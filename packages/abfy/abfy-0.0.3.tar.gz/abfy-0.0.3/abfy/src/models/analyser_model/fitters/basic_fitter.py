...
from abfy.src.models.analyser_model.fitters.fitter import Fitter
...
from abfy.src.models.result_model.result import AnalysisResult, CovariateResult
from abfy.src.utils.dashab_timer import time_profiler
from abfy.src.utils.delta_method import (
...
from abfy.src.utils.experiment.fitter_utils import (
...
from abfy.src.utils.experiment.stats_utils import (
    ...
    def __init__(
        ...
        if self.interaction and len(self.experiment_groups) > 2:
            raise InputConfigError(
                """abfy only support two way interaction of two experiment groups!\
    ...
    def _variance_reduction(self):
        if self.metric.metric_aggregate_func == MetricAggregateFunc.quantile:
            self.message_collection.add_metric_message(
                ...
                abfy can't apply variance reduction on quantile aggregation,\
