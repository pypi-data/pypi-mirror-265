...
def get(configuration: IConfiguration, klass_type: type, configure_options: Callable[[BinderOptions], None]) -> object:
    ...
    if isinstance(configuration , IConfigurationSection) and configuration.value is None and klass_type in default_values:
...
def try_convert_value(klass_type: type, value: str, path: str) -> tuple[bool, object, Exception]:
    ...
    if typing.get_origin(klass_type) == types.UnionType or typing.get_origin(klass_type) == typing.Union:
