...
Descripttion : 
Author       : GDDG08
Date         : 2024-04-02 20:01:54
LastEditors  : GDDG08
LastEditTime : 2024-04-02 20:06:27
'''
import requests
...
def YHKTDown(_courseID, _all=False, _list=None, _range=None, _dual=True, _vga=False, _video=False, _skip=False, _dir='./',  _max_workers=32):
    ...
    if _all:
        ...
        print("Example:")
        print(f"\tyanhekt {_courseID} --all")
        print(f"\tyanhekt {_courseID} --list 0 2 4")
        print(f"\tyanhekt {_courseID} --range 3 5")
        return
