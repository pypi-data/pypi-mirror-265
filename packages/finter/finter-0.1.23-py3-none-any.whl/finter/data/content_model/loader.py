...
class ContentFactory:
    ...
    def determine_base(self):
        if self.universe_name == "raw":
            ...
            return [
                "content.fnguide.ftp.price_volume.*.1d",
                "content.fnguide.ftp.financial.*.1d",
                "content.fnguide.ftp.cax.*.1d",
                "content.fnguide.ftp.investor_activity.*.1d",
                "content.fnguide.ftp.credit.*.1d",
                "content.fnguide.ftp.consensus.*.1d",
                "content.fnguide.ftp.economy.*.1d",
                "content.fnguide.ftp.status.*.1d",
                "content.quantit.api.marketregime.*.1d",
                "content.quantit.fnguide_cm.factor.*.1d",
                "content.quantit.fnguide_cm.descriptor.*.1d",
            ]
        else:
