...
class HATMasker(
    ...
    def load_from_base_module_state_dict(
        ...
        """Load the state dict of the base attention masker to all the tasks.

        Args:
            base_module_state_dict: The state dict of the base attention
                masker.

        """
        for __attn in self.attention:
            __attn.data.copy_(base_module_state_dict["attention"])
