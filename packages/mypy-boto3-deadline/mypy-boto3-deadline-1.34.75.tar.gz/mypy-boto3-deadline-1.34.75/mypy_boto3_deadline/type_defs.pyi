...
FleetAttributeCapabilityPaginatorTypeDef = TypedDict(
    "FleetAttributeCapabilityPaginatorTypeDef",
    {
        "name": str,
        "values": List[str],
...
IpAddressesPaginatorTypeDef = TypedDict(
    "IpAddressesPaginatorTypeDef",
    {
...
CustomerManagedWorkerCapabilitiesPaginatorTypeDef = TypedDict(
    "CustomerManagedWorkerCapabilitiesPaginatorTypeDef",
    {
        ...
        "customAttributes": NotRequired[List[FleetAttributeCapabilityPaginatorTypeDef]],
    },
)
...
FleetCapabilitiesTypeDef = TypedDict(
    "FleetCapabilitiesTypeDef",
    {
        ...
        "attributes": NotRequired[List[FleetAttributeCapabilityTypeDef]],
    },
)
...
ServiceManagedEc2InstanceCapabilitiesPaginatorTypeDef = TypedDict(
    "ServiceManagedEc2InstanceCapabilitiesPaginatorTypeDef",
    {
        "cpuArchitectureType": CpuArchitectureTypeType,
        "memoryMiB": MemoryMiBRangeTypeDef,
...
HostPropertiesResponsePaginatorTypeDef = TypedDict(
    "HostPropertiesResponsePaginatorTypeDef",
    {
        "ec2InstanceArn": NotRequired[str],
        "ec2InstanceType": NotRequired[str],
        "hostName": NotRequired[str],
        "ipAddresses": NotRequired[IpAddressesPaginatorTypeDef],
    },
)
...
CustomerManagedFleetConfigurationPaginatorTypeDef = TypedDict(
    "CustomerManagedFleetConfigurationPaginatorTypeDef",
    {
...
ServiceManagedEc2FleetConfigurationPaginatorTypeDef = TypedDict(
    "ServiceManagedEc2FleetConfigurationPaginatorTypeDef",
    {
...
WorkerSummaryPaginatorTypeDef = TypedDict(
    "WorkerSummaryPaginatorTypeDef",
    {
        "createdAt": datetime,
        "createdBy": str,
        ...
        "status": WorkerStatusType,
        "workerId": str,
        "hostProperties": NotRequired[HostPropertiesResponsePaginatorTypeDef],
        "log": NotRequired[LogConfigurationTypeDef],
        "updatedAt": NotRequired[datetime],
        "updatedBy": NotRequired[str],
    },
...
FleetConfigurationPaginatorTypeDef = TypedDict(
    "FleetConfigurationPaginatorTypeDef",
    {
        "customerManaged": NotRequired[CustomerManagedFleetConfigurationPaginatorTypeDef],
        "serviceManagedEc2": NotRequired[ServiceManagedEc2FleetConfigurationPaginatorTypeDef],
    },
)
...
ListWorkersResponsePaginatorTypeDef = TypedDict(
    "ListWorkersResponsePaginatorTypeDef",
    {
        "nextToken": str,
...
FleetSummaryPaginatorTypeDef = TypedDict(
    "FleetSummaryPaginatorTypeDef",
    {
...
ListFleetsResponsePaginatorTypeDef = TypedDict(
    "ListFleetsResponsePaginatorTypeDef",
    {
