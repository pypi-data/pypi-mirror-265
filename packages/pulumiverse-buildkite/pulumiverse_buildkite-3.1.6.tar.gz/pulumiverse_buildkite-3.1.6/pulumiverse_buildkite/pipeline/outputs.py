...
class PipelineProviderSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param bool build_branches: Whether to create builds when branches are pushed. Defaults to `true` when `trigger_mode` is set to `code`.
        ...
        :param bool build_pull_requests: Whether to create builds for commits that are part of a pull request. Defaults to `true` when `trigger_mode` is set to `code`.
        ...
        :param bool publish_commit_status: Whether to update the status of commits in Bitbucket or GitHub. Defaults to `true` when `trigger_mode` is set to `code`.
        ...
        :param bool skip_pull_request_builds_for_existing_commits: Whether to skip creating a new build for a pull request if an existing build for the commit and branch already exists.  Defaults to `true` when `trigger_mode` is set to `code`.
