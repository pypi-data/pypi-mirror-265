...
def test_awkward_RegularArray_reduce_nonlocal_preparenext_1():
	nextcarry = []
	nextparents = []
	parents = []
	size = 3
	length = 0
	funcPy = getattr(kernels, 'awkward_RegularArray_reduce_nonlocal_preparenext')
...
def test_awkward_RegularArray_reduce_nonlocal_preparenext_2():
	nextcarry = []
	nextparents = []
	parents = []
	size = 0
...
def test_awkward_RegularArray_reduce_nonlocal_preparenext_3():
	nextcarry = []
	nextparents = []
	parents = [0, 1]
	size = 0
...
def test_awkward_RegularArray_reduce_nonlocal_preparenext_4():
...
def test_awkward_RegularArray_reduce_nonlocal_preparenext_5():
...
def test_awkward_RegularArray_reduce_nonlocal_preparenext_6():
	nextcarry = [123]
	nextparents = [123]
	parents = [0]
	size = 1
