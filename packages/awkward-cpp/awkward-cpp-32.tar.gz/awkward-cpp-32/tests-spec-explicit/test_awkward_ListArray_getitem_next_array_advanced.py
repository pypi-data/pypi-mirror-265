...
def test_awkward_ListArray_getitem_next_array_advanced_1():
	...
	with pytest.raises(Exception):
		funcPy(toadvanced = toadvanced,tocarry = tocarry,fromadvanced = fromadvanced,fromarray = fromarray,fromstarts = fromstarts,fromstops = fromstops,lenarray = lenarray,lencontent = lencontent,lenstarts = lenstarts)
