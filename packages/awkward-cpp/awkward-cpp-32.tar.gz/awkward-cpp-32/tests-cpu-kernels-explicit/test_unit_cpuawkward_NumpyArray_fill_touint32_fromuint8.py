...
def test_unit_cpuawkward_NumpyArray_fill_touint32_fromuint8_1():
    toptr = [123, 123, 123]
...
def test_unit_cpuawkward_NumpyArray_fill_touint32_fromuint8_2():
    toptr = []
    toptr = (ctypes.c_uint32*len(toptr))(*toptr)
    tooffset = 0
    fromptr = []
...
def test_unit_cpuawkward_NumpyArray_fill_touint32_fromuint8_3():
...
def test_unit_cpuawkward_NumpyArray_fill_touint32_fromuint8_4():
    toptr = [123, 123]
    toptr = (ctypes.c_uint32*len(toptr))(*toptr)
    tooffset = 0
    fromptr = [3, 5]
...
def test_unit_cpuawkward_NumpyArray_fill_touint32_fromuint8_5():
