...
def test_unit_cpuawkward_NumpyArray_fill_toint64_fromuint32_1():
    toptr = [123, 123, 123]
...
def test_unit_cpuawkward_NumpyArray_fill_toint64_fromuint32_2():
    toptr = []
    toptr = (ctypes.c_int64*len(toptr))(*toptr)
    tooffset = 0
    fromptr = []
...
def test_unit_cpuawkward_NumpyArray_fill_toint64_fromuint32_3():
...
def test_unit_cpuawkward_NumpyArray_fill_toint64_fromuint32_4():
    toptr = [123, 123]
    toptr = (ctypes.c_int64*len(toptr))(*toptr)
    tooffset = 0
    fromptr = [3, 5]
...
def test_unit_cpuawkward_NumpyArray_fill_toint64_fromuint32_5():
