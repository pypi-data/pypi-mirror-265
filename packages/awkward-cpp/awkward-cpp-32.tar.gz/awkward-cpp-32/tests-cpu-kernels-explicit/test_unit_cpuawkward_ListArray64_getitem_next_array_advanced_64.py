...
def test_unit_cpuawkward_ListArray64_getitem_next_array_advanced_64_1():
    ...
    assert funcC(tocarry, toadvanced, fromstarts, fromstops, fromarray, fromadvanced, lenstarts, lenarray, lencontent).str.decode('utf-8') == "stops[i] < starts[i]"
...
def test_unit_cpuawkward_ListArray64_getitem_next_array_advanced_64_2():
    ...
    lenstarts = 1
    funcC = getattr(lib, 'awkward_ListArray64_getitem_next_array_advanced_64')
    assert funcC(tocarry, toadvanced, fromstarts, fromstops, fromarray, fromadvanced, lenstarts, lenarray, lencontent).str.decode('utf-8') == "stops[i] > len(content)"
...
def test_unit_cpuawkward_ListArray64_getitem_next_array_advanced_64_3():
    ...
    lenstarts = 4
    funcC = getattr(lib, 'awkward_ListArray64_getitem_next_array_advanced_64')
    assert funcC(tocarry, toadvanced, fromstarts, fromstops, fromarray, fromadvanced, lenstarts, lenarray, lencontent).str.decode('utf-8') == "index out of range"
