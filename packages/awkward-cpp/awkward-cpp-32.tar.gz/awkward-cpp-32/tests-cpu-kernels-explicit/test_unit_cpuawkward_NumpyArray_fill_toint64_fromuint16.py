...
def test_unit_cpuawkward_NumpyArray_fill_toint64_fromuint16_1():
    toptr = [123, 123, 123]
...
def test_unit_cpuawkward_NumpyArray_fill_toint64_fromuint16_2():
    toptr = []
    toptr = (ctypes.c_int64*len(toptr))(*toptr)
    tooffset = 0
    fromptr = []
...
def test_unit_cpuawkward_NumpyArray_fill_toint64_fromuint16_3():
...
def test_unit_cpuawkward_NumpyArray_fill_toint64_fromuint16_4():
    toptr = [123, 123]
    toptr = (ctypes.c_int64*len(toptr))(*toptr)
    tooffset = 0
    fromptr = [3, 5]
...
def test_unit_cpuawkward_NumpyArray_fill_toint64_fromuint16_5():
