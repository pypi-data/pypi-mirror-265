...
class Main:
	...
	changeLog={
	'2024-04-01@10:44am':[
	"found a bug in Entry's __repr__ method that was preventing la from working ",
	"added 3 new classes, with no interfaces yet installed..."
	],
	...
	def __init__(self,engine,tables,error_log):
		...
		'change_log':{
			'cmds':['cl','16','change_log'],
			'exec':lambda self=self:print(self.changeLog),
			'desc':'print the change_log!'
			}
		}
		#
