...
from hmsclient.genthrift.hive_metastore.ttypes import Database, Table, FieldSchema, Partition, \
...
class HMSClient(ThriftHiveMetastore.Client):
    ...
    def __init__(self, iprot=None, oprot=None, host=None, port=None):
        ...
        if not iprot:
            ...
            def sasl_factory():
                return PureSASLClient(host="dev-cads.lakehouse.cads.live", service="hive")
