...
# Image pre-processing ready for train
    - Function Convert from image folders to parquet: 
      from cads.nosql.image import ConvertFromFolderImage
    - Function Convert from zip fize to parquet: 
      from cads.nosql.image import ConvertFromFolderImage
    - Function Convert parquet to folder of image: 
      from cads.nosql.image import ConvertToFolderImage
...
# Audio pre-processing ready for train
    - Function Convert from audio folders to parquet: 
      from cads.nosql.audio import ConvertToFolderAudio
    - Function Convert from audio folders to parquet: 
      from cads.nosql.audio import ConvertFromFolderAudio
# Video
    - Function Convert from video files to parquet of frame: 
      from cads.nosql.video import ConvertFromVideo2Image
    - Function to display frame parquet
      from cads.nosql.video import ConvertFromFolderAudio
      
    Installation
    -------------
    
    >>> pip install cads-sdk[nosql]
