...
def toPandasImage(self, limit: int = 100, mode='RGB'):
    ...
    >>> df = ss.sql('''
    >>> select *
    >>> from parquet.`file:/img_user_device_jpg_212_212.parquet`
    >>> ''')
    >>> df[100:].toPandasImage()
    """
    if limit > 100:
        limit = 100
...
class Audio(object):
    ...
    >>> Audio('file:/home/user/image_storage/audio_pcm.parquet')
    >>>
    >>> # Test case 2: Open parquet mp3 file
    >>> Audio('file:/home/user/image_storage/audio_mp3.parquet')
    >>>
    >>> # Test case 3: Open parquet wav file
    >>> Audio('file:/home/user/image_storage/audio_wav.parquet')
    """
    def __init__(self, 
                 input_path=None, 
                 width=None, 
