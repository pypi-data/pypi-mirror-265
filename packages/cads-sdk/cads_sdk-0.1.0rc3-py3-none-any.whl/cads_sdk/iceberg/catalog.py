...
from cads_sdk.iceberg.table import (
    Table,
    TableMetadata,
)
...
def load_hive(name: str, conf: Properties) -> Catalog:
    try:
        # replace pyiceberg HiveCatalog with our HiveCatalog
        from cads_sdk.iceberg.hive import HiveCatalog
...
class Catalog(ABC):
    ...
    def _convert_schema_if_needed(schema: Union[Schema, "pa.Schema"]) -> Schema:
        ...
        try:
            ...
            from cads_sdk.iceberg.pyarrow import _ConvertToIcebergWithoutIDs, visit_pyarrow
