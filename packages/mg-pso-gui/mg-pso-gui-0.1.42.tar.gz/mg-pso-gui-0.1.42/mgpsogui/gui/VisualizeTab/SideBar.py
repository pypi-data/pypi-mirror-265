    ...
    def render(self):
        ...
        if (selected_graph == "Best Cost Stacked"):
            ...
            if (self.home_page.csv_data is not None):
                ...
                self.home_page.csv_y1_selector.grid(row=3, column=0, padx=(20, 20), pady=(20, 20), sticky="nsew")
                ...
                self.home_page.csv_y2_selector.grid(row=4, column=0, padx=(20, 20), pady=(20, 20), sticky="nsew")
