...
class SideBar(CTkScrollableFrame):
    ...
    def render(self):
        ...
        if (selected_graph == "Best Cost Stacked"):
            ...
            file_label.grid(row=0, column=0, padx=(20, 20), pady=(20, 20), sticky="w")
            ...
            self.home_page.csv_file_selector.grid(row=1, column=0, padx=(20, 20), pady=(20, 20), sticky="ew")
            ...
            if (self.home_page.csv_data is not None):
                ...
                x_axis_label.grid(row=2, column=0, padx=(20, 20), pady=(20, 20), sticky="w")
                ...
                self.home_page.csv_x_selector.grid(row=3, column=0, padx=(20, 20), pady=(20, 20), sticky="ew")
                ...
                y1_axis_label.grid(row=4, column=0, padx=(20, 20), pady=(20, 20), sticky="w")
                ...
                self.home_page.csv_y1_selector.grid(row=5, column=0, padx=(20, 20), pady=(20, 20), sticky="ew")
                ...
                y2_axis_label.grid(row=6, column=0, padx=(20, 20), pady=(20, 20), sticky="w")
                ...
                self.home_page.csv_y2_selector.grid(row=7, column=0, padx=(20, 20), pady=(20, 20), sticky="ew")
