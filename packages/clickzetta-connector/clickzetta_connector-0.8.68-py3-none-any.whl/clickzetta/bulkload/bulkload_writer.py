...
class BulkLoadWriter:
    def __init__(self, client: Client, meta_data: BulkLoadMetaData, config: BulkLoadConfig, partition_id: int,
                 prefer_internal_endpoint=False):
        self.client = client
        self.meta_data = meta_data
        self.config = config
        self.partition_id = partition_id
        self.staging_config = config.get_staging_config(prefer_internal_endpoint)
        self._process_staging_type()
        self.file_io = config.get_staging_config(prefer_internal_endpoint).create_file_io()
