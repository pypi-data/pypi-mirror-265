...
class BulkLoadStream:
    def __init__(self, meta_data: BulkLoadMetaData, client: Client,
                 commit_options: BulkLoadCommitOptions=None, prefer_internal_endpoint=False):
    ...
    def open_writer(self, partition_id: int):
        ...
        return BulkLoadWriter(self.client, self.meta_data, config, partition_id, self.prefer_internal_endpoint)
