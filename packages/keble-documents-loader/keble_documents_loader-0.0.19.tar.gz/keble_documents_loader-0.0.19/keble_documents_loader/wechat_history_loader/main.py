...
class KebleWechatHistoryLoader:
    ...
    def load_by_daily(self, *, overlap: int = 10) -> List[Document]:
        ...
        loader = KebleWechatHistoryLoader(self.__json_filepath)
        messages: List[WxMessage] = loader.load_messages()
    ...
    def load(self) -> List[Document]:
        ...
        with open(self.__json_filepath, "r") as file:
            ...
            for message in messages:
                ...
                if self.__gte_datetime is not None:
                    document = None
                    if parsed_message.msg_create_time.timestamp() >= self.__gte_datetime.timestamp():
