...
class Key(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["created_at", b"created_at", "description", b"description", "fingerprint", b"fingerprint", "id", b"id", "key_algorithm", b"key_algorithm", "public_key", b"public_key", "service_account_id", b"service_account_id", "subject", b"subject", "user_account_id", b"user_account_id"]) -> None: ...
