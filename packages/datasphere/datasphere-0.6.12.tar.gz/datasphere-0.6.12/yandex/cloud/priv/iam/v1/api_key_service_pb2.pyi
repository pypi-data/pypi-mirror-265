...
class CreateApiKeyRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["api_key_id", b"api_key_id", "description", b"description", "service_account_id", b"service_account_id"]) -> None: ...
