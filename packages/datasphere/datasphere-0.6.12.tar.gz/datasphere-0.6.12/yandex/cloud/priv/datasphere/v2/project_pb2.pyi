...
class ProjectInstance(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["created_at", b"created_at", "instance_spec", b"instance_spec", "resource_usage", b"resource_usage"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["cell_type", b"cell_type", "created_at", b"created_at", "id", b"id", "instance_spec", b"instance_spec", "path", b"path", "resource_usage", b"resource_usage", "state", b"state"]) -> None: ...
