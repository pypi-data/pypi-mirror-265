...
class JobParameters(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["cloud_instance_type", b"cloud_instance_type", "env", b"env", "extended_working_storage", b"extended_working_storage"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["attach_project_disk", b"attach_project_disk", "cloud_instance_type", b"cloud_instance_type", "cmd", b"cmd", "dataset_ids", b"dataset_ids", "env", b"env", "extended_working_storage", b"extended_working_storage", "input_files", b"input_files", "output_files", b"output_files", "s3_mount_ids", b"s3_mount_ids"]) -> None: ...
