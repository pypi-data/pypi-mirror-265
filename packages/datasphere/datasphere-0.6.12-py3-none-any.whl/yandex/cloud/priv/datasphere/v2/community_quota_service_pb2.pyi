...
class AvailableSpec(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["active", b"active", "availability", b"availability", "cost", b"cost", "cost_dedicated", b"cost_dedicated", "currency", b"currency", "spec", b"spec", "type", b"type"]) -> None: ...
...
class GetAvailableProjectSpecsRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["cost_estimation", b"cost_estimation"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["cost_estimation", b"cost_estimation", "project_id", b"project_id", "use_new_api", b"use_new_api"]) -> None: ...
