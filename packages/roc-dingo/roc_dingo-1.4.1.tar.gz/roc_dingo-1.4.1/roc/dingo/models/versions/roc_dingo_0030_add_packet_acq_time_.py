...
def upgrade():
    ...
    op.add_column('tm_log', sa.Column('acq_coarse_time', sa.BIGINT(), nullable=True), schema='pipeline')
    op.add_column('tm_log', sa.Column('acq_fine_time', sa.INTEGER(), nullable=True), schema='pipeline')
