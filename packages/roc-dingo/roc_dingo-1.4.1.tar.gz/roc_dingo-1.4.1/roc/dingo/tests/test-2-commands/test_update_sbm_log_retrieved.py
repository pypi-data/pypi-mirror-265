...
EXPECTED_ROWS = ({'info': {'TM_TDS_SCIENCE_SBM1_RSWF':
                               {'size': 2916, 'count': 27, 'percent': 1.25},
                           'TM_LFR_SCIENCE_SBM1_BP1_F0': {'size': 777330, 'count': 2879, 'percent': 100.0},
                           'TM_LFR_SCIENCE_SBM1_BP2_F0': {'size': 495360, 'count': 720, 'percent': 100.0},
                           'TM_LFR_SCIENCE_SBM1_CWF_F1': {'size': 0, 'count': 0, 'percent': 0.0},
                           'TM_TDS_SCIENCE_SBM1_RSWF_C': {'size': 2221930, 'count': 2132, 'percent': 98.70370370370371},
                           'TM_LFR_SCIENCE_SBM1_CWF_F1_C': {'size': 13138060, 'count': 8776,
                                                            'percent': 99.97721576668945}}, 'size': 16635596,
                  'percent': 99.9827298675983},
                 {'info': {'TM_TDS_SCIENCE_SBM1_RSWF': {'size': 4644, 'count': 43, 'percent': 1.990740740740741},
                           'TM_LFR_SCIENCE_SBM1_BP1_F0': {'size': 777330, 'count': 2879, 'percent': 100.0},
                           'TM_LFR_SCIENCE_SBM1_BP2_F0': {'size': 495360, 'count': 720, 'percent': 100.0},
                           'TM_LFR_SCIENCE_SBM1_CWF_F1': {'size': 0, 'count': 0, 'percent': 0.0},
                           'TM_TDS_SCIENCE_SBM1_RSWF_C': {'size': 2266296, 'count': 2117, 'percent': 98.00925925925927},
                           'TM_LFR_SCIENCE_SBM1_CWF_F1_C': {'size': 13125590, 'count': 8775,
                                                            'percent': 99.96582365003418}}, 'size': 16669220,
                  'percent': 99.99145591250854},
                 {'info': {'TM_TDS_SCIENCE_SBM1_RSWF': {'size': 3672, 'count': 34, 'percent': 1.574074074074074},
                           'TM_LFR_SCIENCE_SBM1_BP1_F0': {'size': 777330, 'count': 2879, 'percent': 100.0},
                           'TM_LFR_SCIENCE_SBM1_BP2_F0': {'size': 495360, 'count': 720, 'percent': 100.0},
                           'TM_LFR_SCIENCE_SBM1_CWF_F1': {'size': 0, 'count': 0, 'percent': 0.0},
                           'TM_TDS_SCIENCE_SBM1_RSWF_C': {'size': 2194002, 'count': 2126, 'percent': 98.42592592592592},
                           'TM_LFR_SCIENCE_SBM1_CWF_F1_C': {'size': 13115610, 'count': 8775,
                                                            'percent': 99.96582365003418}}, 'size': 16585974,
                  'percent': 99.99145591250854},
                 {'info': {'TM_TDS_SCIENCE_SBM1_RSWF': {'size': 4212, 'count': 39, 'percent': 1.8055555555555554},
                           'TM_LFR_SCIENCE_SBM1_BP1_F0': {'size': 777330, 'count': 2879, 'percent': 100.0},
                           'TM_LFR_SCIENCE_SBM1_BP2_F0': {'size': 495360, 'count': 720, 'percent': 100.0},
                           'TM_LFR_SCIENCE_SBM1_CWF_F1': {'size': 0, 'count': 0, 'percent': 0.0},
                           'TM_TDS_SCIENCE_SBM1_RSWF_C': {'size': 2259828, 'count': 2121, 'percent': 98.19444444444444},
                           'TM_LFR_SCIENCE_SBM1_CWF_F1_C': {'size': 13196088, 'count': 8775,
                                                            'percent': 99.96582365003418}}, 'size': 16732818,
                  'percent': 99.99145591250854},
                 {'info': {'TM_TDS_SCIENCE_SBM1_RSWF': {'size': 1512, 'count': 14, 'percent': 0.6481481481481481},
                           'TM_LFR_SCIENCE_SBM1_BP1_F0': {'size': 777330, 'count': 2879, 'percent': 100.0},
                           'TM_LFR_SCIENCE_SBM1_BP2_F0': {'size': 495360, 'count': 720, 'percent': 100.0},
                           'TM_LFR_SCIENCE_SBM1_CWF_F1': {'size': 0, 'count': 0, 'percent': 0.0},
                           'TM_TDS_SCIENCE_SBM1_RSWF_C': {'size': 2124022, 'count': 2146, 'percent': 99.35185185185185},
                           'TM_LFR_SCIENCE_SBM1_CWF_F1_C': {'size': 13042384, 'count': 8775,
                                                            'percent': 99.96582365003418}}, 'size': 16440608,
                  'percent': 99.99145591250854}
                 )
...
class TestDingoUpdateSbmRetrievedCommand(CommandTestCase):
    ...
    @pytest.mark.parametrize('idb_source,idb_version, exclude_tm_apid', [
        ('MIB', '20200131', '1212 1228 1244 1260 1204 1220 1236 1252 1269 1300'),
    ])
    def test_update_sbm_retrieved(self, idb_source,
                                  idb_version,
                                  exclude_tm_apid):
        ...
        if not os.path.isdir(spice_kernels_dir):
            ...
            sclk = max((Path(spice_kernels_dir) / 'sclk').glob(
                'solo_ANC_soc-sclk_*.tsc'), key=os.path.getctime)
            lsk = max((Path(spice_kernels_dir) / 'lsk').glob(
                'naif*.tls'), key=os.path.getctime)

        # First insert data into database
        command_to_run = ' '.join(['pop',
                                   'dingo',
                                   '--idb-source',
                                   idb_source,
                                   '--idb-version',
        ...
        logger.debug(f'Querying sbm_log table in database ...')
        rows = (
            self.session.query(SbmLog)
            .order_by(SbmLog.utc_time)
            .all()
        )
        ...
        for i, row in enumerate(rows):
            ...
            assert all((current_expected.get(k) == v for k, v in current_retrieved.items()))
