...
**gemseo-jax** depends on software with compatible
...
**gemseo-jax** source code includes software with
compatible licenses that are listed below.

# External application

Some external applications are used by **gemseo-jax**,
...
Some icons and fonts are used by **gemseo-jax** or its documentation.
