...
Votre tâche consiste à accepter un texte en entrée et à en extraire les entités nommées.
...
Le résultat doit donner une ligne pour chaque étiquette extraite, cette ligne doit commencer par l'étiquette suivie d'une liste d'entités séparées par le caractère | telles qu'elles apparaissent dans le texte d'origine et dans leur ordre d'apparition, si plusieurs occurrences de la même entité apparaît elle doit être listée plusieurs fois.
Comme par exemple:
ORGANIZATION:bureau du Conseil de Sécurité de l'ONU, Conseil de Sécurité de l'ONU, l'ONU
GROUP:Ces milliers d’actes isolés|quatre blessés
TIME:dans la phase finale de la guerre|de janvier à juillet 2015|souvent
...
Vous trouverez ci-dessous les définitions de chaque étiquette afin de vous aider à déterminer les types d'entités nommées à extraire pour chaque étiquette.
