...
from msanic.libs.component import BaseEnum
...
from msanic.handler_req import BaseAQR
{ws_model}
from {s_name}.config import conf_srv


class BaseApi(HTTPMethodView, BaseAQR):
    conf = conf_srv{ws_base}
'''
