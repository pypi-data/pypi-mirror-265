...
import utils
from model import AccountData, LoginError, SeasonData, SeriesData, EpisodeData, ListableItem, CrunchyrollError
...
class GenericSetting(CrunchyrollSettings):
        ...
        def save(self):
                ...
                rem_list = ["session_restart", "search_type", "category_filter", "playlist", "crunchylist_filter", "season_filter", "field"]
...
class CrunchyrollAPI:
    ...
    def search_items_by_string(self):
