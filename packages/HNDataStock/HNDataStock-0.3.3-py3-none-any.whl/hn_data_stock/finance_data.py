...
class StockData:
    ...
    def get_stock_data(ticker, period, interval):
        ...
        :param ticker: Mã cổ phiếu.
        :param period: Khoảng thời gian tổng để truy xuất. Ví dụ: '1d', '1mo', '1y'.
        :param interval: Khoảng thời gian chi tiết để truy xuất. Ví dụ: '1m', '5m', '1h'.
        :return: DataFrame chứa dữ liệu lịch sử cổ phiếu.
        """
        history = yf.Ticker(ticker)
        history_data = history.history(period=period, interval=interval)
        history_data = history_data.reset_index().rename(columns={'Datetime': 'Datetime'})
        return history_data
