...
from dharitri_sdk_core import ArbitraryMessage

from dharitri_sdk_wallet.validator_keys import ValidatorSecretKey
...
def test_sign_message():
    signer = ValidatorSigner.from_pem_file(Path("./dharitri_sdk_wallet/testdata/validatorKey00.pem"))
...
def test_pem_save():
    path = Path("./dharitri_sdk_wallet/testdata/validatorKey00.pem")
