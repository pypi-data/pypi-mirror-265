...
pygame.init()
#读取默认子弹资源
default_bullet_images = ResourceManager('invasion_game_demo/resources/bullet')   
default_autocannon_assers = ResourceManager('invasion_game_demo/resources/autocannon')
default_gatling_assers = ResourceManager('invasion_game_demo/resources/gatling')
default_railgun_assers = ResourceManager('invasion_game_demo/resources/railgun')
