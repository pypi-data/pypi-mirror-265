 ...
 */
static inline npy_int64 extract_unit_64(npy_int64 *d, npy_int64 unit) {
  assert(unit > 0);
...
int convert_datetime_to_datetimestruct(PyArray_DatetimeMetaData *meta,
  ...
  case NPY_FR_ps:
    ...
    set_datetimestruct_days(days, out);
    out->hour =
        (int)extract_unit_64(&dt, 1000LL * 1000 * 1000 * 1000 * 60 * 60);
  ...
  case NPY_FR_fs:
    ...
    out->hour =
        (int)extract_unit_64(&dt, 1000LL * 1000 * 1000 * 1000 * 1000 * 60 * 60);
    if (out->hour < 0) {
      out->year = 1969;
      out->month = 12;
      out->day = 31;
    ...
    out->min =
        (int)extract_unit_64(&dt, 1000LL * 1000 * 1000 * 1000 * 1000 * 60);
  ...
  case NPY_FR_as:
    ...
    out->sec =
        (int)extract_unit_64(&dt, 1000LL * 1000 * 1000 * 1000 * 1000 * 1000);
    if (out->sec < 0) {
      out->year = 1969;
      out->month = 12;
      out->day = 31;
