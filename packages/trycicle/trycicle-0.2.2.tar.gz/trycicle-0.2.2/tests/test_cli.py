...
def test_create_clean_copy(
    ...
    create_clean_copy.assert_called_once_with("")
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param("", "tests/basic.yml", ["NAME", "SHELL", "USER"], id="variable"),
        pytest.param(
            "",
            "tests/example.yml",
            [
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(".t", "tests/example.yml", [".tests"], id="hidden-jobs"),
    ],
)
