...
class ArnConnectionInfoDto(object):
    ...
    def __init__(self, path=None):  # noqa: E501
        """ArnConnectionInfoDto - a model defined in Swagger"""  # noqa: E501
        self._path = None
    ...
    @property
    def path(self):
        """Gets the path of this ArnConnectionInfoDto.  # noqa: E501

        The ARN path for S3.  # noqa: E501

        :return: The path of this ArnConnectionInfoDto.  # noqa: E501
        :rtype: str
        """
        return self._path
    ...
    @path.setter
    def path(self, path):
        """Sets the path of this ArnConnectionInfoDto.

        The ARN path for S3.  # noqa: E501

        :param path: The path of this ArnConnectionInfoDto.  # noqa: E501
        :type: str
        """
        if path is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ArnConnectionInfoDto, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ArnConnectionInfoDto):
            return False
