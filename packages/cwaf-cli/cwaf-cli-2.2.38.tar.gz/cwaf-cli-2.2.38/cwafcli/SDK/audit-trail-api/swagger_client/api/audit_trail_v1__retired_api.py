...
class AuditTrailV1RetiredApi(object):
    ...
    def get_audit_events(self, start, **kwargs):  # noqa: E501
        """Get account audit events  # noqa: E501

        This api is deprecated. This is a list of audit events of the specified account  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_audit_events(start, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.get_audit_events_with_http_info(start, **kwargs)  # noqa: E501
        else:
            (data) = self.get_audit_events_with_http_info(start, **kwargs)  # noqa: E501
            return data

    def get_audit_events_with_http_info(self, start, **kwargs):  # noqa: E501
        """Get account audit events  # noqa: E501

        This api is deprecated. This is a list of audit events of the specified account  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_audit_events_with_http_info(start, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_audit_events" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('start' not in params or
            ...
            raise ValueError("Missing the required parameter `start` when calling `get_audit_events`")  # noqa: E501
