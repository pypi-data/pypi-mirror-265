...
class CaptchaSettingsV1Recaptcha(object):
    ...
    """
    swagger_types = {
        'recaptcha_site_key': 'CaptchaSettingsValue',
        'recaptcha_secret_key': 'CaptchaSettingsPassword'
    }
    ...
    def __init__(self, recaptcha_site_key=None, recaptcha_secret_key=None):  # noqa: E501
        """CaptchaSettingsV1Recaptcha - a model defined in Swagger"""  # noqa: E501
        self._recaptcha_site_key = None
        self._recaptcha_secret_key = None
    ...
    def recaptcha_site_key(self):
        """Gets the recaptcha_site_key of this CaptchaSettingsV1Recaptcha.  # noqa: E501


        :return: The recaptcha_site_key of this CaptchaSettingsV1Recaptcha.  # noqa: E501
    ...
    def recaptcha_site_key(self, recaptcha_site_key):
        """Sets the recaptcha_site_key of this CaptchaSettingsV1Recaptcha.


        :param recaptcha_site_key: The recaptcha_site_key of this CaptchaSettingsV1Recaptcha.  # noqa: E501
        :type: CaptchaSettingsValue
        """
        if recaptcha_site_key is None:
            raise ValueError("Invalid value for `recaptcha_site_key`, must not be `None`")  # noqa: E501

        self._recaptcha_site_key = recaptcha_site_key

    @property
    def recaptcha_secret_key(self):
        """Gets the recaptcha_secret_key of this CaptchaSettingsV1Recaptcha.  # noqa: E501


        :return: The recaptcha_secret_key of this CaptchaSettingsV1Recaptcha.  # noqa: E501
        :rtype: CaptchaSettingsPassword
        """
        return self._recaptcha_secret_key

    @recaptcha_secret_key.setter
    def recaptcha_secret_key(self, recaptcha_secret_key):
        """Sets the recaptcha_secret_key of this CaptchaSettingsV1Recaptcha.


        :param recaptcha_secret_key: The recaptcha_secret_key of this CaptchaSettingsV1Recaptcha.  # noqa: E501
        :type: CaptchaSettingsPassword
        """
        if recaptcha_secret_key is None:
            raise ValueError("Invalid value for `recaptcha_secret_key`, must not be `None`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CaptchaSettingsV1Recaptcha, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CaptchaSettingsV1Recaptcha):
            return False
