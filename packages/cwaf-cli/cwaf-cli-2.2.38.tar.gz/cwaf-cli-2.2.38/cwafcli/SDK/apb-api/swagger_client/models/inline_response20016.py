...
import six
from swagger_client.models.site_priority_v1 import SitePriorityV1  # noqa: F401,E501

class InlineResponse20016(SitePriorityV1):
    ...
    if hasattr(SitePriorityV1, "swagger_types"):
        swagger_types.update(SitePriorityV1.swagger_types)

    attribute_map = {
        'links': '_links'
    }
    if hasattr(SitePriorityV1, "attribute_map"):
        attribute_map.update(SitePriorityV1.attribute_map)
    ...
    def __init__(self, links=None, *args, **kwargs):  # noqa: E501
        ...
        self.links = links
        SitePriorityV1.__init__(self, *args, **kwargs)
