...
class CookieModeV1(object):
    ...
    LAX = "lax"
    LEGACY = "legacy"
    NONE_SECURE = "none_secure"
    LAX_AND_NONE_SECURE = "lax_and_none_secure"
    LAX_AND_LEGACY = "lax_and_legacy"
    LEGACY_AND_NONE_SECURE = "legacy_and_none_secure"
    """
    Attributes:
    ...
    def __init__(self):  # noqa: E501
        """CookieModeV1 - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CookieModeV1, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CookieModeV1):
            return False
