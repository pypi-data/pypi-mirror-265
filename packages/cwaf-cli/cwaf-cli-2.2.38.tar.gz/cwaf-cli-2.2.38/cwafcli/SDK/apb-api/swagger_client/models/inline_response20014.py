...
import six
from swagger_client.models.domain_priority_v1 import DomainPriorityV1  # noqa: F401,E501

class InlineResponse20014(DomainPriorityV1):
    ...
    if hasattr(DomainPriorityV1, "swagger_types"):
        swagger_types.update(DomainPriorityV1.swagger_types)

    attribute_map = {
        'links': '_links'
    }
    if hasattr(DomainPriorityV1, "attribute_map"):
        attribute_map.update(DomainPriorityV1.attribute_map)
    ...
    def __init__(self, links=None, *args, **kwargs):  # noqa: E501
        ...
        self.links = links
        DomainPriorityV1.__init__(self, *args, **kwargs)
