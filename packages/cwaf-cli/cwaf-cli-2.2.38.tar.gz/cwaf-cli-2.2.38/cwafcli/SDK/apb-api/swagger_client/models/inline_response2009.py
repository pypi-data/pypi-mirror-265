...
import six
from swagger_client.models.latest_successful_publish_v1 import LatestSuccessfulPublishV1  # noqa: F401,E501

class InlineResponse2009(LatestSuccessfulPublishV1):
    ...
    if hasattr(LatestSuccessfulPublishV1, "swagger_types"):
        swagger_types.update(LatestSuccessfulPublishV1.swagger_types)

    attribute_map = {
        'links': '_links'
    }
    if hasattr(LatestSuccessfulPublishV1, "attribute_map"):
        attribute_map.update(LatestSuccessfulPublishV1.attribute_map)
    ...
    def __init__(self, links=None, *args, **kwargs):  # noqa: E501
        ...
        self.links = links
        LatestSuccessfulPublishV1.__init__(self, *args, **kwargs)
