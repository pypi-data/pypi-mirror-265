...
class CaptchaSettingsV1ManagedGeetest(object):
    ...
    """
    swagger_types = {
        'difficulty': 'GeetestDifficultyV1'
    }
    ...
    def __init__(self, difficulty=None):  # noqa: E501
        """CaptchaSettingsV1ManagedGeetest - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def difficulty(self):
        """Gets the difficulty of this CaptchaSettingsV1ManagedGeetest.  # noqa: E501


        :return: The difficulty of this CaptchaSettingsV1ManagedGeetest.  # noqa: E501
        :rtype: GeetestDifficultyV1
        """
        return self._difficulty

    @difficulty.setter
    def difficulty(self, difficulty):
        """Sets the difficulty of this CaptchaSettingsV1ManagedGeetest.


        :param difficulty: The difficulty of this CaptchaSettingsV1ManagedGeetest.  # noqa: E501
        :type: GeetestDifficultyV1
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CaptchaSettingsV1ManagedGeetest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CaptchaSettingsV1ManagedGeetest):
            return False
