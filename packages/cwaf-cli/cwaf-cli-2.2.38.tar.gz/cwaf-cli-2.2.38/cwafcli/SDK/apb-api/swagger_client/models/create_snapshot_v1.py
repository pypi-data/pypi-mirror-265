...
class CreateSnapshotV1(object):
    ...
    def __init__(self, name=None):  # noqa: E501
        """CreateSnapshotV1 - a model defined in Swagger"""  # noqa: E501
        self._name = None
    ...
    @property
    def name(self):
        """Gets the name of this CreateSnapshotV1.  # noqa: E501


        :return: The name of this CreateSnapshotV1.  # noqa: E501
        :rtype: Name
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this CreateSnapshotV1.


        :param name: The name of this CreateSnapshotV1.  # noqa: E501
        :type: Name
        """
        if name is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CreateSnapshotV1, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreateSnapshotV1):
            return False
