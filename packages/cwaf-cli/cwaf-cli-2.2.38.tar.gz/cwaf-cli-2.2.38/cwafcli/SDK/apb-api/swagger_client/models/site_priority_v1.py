...
class SitePriorityV1(object):
    ...
    def __init__(self, site_ids=None):  # noqa: E501
        """SitePriorityV1 - a model defined in Swagger"""  # noqa: E501
        self._site_ids = None
    ...
    @property
    def site_ids(self):
        """Gets the site_ids of this SitePriorityV1.  # noqa: E501

        The site IDs in order of priority. The first element has the highest priority.   # noqa: E501

        :return: The site_ids of this SitePriorityV1.  # noqa: E501
        :rtype: list[SiteId]
        """
    ...
    def site_ids(self, site_ids):
        """Sets the site_ids of this SitePriorityV1.

        The site IDs in order of priority. The first element has the highest priority.   # noqa: E501

        :param site_ids: The site_ids of this SitePriorityV1.  # noqa: E501
        :type: list[SiteId]
        """
        if site_ids is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SitePriorityV1, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SitePriorityV1):
            return False
