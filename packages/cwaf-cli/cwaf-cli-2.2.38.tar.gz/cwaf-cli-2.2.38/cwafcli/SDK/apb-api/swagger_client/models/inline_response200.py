...
import six
from swagger_client.models.root_v1 import RootV1  # noqa: F401,E501

class InlineResponse200(RootV1):
    ...
    if hasattr(RootV1, "swagger_types"):
        swagger_types.update(RootV1.swagger_types)

    attribute_map = {
        'links': '_links'
    }
    if hasattr(RootV1, "attribute_map"):
        attribute_map.update(RootV1.attribute_map)
    ...
    def __init__(self, links=None, *args, **kwargs):  # noqa: E501
        ...
        self.links = links
        RootV1.__init__(self, *args, **kwargs)
