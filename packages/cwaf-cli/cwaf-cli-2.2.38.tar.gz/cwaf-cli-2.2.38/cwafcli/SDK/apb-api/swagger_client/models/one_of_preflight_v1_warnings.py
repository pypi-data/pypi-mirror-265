...
class OneOfPreflightV1Warnings(object):
    ...
    def __init__(self):  # noqa: E501
        """OneOfPreflightV1Warnings - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OneOfPreflightV1Warnings, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OneOfPreflightV1Warnings):
            return False
