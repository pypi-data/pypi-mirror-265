...
import six
from swagger_client.models.with_links import WithLinks  # noqa: F401,E501

class InlineResponse20011(WithLinks):
    ...
    """
    swagger_types = {
        'environmental_parameters': 'list[EnvironmentalParameterV1]'
    }
    if hasattr(WithLinks, "swagger_types"):
        swagger_types.update(WithLinks.swagger_types)

    attribute_map = {
        'environmental_parameters': 'environmental_parameters'
    }
    if hasattr(WithLinks, "attribute_map"):
        attribute_map.update(WithLinks.attribute_map)

    def __init__(self, environmental_parameters=None, *args, **kwargs):  # noqa: E501
        """InlineResponse20011 - a model defined in Swagger"""  # noqa: E501
        self._environmental_parameters = None
        self.discriminator = None
        self.environmental_parameters = environmental_parameters
        WithLinks.__init__(self, *args, **kwargs)

    @property
    def environmental_parameters(self):
        """Gets the environmental_parameters of this InlineResponse20011.  # noqa: E501


        :return: The environmental_parameters of this InlineResponse20011.  # noqa: E501
        :rtype: list[EnvironmentalParameterV1]
        """
        return self._environmental_parameters

    @environmental_parameters.setter
    def environmental_parameters(self, environmental_parameters):
        """Sets the environmental_parameters of this InlineResponse20011.


        :param environmental_parameters: The environmental_parameters of this InlineResponse20011.  # noqa: E501
        :type: list[EnvironmentalParameterV1]
        """
        if environmental_parameters is None:
            raise ValueError("Invalid value for `environmental_parameters`, must not be `None`")  # noqa: E501

        self._environmental_parameters = environmental_parameters
