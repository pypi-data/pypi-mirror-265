...
import six
from swagger_client.models.moi_validation_result_v1 import MoiValidationResultV1  # noqa: F401,E501

class InlineResponse20018(MoiValidationResultV1):
    ...
    if hasattr(MoiValidationResultV1, "swagger_types"):
        swagger_types.update(MoiValidationResultV1.swagger_types)

    attribute_map = {
        'links': '_links'
    }
    if hasattr(MoiValidationResultV1, "attribute_map"):
        attribute_map.update(MoiValidationResultV1.attribute_map)
    ...
    def __init__(self, links=None, *args, **kwargs):  # noqa: E501
        ...
        self.links = links
        MoiValidationResultV1.__init__(self, *args, **kwargs)
