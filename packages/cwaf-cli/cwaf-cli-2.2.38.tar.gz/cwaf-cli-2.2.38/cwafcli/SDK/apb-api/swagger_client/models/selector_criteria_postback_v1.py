...
class SelectorCriteriaPostbackV1(object):
    ...
    allowed enum values
    """
    WEB_INTERROGATION = "web_interrogation"
    IOS_INTERROGATION = "ios_interrogation"
    WEB_AUTOMATION = "web_automation"
    ANDROID_INTERROGATION = "android_interrogation"
    """
    Attributes:
    ...
    def __init__(self):  # noqa: E501
        """SelectorCriteriaPostbackV1 - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SelectorCriteriaPostbackV1, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SelectorCriteriaPostbackV1):
            return False
