...
class TestDomainApi(unittest.TestCase):
    ...
    def test_v1_account_account_id_domain_get(self):
        """Test case for v1_account_account_id_domain_get

        Retrieve the list of Domains belonging to the Account  # noqa: E501
        """
        pass

    def test_v1_account_account_id_domain_post(self):
        """Test case for v1_account_account_id_domain_post

        Create a new Domain  # noqa: E501
        """
        pass

    def test_v1_domain_domain_id_delete(self):
        """Test case for v1_domain_domain_id_delete

        Delete a domain  # noqa: E501
        """
        pass

    def test_v1_domain_domain_id_get(self):
        """Test case for v1_domain_domain_id_get

        Retrieve a Domain  # noqa: E501
        """
        pass

    def test_v1_domain_domain_id_put(self):
        """Test case for v1_domain_domain_id_put

        Update a Domain  # noqa: E501
        """
        pass

    def test_v1_site_site_id_domain_get(self):
        """Test case for v1_site_site_id_domain_get

        Retrieve the list of Domains belonging to the Site  # noqa: E501
        """
        pass

    def test_v1_site_site_id_domain_priority_get(self):
        """Test case for v1_site_site_id_domain_priority_get

        Retrieve the Site's Domain priority order  # noqa: E501
        """
        pass

    def test_v1_site_site_id_domain_priority_put(self):
        """Test case for v1_site_site_id_domain_priority_put
