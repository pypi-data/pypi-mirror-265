...
class TestSiteApi(unittest.TestCase):
    ...
    def test_v1_account_account_id_site_get(self):
        """Test case for v1_account_account_id_site_get

        Retrieve the list of Sites belonging to an Account  # noqa: E501
        """
        pass

    def test_v1_account_account_id_site_post(self):
        """Test case for v1_account_account_id_site_post

        Create a new Site  # noqa: E501
        """
        pass

    def test_v1_account_account_id_site_priority_get(self):
        """Test case for v1_account_account_id_site_priority_get

        Retrieve the Account's Site priority order  # noqa: E501
        """
        pass

    def test_v1_account_account_id_site_priority_put(self):
        """Test case for v1_account_account_id_site_priority_put

        Set site priority in this Account  # noqa: E501
        """
        pass

    def test_v1_site_site_id_delete(self):
        """Test case for v1_site_site_id_delete

        Delete a Site  # noqa: E501
        """
        pass

    def test_v1_site_site_id_environmental_parameters_get(self):
        """Test case for v1_site_site_id_environmental_parameters_get

        Retrieve all environmental parameters used in a Site  # noqa: E501
        """
        pass

    def test_v1_site_site_id_get(self):
        """Test case for v1_site_site_id_get

        Retrieve a Site  # noqa: E501
        """
        pass

    def test_v1_site_site_id_put(self):
        """Test case for v1_site_site_id_put
