...
class TestSnapshotApi(unittest.TestCase):
    ...
    def test_v1_account_account_id_snapshot_get(self):
        """Test case for v1_account_account_id_snapshot_get

        Retrieve the list of snapshots belonging to an Account  # noqa: E501
        """
        pass

    def test_v1_account_account_id_snapshot_post(self):
        """Test case for v1_account_account_id_snapshot_post

        Create a snapshot to allow a configuration rollback  # noqa: E501
        """
        pass

    def test_v1_snapshot_snapshot_id_delete(self):
        """Test case for v1_snapshot_snapshot_id_delete

        Delete a snapshot  # noqa: E501
        """
        pass

    def test_v1_snapshot_snapshot_id_get(self):
        """Test case for v1_snapshot_snapshot_id_get

        Retrieve a snapshot  # noqa: E501
        """
        pass

    def test_v1_snapshot_snapshot_id_restore_post(self):
        """Test case for v1_snapshot_snapshot_id_restore_post
