...
class SiteIdApiIdBody(object):
    ...
    def __init__(self, api_specification=None, description=None, oas_file_name=None, specification_violation_action=None, validate_host=True, violation_actions=None):  # noqa: E501
        """SiteIdApiIdBody - a model defined in Swagger"""  # noqa: E501
        ...
        if api_specification is not None:
    ...
    def api_specification(self):
        """Gets the api_specification of this SiteIdApiIdBody.  # noqa: E501

        The API specification document. The supported format is OAS2 or OAS3 (JSON or YAML)  # noqa: E501

        :return: The api_specification of this SiteIdApiIdBody.  # noqa: E501
        :rtype: str
        """
    ...
    def api_specification(self, api_specification):
        """Sets the api_specification of this SiteIdApiIdBody.

        The API specification document. The supported format is OAS2 or OAS3 (JSON or YAML)  # noqa: E501

        :param api_specification: The api_specification of this SiteIdApiIdBody.  # noqa: E501
        :type: str
        """
    ...
    def description(self):
        """Gets the description of this SiteIdApiIdBody.  # noqa: E501

        A description that will help recognize the API in the dashboard  # noqa: E501

        :return: The description of this SiteIdApiIdBody.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this SiteIdApiIdBody.

        A description that will help recognize the API in the dashboard  # noqa: E501

        :param description: The description of this SiteIdApiIdBody.  # noqa: E501
        :type: str
        """
    ...
    def oas_file_name(self):
        """Gets the oas_file_name of this SiteIdApiIdBody.  # noqa: E501

        Uploaded OAS file name  # noqa: E501

        :return: The oas_file_name of this SiteIdApiIdBody.  # noqa: E501
        :rtype: str
        """
    ...
    def oas_file_name(self, oas_file_name):
        """Sets the oas_file_name of this SiteIdApiIdBody.

        Uploaded OAS file name  # noqa: E501

        :param oas_file_name: The oas_file_name of this SiteIdApiIdBody.  # noqa: E501
        :type: str
        """
    ...
    def specification_violation_action(self):
        """Gets the specification_violation_action of this SiteIdApiIdBody.  # noqa: E501

        The action taken when an API Specification Violation occurs  # noqa: E501

        :return: The specification_violation_action of this SiteIdApiIdBody.  # noqa: E501
        :rtype: str
        """
    ...
    def specification_violation_action(self, specification_violation_action):
        """Sets the specification_violation_action of this SiteIdApiIdBody.

        The action taken when an API Specification Violation occurs  # noqa: E501

        :param specification_violation_action: The specification_violation_action of this SiteIdApiIdBody.  # noqa: E501
        :type: str
        """
    ...
    def validate_host(self):
        """Gets the validate_host of this SiteIdApiIdBody.  # noqa: E501
        ...
        :return: The validate_host of this SiteIdApiIdBody.  # noqa: E501
        :rtype: bool
        """
    ...
    def validate_host(self, validate_host):
        """Sets the validate_host of this SiteIdApiIdBody.

        When set to true, verifies that the host name and site name match. Set to false in cases such as CNAME reuse or API management integrations where the host name and site name do not match.  # noqa: E501

        :param validate_host: The validate_host of this SiteIdApiIdBody.  # noqa: E501
        :type: bool
        """
    ...
    def violation_actions(self):
        """Gets the violation_actions of this SiteIdApiIdBody.  # noqa: E501
        ...
        :return: The violation_actions of this SiteIdApiIdBody.  # noqa: E501
        :rtype: str
        """
    ...
    def violation_actions(self, violation_actions):
        """Sets the violation_actions of this SiteIdApiIdBody.

        Json payload described by ViolationActions Object. This object defines different actions taken when each violation occurs  # noqa: E501

        :param violation_actions: The violation_actions of this SiteIdApiIdBody.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(SiteIdApiIdBody, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SiteIdApiIdBody):
            return False
