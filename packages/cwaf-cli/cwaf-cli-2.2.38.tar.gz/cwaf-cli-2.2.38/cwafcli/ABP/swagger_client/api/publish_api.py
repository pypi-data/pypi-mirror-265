...
class PublishApi(object):
    ...
    def v1_account_account_id_publish_latest_successful_get(self, account_id, **kwargs):  # noqa: E501
        """Gets the latest successful Publish for the Account  # noqa: E501

        Gets the latest successful Publish for the Account. If the account has never been successfully published this endpoint responds with Not Found.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1_account_account_id_publish_latest_successful_get(account_id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.v1_account_account_id_publish_latest_successful_get_with_http_info(account_id, **kwargs)  # noqa: E501
        else:
            (data) = self.v1_account_account_id_publish_latest_successful_get_with_http_info(account_id, **kwargs)  # noqa: E501
            return data

    def v1_account_account_id_publish_latest_successful_get_with_http_info(self, account_id, **kwargs):  # noqa: E501
        """Gets the latest successful Publish for the Account  # noqa: E501

        Gets the latest successful Publish for the Account. If the account has never been successfully published this endpoint responds with Not Found.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1_account_account_id_publish_latest_successful_get_with_http_info(account_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method v1_account_account_id_publish_latest_successful_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('account_id' not in params or
            ...
            raise ValueError("Missing the required parameter `account_id` when calling `v1_account_account_id_publish_latest_successful_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/account/{accountId}/publish/latest_successful', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def v1_publish_publish_id_get(self, publish_id, **kwargs):  # noqa: E501
        """Retrieve publish information  # noqa: E501

        Provides information about a published preflight.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1_publish_publish_id_get(publish_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param PublishId publish_id: Identifies a Publish to operate on. (required)
        :param int caid: Current Account ID. API keys are valid for an account and all of its sub accounts. When working with sub-accounts, this needs to be set to the corresponding Imperva account ID. Not specifying the parameter will default it to the main account's ID. 
        :return: InlineResponse2018
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.v1_publish_publish_id_get_with_http_info(publish_id, **kwargs)  # noqa: E501
        else:
            (data) = self.v1_publish_publish_id_get_with_http_info(publish_id, **kwargs)  # noqa: E501
            return data

    def v1_publish_publish_id_get_with_http_info(self, publish_id, **kwargs):  # noqa: E501
        """Retrieve publish information  # noqa: E501

        Provides information about a published preflight.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.v1_publish_publish_id_get_with_http_info(publish_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['publish_id', 'caid']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v1_publish_publish_id_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'publish_id' is set
        if ('publish_id' not in params or
                params['publish_id'] is None):
            raise ValueError("Missing the required parameter `publish_id` when calling `v1_publish_publish_id_get`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'publish_id' in params:
            path_params['publishId'] = params['publish_id']  # noqa: E501
