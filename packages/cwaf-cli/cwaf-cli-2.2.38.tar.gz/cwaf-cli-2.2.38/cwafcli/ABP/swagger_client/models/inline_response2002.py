...
import six
from swagger_client.models.account_default_encryption_key_v1 import AccountDefaultEncryptionKeyV1  # noqa: F401,E501

class InlineResponse2002(AccountDefaultEncryptionKeyV1):
    ...
    if hasattr(AccountDefaultEncryptionKeyV1, "swagger_types"):
        swagger_types.update(AccountDefaultEncryptionKeyV1.swagger_types)

    attribute_map = {
        'links': '_links'
    }
    if hasattr(AccountDefaultEncryptionKeyV1, "attribute_map"):
        attribute_map.update(AccountDefaultEncryptionKeyV1.attribute_map)
    ...
    def __init__(self, links=None, *args, **kwargs):  # noqa: E501
        ...
        self.links = links
        AccountDefaultEncryptionKeyV1.__init__(self, *args, **kwargs)
