...
class OneOfCreateDomainV1ChallengeIpLookupMode(object):
    ...
    def __init__(self):  # noqa: E501
        """OneOfCreateDomainV1ChallengeIpLookupMode - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OneOfCreateDomainV1ChallengeIpLookupMode, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OneOfCreateDomainV1ChallengeIpLookupMode):
            return False
