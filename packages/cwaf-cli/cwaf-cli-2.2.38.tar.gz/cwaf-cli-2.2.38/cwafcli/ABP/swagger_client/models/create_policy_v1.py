...
class CreatePolicyV1(object):
    ...
    swagger_types = {
        'name': 'Name',
        'description': 'str',
        'directives': 'list[CreateDirectiveV1]'
    }
    ...
    def __init__(self, name=None, description=None, directives=None):  # noqa: E501
        """CreatePolicyV1 - a model defined in Swagger"""  # noqa: E501
        self._name = None
    ...
    @property
    def name(self):
        """Gets the name of this CreatePolicyV1.  # noqa: E501


        :return: The name of this CreatePolicyV1.  # noqa: E501
        :rtype: Name
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this CreatePolicyV1.


        :param name: The name of this CreatePolicyV1.  # noqa: E501
        :type: Name
        """
        if name is None:
    ...
    def description(self):
        """Gets the description of this CreatePolicyV1.  # noqa: E501


        :return: The description of this CreatePolicyV1.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this CreatePolicyV1.


        :param description: The description of this CreatePolicyV1.  # noqa: E501
        :type: str
        """
    ...
    @property
    def directives(self):
        """Gets the directives of this CreatePolicyV1.  # noqa: E501


        :return: The directives of this CreatePolicyV1.  # noqa: E501
        :rtype: list[CreateDirectiveV1]
        """
        return self._directives

    @directives.setter
    def directives(self, directives):
        """Sets the directives of this CreatePolicyV1.


        :param directives: The directives of this CreatePolicyV1.  # noqa: E501
        :type: list[CreateDirectiveV1]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CreatePolicyV1, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CreatePolicyV1):
            return False
