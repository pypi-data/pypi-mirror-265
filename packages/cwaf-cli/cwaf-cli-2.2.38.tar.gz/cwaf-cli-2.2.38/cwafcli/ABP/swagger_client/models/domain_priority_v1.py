...
class DomainPriorityV1(object):
    ...
    def __init__(self, domain_ids=None):  # noqa: E501
        """DomainPriorityV1 - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def domain_ids(self):
        """Gets the domain_ids of this DomainPriorityV1.  # noqa: E501

        The domain IDs in order of priority. The first element has the highest priority.   # noqa: E501

        :return: The domain_ids of this DomainPriorityV1.  # noqa: E501
        :rtype: list[DomainId]
        """
    ...
    def domain_ids(self, domain_ids):
        """Sets the domain_ids of this DomainPriorityV1.

        The domain IDs in order of priority. The first element has the highest priority.   # noqa: E501

        :param domain_ids: The domain_ids of this DomainPriorityV1.  # noqa: E501
        :type: list[DomainId]
        """
        if domain_ids is None:
            raise ValueError("Invalid value for `domain_ids`, must not be `None`")  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DomainPriorityV1, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DomainPriorityV1):
            return False
