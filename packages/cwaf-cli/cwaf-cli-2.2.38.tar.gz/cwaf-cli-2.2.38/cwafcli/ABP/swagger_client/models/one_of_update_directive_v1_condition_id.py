...
class OneOfUpdateDirectiveV1ConditionId(object):
    ...
    def __init__(self):  # noqa: E501
        """OneOfUpdateDirectiveV1ConditionId - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OneOfUpdateDirectiveV1ConditionId, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OneOfUpdateDirectiveV1ConditionId):
            return False
