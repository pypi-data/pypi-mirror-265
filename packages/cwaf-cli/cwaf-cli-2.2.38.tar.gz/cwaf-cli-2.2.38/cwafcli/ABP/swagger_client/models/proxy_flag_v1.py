...
class ProxyFlagV1(object):
    ...
    allowed enum values
    """
    ENABLE_REFERRER_FIX = "enable_referrer_fix"
    DONT_MINIFY_POST_RESUBMIT_ERROR_PAGE = "dont_minify_post_resubmit_error_page"
    INJECT_JS_INTO_BODY = "inject_js_into_body"
    """
    Attributes:
    ...
    def __init__(self):  # noqa: E501
        """ProxyFlagV1 - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ProxyFlagV1, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProxyFlagV1):
            return False
