...
import six
from swagger_client.models.account_v1 import AccountV1  # noqa: F401,E501

class InlineResponse2001(AccountV1):
    ...
    if hasattr(AccountV1, "swagger_types"):
        swagger_types.update(AccountV1.swagger_types)

    attribute_map = {
        'links': '_links'
    }
    if hasattr(AccountV1, "attribute_map"):
        attribute_map.update(AccountV1.attribute_map)
    ...
    def __init__(self, links=None, *args, **kwargs):  # noqa: E501
        ...
        self.links = links
        AccountV1.__init__(self, *args, **kwargs)
