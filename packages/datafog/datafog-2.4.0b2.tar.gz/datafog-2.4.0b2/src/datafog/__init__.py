...
class DataFog:
    ...
    def upload_file(uploaded_file_path):
        ...
        if not uploaded_file_path.exists():
            ...
            if uploaded_file_path.suffix == ".ppt" or uploaded_file_path.suffix == ".pptx":
                # install unstructured[pptx] to support pptx files
                
                elements = partition_pptx(uploaded_file_path)
                text = ""
