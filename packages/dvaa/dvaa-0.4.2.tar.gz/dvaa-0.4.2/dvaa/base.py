...
def parse(obj, required_properties=None, additional_properties=None,
    ...
    :param required_properties: Specifies for this parse call whether parsed
        :py:class:`~dvaa.validators.Object` properties are required or
        optional by default. It can be:

        - ``True`` for required.
        - ``False`` for optional.
        - ``None`` to use the value of the
          :py:attr:`~dvaa.validators.Object.REQUIRED_PROPERTIES` attribute.

    :param additional_properties: Specifies for this parse call the schema of
        all :py:class:`~dvaa.validators.Object` properties that are not
        ...
        - :py:attr:`~dvaa.validators.Object.REMOVE` to remove any additional
          properties from the adapted object.
        - ``None`` to use the value of the
          :py:attr:`~dvaa.validators.Object.ADDITIONAL_PROPERTIES` attribute.
    ...
    :param ignore_optional_property_errors: Determines if invalid optional
        ...
        - ``None`` to use the value of the
          :py:attr:`~dvaa.validators.Object.IGNORE_OPTIONAL_PROPERTY_ERRORS`
          attribute.
    ...
    .. warning:: Passing ``required_properties`` and/or ``additional_properties``
        ...
        :py:class:`~dvaa.validators.Nullable` has already parsed its argument
        with the default value of ``required_properties``. Several other builtin
        validators work similarly to :py:class:`~dvaa.validators.Nullable`,
