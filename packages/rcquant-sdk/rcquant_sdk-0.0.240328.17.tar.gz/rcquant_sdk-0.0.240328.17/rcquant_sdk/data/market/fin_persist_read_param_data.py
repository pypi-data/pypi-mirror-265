...
class FinPersistReadParamData(IData):
    def __init__(self, table_name: str = '', range: str = '', start_date: int = 0, end_date: int = 99999999,
                 data_fileds: List[FinPersistFiledData] = [], base_path: str = ''):
        ...
        self._DataFileds: List[FinPersistFiledData] = data_fileds
