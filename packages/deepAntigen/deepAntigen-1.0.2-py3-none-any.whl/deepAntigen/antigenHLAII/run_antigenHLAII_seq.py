...
def Train(k_fold_dir, config_path=''):
    ...
    train_dataset = pMHC_DataSet(train_path,num_process=args['num_process'],aug=True,test=False)
    val_dataset = pMHC_DataSet(val_path,num_process=args['num_process'],aug=False,test=False)
    start_epoch = 0
