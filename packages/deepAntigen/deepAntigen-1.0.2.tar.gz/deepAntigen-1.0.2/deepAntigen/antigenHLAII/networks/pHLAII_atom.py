...
class DeepGCN(MessagePassing):
    def __init__(self, args, aggr='add'):
        ...
        self.projector_atom = pyg_linear.Linear(args['hidden_size'], int(0.5*args['hidden_size']), weight_initializer='glorot')
        self.classier_atom = pyg_linear.Linear(int(0.5*args['hidden_size']), 2, weight_initializer='glorot')
