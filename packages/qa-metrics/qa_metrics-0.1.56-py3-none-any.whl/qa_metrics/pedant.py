...
from .utils.tools import normalize_answer, download_link, remove_punctuation, file_needs_update
import joblib
...
class PEDANT:
    ...
    def get_scores(self, reference, candidate, question):
        ...
        if isinstance(reference, list) and isinstance(candidate, list):
            ...
            references = [remove_punctuation(normalize_answer(str(ele))) for ele in reference]
            candidates = remove_punctuation(normalize_answer(str(candidate)))
            question = remove_punctuation(normalize_answer(str(question)))
