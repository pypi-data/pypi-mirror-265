...
import numpy as np
import gc
from tools.image import type_as
from tools.array import ima_minmax, ima_pad_blk, ima_pad_crop, ima_rgb2l
from intrinsic_images.multiple_task import transform
...
def chikkerur2007(im):
    ...
    o, f, m, c = estimation_transform.chikkerur2007(im)
...
def chikkerur2007_no_smooth(im):
    """2007年Chikkerur提出的指纹指纹增强算法"""
    o, f, m, c = estimation_transform.chikkerur2007(im, smo_itn=0, smf_itn=0)
    out = filter_chikkerur(im, o, f)
    out = m*out
    return out, o, f, m, c
