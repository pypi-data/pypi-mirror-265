...
class LSVMArena(LocalArena):
    def __init__(self, num_cycles_per_player = 3, players=[], timeout=1, handin=False, logging_path = None, save_path = None, elo_path = "handin/results/lsvm/elo_ranking.json", local_save_path = None, num_rounds = 2500):
        ...
        if self.handin_mode:
            self.elo_path = pkg_resources.resource_filename('agt_server', elo_path)
        else: 
            self.elo_path = "local_elo_ranking.json"
