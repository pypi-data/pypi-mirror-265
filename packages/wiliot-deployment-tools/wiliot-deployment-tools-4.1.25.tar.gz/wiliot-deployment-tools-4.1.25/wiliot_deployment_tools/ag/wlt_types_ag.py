...
SUB1G_ENERGY_PATTERN_IDX_0 = 0x00
SUB1G_ENERGY_PATTERN_IDX_1 = 0x01
SUB1G_ENERGY_PATTERN_IDX_2 = 0x02
SUB1G_ENERGY_PATTERN_IDX_3 = 0x03
SUB1G_ENERGY_PATTERN_IDX_4 = 0x04
SUB1G_ENERGY_PATTERN_IDX_5 = 0x05
SUB1G_ENERGY_PATTERN_IDX_6 = 0x06
SUB1G_ENERGY_PATTERN_IDX_7 = 0x07
SUB1G_ENERGY_PATTERN_IDX_8 = 0x08
SUB1G_ENERGY_PATTERN_IDX_9 = 0x09
SUB1G_ENERGY_PATTERN_IDX_LAST = SUB1G_ENERGY_PATTERN_IDX_9
...
ENERGY_PATTERN_2_4_IDX_0 = 0x00
ENERGY_PATTERN_2_4_IDX_1 = 0x01
ENERGY_PATTERN_2_4_IDX_2 = 0x02
ENERGY_PATTERN_2_4_IDX_3 = 0x03
ENERGY_PATTERN_2_4_IDX_4 = 0x04
ENERGY_PATTERN_2_4_IDX_5 = 0x05
ENERGY_PATTERN_2_4_IDX_6 = 0x06
ENERGY_PATTERN_2_4_IDX_LAST = ENERGY_PATTERN_2_4_IDX_6
...
BRG_DEFAULT_SB_ENERGY_PATTERN_IDX = ENERGY_PATTERN_2_4_IDX_3
...
INTERNAL_BRG_DEFAULT_COMM_PATTERN = 0
INTERNAL_BRG_DEFAULT_PACER_INTERVAL = 15
INTERNAL_BRG_DEFAULT_PKT_FILTER = 19
INTERNAL_BRG_DEFAULT_CALIB_INTERVAL = 10
INTERNAL_BRG_DEFAULT_CALIB_PATTERN = 3
INTERNAL_BRG_DEFAULT_CALIB_OUTPUT_POWER = RADIO_TX_POWER_POS_8_DBM
INTERNAL_BRG_DEFAULT_ENERGY_DUTY_CYCLE_2_4 = 30
INTERNAL_BRG_DEFAULT_ENERGY_PATTERN_2_4_IDX = ENERGY_PATTERN_2_4_IDX_0
...
class ModuleEnergy2400V9():
    def __init__(self, raw='', module_type=MODULE_ENERGY_2400, msg_type=BRG_MGMT_MSG_TYPE_CFG_SET, api_version=API_VERSION_V9, seq_id=0, brg_mac=0, duty_cycle=BRG_DEFAULT_ENERGY_DUTY_CYCLE_2_4, energy_pattern_2400=BRG_DEFAULT_ENERGY_PATTERN_2_4_IDX, output_power=BRG_DEFAULT_OUTPUT_POWER_2_4, unused0=0):
        self.module_type = module_type
        self.msg_type = msg_type
        self.api_version = api_version
        self.seq_id = seq_id
...
class ModuleEnergySub1GV9():
    def __init__(self, raw='', module_type=MODULE_ENERGY_SUB1G, msg_type=BRG_MGMT_MSG_TYPE_CFG_SET, api_version=API_VERSION_V9, seq_id=0, brg_mac=0, output_power=BRG_DEFAULT_OUTPUT_POWER_SUB1G, sub1g_energy_pattern=BRG_DEFAULT_SUB1G_ENERGY_PATTERN_IDX, cycle=BRG_DEFAULT_SUB1G_CYCLE, duty_cycle=BRG_DEFAULT_SUB1G_DUTY_CYCLE, unused0=0):
        self.module_type = module_type
        self.msg_type = msg_type
        self.api_version = api_version
        self.seq_id = seq_id
...
WLT_PKT_TYPES = [UnifiedEchoPkt, ActionGenericV9, ActionGenericV8, ActionGenericV7, ActionGwHbV9, ActionGwHbV8, ActionRebootV9, ActionRebootV8, ActionBlinkV9, ActionBlinkV8, ActionGetModuleV9, ActionGetModuleV8, ActionRestoreDefaultsV9, ActionRestoreDefaultsV8, ActionSendHbV9, ActionSendHbV8, ActionGetBatterySensorV9, ActionGetBatterySensorV8, ActionGetPofDataV9, ActionGetPofDataV8, Brg2BrgOtaV9, Brg2BrgCfgV9, Gw2BrgCfgV9, Gw2BrgCfgV8, Gw2BrgCfgV7, Brg2GwCfgV8, Brg2GwCfgV7, Brg2GwCfgV6, Brg2GwCfgV5, Brg2GwCfgV2, Brg2GwHbV9, Brg2GwHbV8, Brg2GwHbV7, Brg2GwHbV6, Brg2GwHbV5, Brg2GwHbV1, SideInfo, SideInfoSensor, ModuleIfV9, ModuleIfV8, ModuleIfV7, ModuleCalibrationV9, ModuleCalibrationV8, ModuleCalibrationV7, ModuleDatapathV9, ModuleDatapathV8, ModuleDatapathV7, ModuleEnergy2400V9, ModuleEnergy2400V8, ModuleEnergy2400V7, ModuleEnergySub1GV9, ModuleEnergySub1GV8, ModuleEnergySub1GV7, ModulePwrMgmtV9, ModulePwrMgmtV8, ModulePwrMgmtV7, ModuleExtSensorsV9, ModuleExtSensorsV8, ModuleExtSensorsV7, ModuleCustomV9, ModuleCustomV8, ModuleCustomV7, ModuleCustomLis2Dw12V9, ModuleCustomLis2Dw12V8, ModuleCustomLis2Dw12V7]