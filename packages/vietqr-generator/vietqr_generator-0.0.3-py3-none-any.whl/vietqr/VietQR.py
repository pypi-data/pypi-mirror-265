...
def genVietQR(is_dynamic_qr:bool=False, merchant_category="5812", merchant_name="_",
              ...
              ref_label="", customer_label="", terminal_label="", purpose_txn="", additional_data="",
              lang_ref="", local_merchant_name="", local_merchant_city="", uuid="",
              ipn_url="", app_package_name="",embeded_image_path=False):
    ...
    qr.make(fit=True)
    if embeded_image_path and type(embeded_image_path) is str:
        return qr.make_image(image_factory=StyledPilImage, embeded_image_path=embeded_image_path)
    else:
