...
#         name=package_name,
#         version=get_version(),
#         author="Renleilei",  # 作者名称
#         author_email="renleilei_yang@outlook.com", # 作者邮箱
#         description="An AI coach being constructed", # 库描述
...
setuptools.setup(
    ...
    description="An AI coach being constructed",
    long_description="AI_Coach_RLL",
    long_description_content_type="text/markdown",
    packages=setuptools.find_packages(),
    classifiers=[
        "Programming Language :: Python :: 3",
