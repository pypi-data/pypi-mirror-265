...
class ServiceListView(generic.ObjectListView):
    ...
    def __init__(self, *args, **kwargs):
        if NETBOX_CURRENT_VERSION >= version.parse("3.4"):
            self.template_name = "nb_service_ntt/3.x/custom_list_3.4.html"
        elif NETBOX_CURRENT_VERSION >= version.parse(
            "3.0"
        ) and NETBOX_CURRENT_VERSION < version.parse("3.4"):
            self.template_name = "nb_service_ntt/3.x/custom_list.html"
        else:
            self.template_name = "nb_service_ntt/2.x/custom_list.html"
...
class ServiceView(generic.ObjectView):
    ...
    def __init__(self, *args, **kwargs):
        if NETBOX_CURRENT_VERSION >= version.parse("3.0"):
            self.template_name = "nb_service_ntt/3.x/service/service_view.html"
        else:
            self.template_name = "nb_service_ntt/2.x/service/service_view.html"
        super().__init__(*args, *kwargs)
...
class ServiceDiagramView(generic.ObjectView):
    ...
    def __init__(self, *args, **kwargs):
        if NETBOX_CURRENT_VERSION >= version.parse("3.0"):
            self.template_name = "nb_service_ntt/3.x/service/service_diagram_view.html"
        else:
            self.template_name = "nb_service_ntt/2.x/service/service_diagram_view.html"
        super().__init__(*args, *kwargs)
...
class ServiceICView(generic.ObjectView):
    ...
    def __init__(self, *args, **kwargs):
        if NETBOX_CURRENT_VERSION >= version.parse("3.0"):
            self.template_name = "nb_service_ntt/3.x/service/service_IC_view.html"
        else:
            self.template_name = "nb_service_ntt/2.x/service/service_IC_view.html"
        super().__init__(*args, *kwargs)
...
class ServiceRelationView(generic.ObjectView):
    ...
    def __init__(self, *args, **kwargs):
        if NETBOX_CURRENT_VERSION >= version.parse("3.0"):
            self.template_name = "nb_service_ntt/3.x/service/service_Relation_view.html"
        else:
            self.template_name = "nb_service_ntt/2.x/service/service_Relation_view.html"
        super().__init__(*args, *kwargs)
...
class ServiceEditView(generic.ObjectEditView):
    ...
    def __init__(self, *args, **kwargs):
        if NETBOX_CURRENT_VERSION >= version.parse("3.0"):
            self.template_name = "nb_service_ntt/3.x/obj_edit.html"
        else:
            self.template_name = "nb_service_ntt/2.x/obj_edit.html"
        super().__init__(*args, *kwargs)
...
if NETBOX_CURRENT_VERSION >= version.parse("3.0"):
    from nb_service_ntt.views_3_x import ServiceDeleteView as ServiceDeleteView_3x
    from nb_service_ntt.views_3_x import (
        ApplicationDeleteView as ApplicationDeleteView_3x,
    )

    ServiceDeleteView = ServiceDeleteView_3x
    ApplicationDeleteView = ApplicationDeleteView_3x
else:
    from nb_service_ntt.views_2_x import ServiceDeleteView as ServiceDeleteView_2x
    from nb_service_ntt.views_2_x import (
        ApplicationDeleteView as ApplicationDeleteView_2x,
    )
...
class ICCreateView(generic.ObjectEditView):
    ...
    def __init__(self, *args, **kwargs):
        if NETBOX_CURRENT_VERSION >= version.parse("3.0"):
            self.template_name = "nb_service_ntt/3.x/IC/ic_edit.html"
        else:
            self.template_name = "nb_service_ntt/2.x/IC/ic_edit.html"
        super().__init__(*args, *kwargs)
    ...
    def alter_obj(self, obj, request, url_args, url_kwargs):
        ...
        if "interface" in request.POST:
            try:
                obj.assigned_object = Interface.objects.get(
                    pk=request.POST["interface"]
                )
        ...
        if "application" in request.POST:
            try:
                obj.assigned_object = models.Application.objects.get(
                    pk=request.POST["application"]
                )
...
class ApplicationView(generic.ObjectView):
    ...
    def __init__(self, *args, **kwargs):
        if NETBOX_CURRENT_VERSION >= version.parse("3.0"):
            self.template_name = "nb_service_ntt/3.x/Application/application_view.html"
        else:
            self.template_name = "nb_service_ntt/2.x/Application/application_view.html"
        super().__init__(*args, *kwargs)
...
class ApplicationDevicesView(generic.ObjectView):
    ...
    def __init__(self, *args, **kwargs):
        if NETBOX_CURRENT_VERSION >= version.parse("3.0"):
            self.template_name = "nb_service_ntt/3.x/Application/application_objs.html"
        else:
            self.template_name = "nb_service_ntt/2.x/Application/application_objs.html"
        super().__init__(*args, *kwargs)
