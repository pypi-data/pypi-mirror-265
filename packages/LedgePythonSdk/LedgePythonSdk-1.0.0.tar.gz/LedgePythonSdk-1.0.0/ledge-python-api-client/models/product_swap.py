...
class ProductSwap(BaseModel):
    ...
    Model ProductSwap
    """ # noqa: E501
    swappable_product_id: StrictStr = Field(alias="swappableProductId")
    ...
    id: StrictStr
    __properties: ClassVar[List[str]] = ["swappableProductId", "productId", "chance", "qty", "title", "updatedAt", "createdAt", "id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "swappableProductId": obj.get("swappableProductId"),
