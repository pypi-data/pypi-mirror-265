...
class GameGenreDetailed(BaseModel):
    """
    GameGenreDetailed
    """ # noqa: E501
    genre_id: StrictStr = Field(alias="genreId")
    game_id: StrictStr = Field(alias="gameId")
    updated_at: datetime = Field(alias="updatedAt")
    created_at: datetime = Field(alias="createdAt")
    id: StrictStr
    genre: Optional[Genre]
    __properties: ClassVar[List[str]] = ["genreId", "gameId", "updatedAt", "createdAt", "id", "genre"]
