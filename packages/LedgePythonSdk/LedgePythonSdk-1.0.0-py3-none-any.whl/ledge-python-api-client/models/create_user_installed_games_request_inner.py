...
class CreateUserInstalledGamesRequestInner(BaseModel):
    """
    CreateUserInstalledGamesRequestInner
    """ # noqa: E501
    package_name: StrictStr = Field(alias="packageName")
    first_installed_time: Union[StrictFloat, StrictInt] = Field(alias="firstInstalledTime")
    __properties: ClassVar[List[str]] = ["packageName", "firstInstalledTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "firstInstalledTime": obj.get("firstInstalledTime")
        })
        return _obj
