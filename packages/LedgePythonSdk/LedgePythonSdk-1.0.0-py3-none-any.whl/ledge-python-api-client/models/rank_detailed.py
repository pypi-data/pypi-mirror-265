...
class RankDetailed(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["leaderboardId", "rank", "playerId", "updatedAt", "createdAt", "id", "stats", "player"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "stats": [PlayerStats.from_dict(_item) for _item in obj["stats"]] if obj.get("stats") is not None else None,
            "player": User.from_dict(obj["player"]) if obj.get("player") is not None else None
        })
        return _obj
