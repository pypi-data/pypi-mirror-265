...
class ToxicityAPIPROFANITY(MetricBase):
    name: str = 'profanity' # changes to toxicity_with_perspective_api
    input_type: Any = 'text'
    ...
    def compute(self,api_key,text):
        ...
        insult = response['attributeScores']['PROFANITY']['summaryScore']['value']
