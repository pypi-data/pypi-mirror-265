...
def load_eeg_mr4(eeg_path):
    ...
    ecg = (data[0, :] - 32767) / 65536 * 2.0 * 1000 * 1000 / 192
    emg = (data[1, :] - 32767) / 65536 * 2.0 * 1000 * 1000 / 192
    eeg0 = (data[2, :] - 32767) / 65536 * 2.0 * 1000 * 1000 / 192
    eeg1 = (data[3, :] - 32767) / 65536 * 2.0 * 1000 * 1000 / 192
    # start time
    eeg_data.seek(33, 0)
