...
def load_eeg_mr2(eeg_path):
    ...
    eeg0 = (data[0, :] - 32767) / 65536 * 2.0 * 1000 * 1000 / 192
    eeg1 = (data[1, :] - 32767) / 65536 * 2.0 * 1000 * 1000 / 192
    ...
    return eeg0, eeg1, eeg_start_time, disconnect_rate, package_loss_rate, header_mac, box_mac
