...
class Event(_message.Message):
    __slots__ = ["signature", "store_manifest", "update_manifest", "create_item", "update_item", "create_tag", "add_to_tag", "remove_from_tag", "rename_tag", "delete_tag", "create_cart", "change_cart", "change_stock", "new_key_card"]
...
class CommitCartResponse(_message.Message):
    __slots__ = ["request_id", "error", "purchase_address", "totals", "total_in_crypto"]
    ...
    REQUEST_ID_FIELD_NUMBER: _ClassVar[int]
    ERROR_FIELD_NUMBER: _ClassVar[int]
    PURCHASE_ADDRESS_FIELD_NUMBER: _ClassVar[int]
    TOTALS_FIELD_NUMBER: _ClassVar[int]
    TOTAL_IN_CRYPTO_FIELD_NUMBER: _ClassVar[int]
    request_id: bytes
    error: Error
    purchase_address: bytes
    totals: _containers.ScalarMap[str, str]
    total_in_crypto: str
    def __init__(self, request_id: _Optional[bytes] = ..., error: _Optional[_Union[Error, _Mapping]] = ..., purchase_address: _Optional[bytes] = ..., totals: _Optional[_Mapping[str, str]] = ..., total_in_crypto: _Optional[str] = ...) -> None: ...
