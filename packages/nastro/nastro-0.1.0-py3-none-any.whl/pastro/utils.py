...
# TODO: REALLOCATE NON-CONVERSION FUNCTIONS AND REMOVE THIS FILE
...
def get_acceleration(
    t: Vector, s: CartesianState, forces: ForceModel
) -> CartesianStateDerivative:
...
def global_diff(s: CartesianState, ref: CartesianState) -> tuple[Vector, Vector]:
...
def cglobal_diff(s: CartesianState, ref: CartesianState) -> tuple[float, float]:
