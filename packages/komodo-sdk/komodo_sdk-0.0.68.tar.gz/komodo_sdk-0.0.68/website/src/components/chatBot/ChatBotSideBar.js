              ...
              <button
                className={`${
                  activeTab === 1
                    ...
                    : "bg-transparent"
                } px-10 py-2 xxl:px-3 sm:text-[16px] cursor-pointer rounded-[10px]`}
                onClick={() => changeTab(1)}
              >
                Files
              </button>
              <button
                className={`${
                  activeTab === 2
                    ? "bg-white text-customColor"
                    : "bg-transparent"
                } px-5 py-2 xxl:px-3 sm:text-[16px] cursor-pointer rounded-[10px]`}
                onClick={() => changeTab(2)}
              >
                Conversation
              </button>
                  ...
                  return (
                    <div
                      ...
                      onClick={() => {
                        ...
                        contextFiles?.handleFileData(id, val?.guid);
