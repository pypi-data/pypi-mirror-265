...
collection = Collection(shortcode=str(uuid.uuid4()), name="My Collection", description="My Collection Description")
print(collection)
...
report = Report(guid=str(uuid.uuid4()), name="My Report", description="My Report Description")
print(report)
