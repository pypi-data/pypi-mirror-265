...
# Processing tool call: call_2EuEj837GZm8VnZdMYScl3Ml Type: function Function: multi_tool_use.parallel Arguments: {"tool_uses":[{"recipient_name":"functions.komodo_file_reader","parameters":{"folder":"/data/komodo/users/ryan@komodoapp.ai/collections/011eb4d4","filename":"8b5cb351.pdf"}},{"recipient_name":"functions.komodo_file_reader","parameters":{"folder":"/data/komodo/users/ryan@komodoapp.ai/collections/011eb4d4","filename":"42a9b5f3.pdf"}},{"recipient_name":"functions.komodo_file_reader","parameters":{"folder":"/data/komodo/users/ryan@komodoapp.ai/collections/011eb4d4","filename":"d681fa74.pdf"}},{"recipient_name":"functions.komodo_file_reader","parameters":{"folder":"/data/komodo/users/ryan@komodoapp.ai/collections/011eb4d4","filename":"45ef737c.pdf"}},{"recipient_name":"functions.komodo_file_reader","parameters":{"folder":"/data/komodo/users/ryan@komodoapp.ai/collections/011eb4d4","filename":"121df388.pdf"}},{"recipient_name":"functions.komodo_file_reader","parameters":{"folder":"/data/komodo/users/ryan@komodoapp.ai/collections/011eb4d4","filename":"331edb86.pdf"}},{"recipient_name":"functions.komodo_file_reader","parameters":{"folder":"/data/komodo/users/ryan@komodoapp.ai/collections/011eb4d4","filename":"45d84309.pdf"}}]}

## Processing tool call: call_8WwKHzhpmznl17eieO1K2lbD
# Type: function Function: parallel
# Arguments: {"tool_uses":
# [{"recipient_name":"functions.elastic_count","parameters":{"index":"test-index","body":"{\"query\":{\"match_all\":{}}"}},
# {"recipient_name":"functions.elastic_count","parameters":{"index":"test-index2","body":"{\"query\":{\"match_all\":{}}"}}]}
# Requested tool parallel is not available
