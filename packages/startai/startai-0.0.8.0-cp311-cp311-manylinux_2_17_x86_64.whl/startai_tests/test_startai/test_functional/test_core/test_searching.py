...
@handle_test(
    fn_tree="functional.startai.argmax",
...
@handle_test(
    fn_tree="functional.startai.argmin",
    dtype_x_axis=_dtype_x_limited_axis(allow_none=True),
    keepdims=st.booleans(),
...
# argwhere
@handle_test(
    fn_tree="functional.startai.argwhere",
...
@handle_test(
    fn_tree="functional.startai.nonzero",
...
@handle_test(
    fn_tree="functional.startai.where",
