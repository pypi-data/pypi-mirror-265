...
from startai.functional.frontends.paddle import Tensor
from startai_tests.test_startai.helpers import assert_all_close
from startai_tests.test_startai.helpers import handle_frontend_method, BackendHandler
from startai_tests.test_startai.test_functional.test_experimental.test_core.test_manipulation import (  # noqa E501
...
from startai_tests.test_startai.test_frontends.test_paddle.test_manipulation import (
    _tile_helper,
)

CLASS_TREE = "startai.functional.frontends.paddle.Tensor"
...
def test_paddle_device(
    ...
    startai.utils.assertions.check_equal(
        x.place, startai.dev(startai.array(data[0])), as_array=False
    )
...
def test_paddle_eigvals(
    ...
    with BackendHandler.update_backend(backend_fw) as startai_backend:
        # check if Tensor or startai array
        try:
            ret = ret.startai_array.to_numpy()
        except AttributeError:
            ret = startai_backend.to_numpy(ret)
