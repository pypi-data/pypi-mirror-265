...
from startai_tests.test_startai.helpers import handle_frontend_test, matrix_is_stable
from startai_tests.test_startai.test_functional.test_core.test_linalg import (
    _get_dtype_and_matrix,
)

from startai_tests.test_startai.test_frontends.test_tensorflow.test_linalg import (
    _get_second_matrix,
...
def _dtype_values_axis(draw):
    ...
    p_list = ["fro", 1, 2, startai.inf, -startai.inf]
