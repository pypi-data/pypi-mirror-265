...
class _ContainerWithDataTypes(ContainerBase):
    ...
    def _static_astype(
        x: startai.Container,
        dtype: Union[startai.Dtype, startai.Container],
        ...
        *,
        ...
        Examples
        --------
        >>> c = startai.Container(a=startai.array([False,True,True]),
        ...                   b=startai.array([3.14, 2.718, 1.618]))
        >>> startai.Container.static_astype(c, startai.int32)
        {
    ...
    def _static_broadcast_arrays(
        *arrays: Union[startai.Container, startai.Array, startai.NativeArray],
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        prune_unapplied: Union[bool, startai.Container] = False,
        map_sequences: Union[bool, startai.Container] = False,
    ) -> startai.Container:
        """`startai.Container` static method variant of `startai.broadcast_arrays`.
        ...
        >>> x1 = startai.Container(a=startai.array([1, 2]), b=startai.array([3, 4]))
        >>> x2 = startai.Container(a=startai.array([-1.2, 0.4]), b=startai.array([0, 1]))
        >>> y = startai.Container.static_broadcast_arrays(x1, x2)
        >>> print(y)
        [{
            a: startai.array([1, 2]),
            b: startai.array([3, 4])
        }, {
            a: startai.array([-1.2, 0.4]),
            b: startai.array([0, 1])
        }]

        With mixed :class:`startai.Container` and :class:`startai.Array` inputs:

        >>> x1 = startai.Container(a=startai.array([4, 5]), b=startai.array([2, -1]))
        >>> x2 = startai.array([0.2, 3.])
        >>> y = startai.Container.static_broadcast_arrays(x1, x2)
        >>> print(y)
        [{
            a: startai.array([4, 5]),
            ...
            a: startai.array([0.2, 3.]),
            b: startai.array([0.2, 3.])
        }]
        """
        return ContainerBase.cont_multi_map_in_function(
            "broadcast_arrays",
    ...
    def broadcast_arrays(
        ...
        *arrays: Union[startai.Container, startai.Array, startai.NativeArray],
        ...
        """`startai.Container` instance method variant of `startai.broadcast_arrays`.
        This method simply wraps the function, and so the docstring for
        `startai.broadcast_arrays` also applies to this method with minimal
        changes.
    ...
    def _static_broadcast_to(
        ...
        *,
        ...
        """`startai.Container` static method variant of `startai.broadcast_to`. This
        ...
        ...                   b=startai.array([2]))
        >>> y = startai.Container.static_broadcast_to(x,(3, 1))
        >>> print(y)
        {
            a: startai.array([1],
                         [1],
    ...
    def broadcast_to(
        ...
        *,
        ...
        """`startai.Container` instance method variant of `startai.broadcast_to`. This
        method simply wraps the function, and so the docstring for
        `startai.broadcast_to` also applies to this method with minimal changes.
        ...
        >>> x = startai.Container(a=startai.array([0, 0.5]),
        ...                   b=startai.array([4, 5]))
        >>> y = x.broadcast_to((3,2))
        >>> print(y)
        {
            a: startai.array([[0., 0.5],
                          [0., 0.5],
                          [0., 0.5]]),
            b: startai.array([[4, 5],
                          [4, 5],
    ...
    def _static_can_cast(
        from_: startai.Container,
        to: Union[startai.Dtype, startai.Container],
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        prune_unapplied: Union[bool, startai.Container] = False,
        map_sequences: Union[bool, startai.Container] = False,
    ) -> startai.Container:
        """`startai.Container` static method variant of `startai.can_cast`. This method
        ...
        >>> print(startai.Container.static_can_cast(x, 'int64'))
        {
            a: false,
            b: true
        }
    ...
    def can_cast(
        ...
        """`startai.Container` instance method variant of `startai.can_cast`. This
        method simply wraps the function, and so the docstring for
        `startai.can_cast` also applies to this method with minimal changes.
    ...
    def _static_dtype(
        x: startai.Container,
        *,
        as_native: Union[bool, startai.Container] = False,
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        prune_unapplied: Union[bool, startai.Container] = False,
        map_sequences: Union[bool, startai.Container] = False,
    ...
    def _static_default_float_dtype(
        *,
        input: Optional[Union[startai.Array, startai.NativeArray, startai.Container]] = None,
        float_dtype: Optional[
            Union[startai.FloatDtype, startai.NativeDtype, startai.Container]
        ] = None,
        as_native: Optional[Union[bool, startai.Container]] = None,
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        prune_unapplied: Union[bool, startai.Container] = False,
        map_sequences: Union[bool, startai.Container] = False,
    ...
    def _static_finfo(
        ...
        *,
        ...
        """`startai.Container` static method variant of `startai.finfo`.
        ...
        >>> y = startai.Container.static_finfo(c)
        >>> print(y)
        {
    ...
    def finfo(
        ...
        *,
        ...
        """`startai.Container` instance method variant of `startai.finfo`.
    ...
    def _static_iinfo(
        ...
        *,
        ...
        """`startai.Container` static method variant of `startai.iinfo`. This method
        ...
        Examples
        --------
        >>> c = startai.Container(x=startai.array([12,-1800,1084], dtype=startai.int16),
        ...                   y=startai.array([-40000,99,1], dtype=startai.int32))
        >>> y = startai.Container.static_iinfo(c)
        >>> print(y)
        {
    ...
    def iinfo(
        ...
        """`startai.Container` instance method variant of `startai.iinfo`. This method
        simply wraps the function, and so the docstring for `startai.iinfo` also
        applies to this method with minimal changes.
        ...
        Examples
        --------
        >>> c = startai.Container(x=startai.array([-9,1800,89], dtype=startai.int16),
        ...                   y=startai.array([76,-81,16], dtype=startai.int32))
        >>> c.iinfo()
        {
            x: iinfo(min=-32768, max=32767, dtype=int16),
            y: iinfo(min=-2147483648, max=2147483647, dtype=int32)
        ...
        >>> c = startai.Container(x=startai.array([-12,123,4], dtype=startai.int8),
        ...                   y=startai.array([76,-81,16], dtype=startai.int16))
        >>> c.iinfo()
        {
    ...
    def _static_is_float_dtype(
        ...
        """`startai.Container` static method variant of `is_float_dtype`. This
        ...
        Examples
        --------
        >>> x = startai.static_is_float_dtype(startai.float32)
        >>> print(x)
        True

        >>> x = startai.static_is_float_dtype(startai.int64)
        >>> print(x)
        False

        >>> x = startai.static_is_float_dtype(startai.int32)
        >>> print(x)
        False

        >>> x = startai.static_is_float_dtype(startai.bool)
        >>> print(x)
        False
    ...
    def is_float_dtype(
        ...
        """`startai.Container` instance method variant of `startai.is_float_dtype`.
        This method simply wraps the function, and so the docstring for
        `startai.is_float_dtype` also applies to this method with minimal changes.

        Parameters
        ----------
        self : startai.Container
            The `startai.Container` instance to call `startai.is_float_dtype` on.
        ...
        >>> x = startai.is_float_dtype(startai.int64)
        >>> print(x)
        False

        >>> x = startai.is_float_dtype(startai.int32)
        >>> print(x)
        False

        >>> x = startai.is_float_dtype(startai.bool)
        >>> print(x)
        False
    ...
    def _static_is_complex_dtype(
        ...
        """`startai.Container` static method variant of `is_complex_dtype`. This
        ...
        Examples
        --------
        >>> x = startai.Container.static_is_complex_dtype(startai.complex64)
        >>> print(x)
        True

        >>> x = startai.Container.static_is_complex_dtype(startai.int64)
        >>> print(x)
        False

        >>> x = startai.Container.static_is_complex_dtype(startai.float32)
        >>> print(x)
        False
        """
        return ContainerBase.cont_multi_map_in_function(
    ...
    def is_complex_dtype(
        ...
        """`startai.Container` instance method variant of `startai.is_complex_dtype`.
        This method simply wraps the function, and so the docstring for
        `startai.is_complex_dtype` also applies to this method with minimal
        changes.

        Parameters
        ----------
        self : startai.Container
            The `startai.Container` instance to call `startai.is_complex_dtype` on.
        ...
        Examples
        --------
        >>> x = startai.is_complex_dtype(startai.complex64)
        >>> print(x)
        True

        >>> x = startai.is_complex_dtype(startai.int64)
        >>> print(x)
        False

        >>> x = startai.is_complex_dtype(startai.float32)
        >>> print(x)
        False
        """
    ...
    def _static_result_type(
        *arrays_and_dtypes: startai.Container,
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        prune_unapplied: Union[bool, startai.Container] = False,
        map_sequences: Union[bool, startai.Container] = False,
    ) -> startai.Container:
        """`startai.Container` static method variant of `startai.result_type`. This
        method simply wraps the function, and so the docstring for
        ...
        >>> print(startai.Container.static_result_type(x, startai.float64))
        {
            a: float64,
            b: float32
        }
    ...
    def result_type(
        ...
        *arrays_and_dtypes: startai.Container,
        ...
        """`startai.Container` instance method variant of `startai.result_type`. This
        method simply wraps the function, and so the docstring for
        `startai.result_type` also applies to this method with minimal changes.
        ...
        Examples
        --------
        >>> x = startai.Container(a = startai.array([3, 3, 3]))
        >>> print(x.a.dtype)
        int32

        >>> y = startai.Container(b = startai.float64)
