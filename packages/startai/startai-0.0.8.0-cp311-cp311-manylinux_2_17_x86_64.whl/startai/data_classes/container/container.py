...
from startai.data_classes.container.experimental import (
...
class Container(
    ...
    def __pow__(self, power):
        """startai.Container special method for the power operator, calling
        ...
        >>> x = startai.Container(a=startai.array([0, 1.2]), b=startai.array([2.2, 3.]))
        >>> y = x ** 3.1
        >>> print(y)
        {
            a: startai.array([0., 1.75979435]),
            b: startai.array([11.52153397, 30.13532257])
        }
        """
        if isinstance(power, startai.Container):
            return startai.Container.cont_multi_map(
    ...
    def __add__(self, other):
        """startai.Container special method for the add operator, calling
        ...
        With :class:`startai.Array` instances at the leaves:
        ...
        With a mix of :class:`startai.Container` and :class:`startai.Array` instances:

        >>> x = startai.Container(a=startai.array([[4.], [5.], [6.]]),
        ...                   b=startai.array([[5.], [6.], [7.]]))
        >>> y = startai.array([[1.1, 2.3, -3.6]])
        >>> z = x + y
        >>> print(z)
        {
    ...
    def __radd__(self, other):
        """startai.Container reverse special method for the add operator, calling
        :code:`operator.add` for each of the corresponding leaves of the two
        containers.
    ...
    def __sub__(self, other):
        """startai.Container special method for the subtract operator, calling
        ...
        >>> y = startai.Container(a=startai.array([4, 5, 6]),
        ...                   b=startai.array([6, 5, 4]))
        >>> z = x - y
        >>> print(z)
        {
            a: startai.array([-3, -3, -3]),
        ...
        >>> print(z)
        {
            a: startai.array([[2.9, 1.7, 7.6],
                          [3.9, 2.7, 8.6],
                          [4.9, 3.7, 9.6]]),
            b: startai.array([[3.9, 2.7, 8.6],
                          [4.9, 3.7, 9.6],
                          [5.9, 4.7, 10.6]])
        }
        """
    ...
    def __rsub__(self, other):
        """startai.Container reverse special method for the subtract operator,
    ...
    def __truediv__(self, other):
        """startai.Container special method for the divide operator, calling
        ...
        >>> print(z)
        {
            a: startai.array([0.25, 0.40000001, 0.5]),
            b: startai.array([0.66666669, 0.60000002, 0.5])
        }
        """
        return startai.Container.cont_multi_map(
    ...
    def __floordiv__(self, other):
        if isinstance(other, startai.Container):
            return startai.Container.cont_multi_map(
    ...
    def __abs__(self):
        """startai.Container special method for the abs operator, calling
        ...
        Examples
        --------
        With :class:`startai.Container` instances:

        >>> x = startai.Container(a=startai.array([1, -2, 3]),
        ...                    b=startai.array([-1, 0, 5]))
        >>> y = abs(x)
        >>> print(y)
        {
    ...
    def __lt__(self, other):
        """startai.Container special method for the less operator, calling
        ...
        >>> y = startai.Container(a=startai.array([1, 5, 3]),b=startai.array([5, 3, 7]))
        >>> z = x < y
        >>> print(z)
        {
    ...
    def __le__(self, other):
        """startai.Container special method for the less_equal operator, calling
    ...
    def __eq__(self, other):
        """startai.Container special method for the equal operator, calling
        ...
        ...                    b=startai.array([1, 4, 5]))
        >>> x2 = startai.Container(a=startai.array([1, 3, 3.0]),
    ...
    def __ne__(self, other):
        """startai.Container special method for the not_equal operator, calling
    ...
    def __gt__(self, other):
        """startai.Container special method for the greater operator, calling
    ...
    def __ge__(self, other):
        """startai.Container special method for the greater_equal operator, calling
    ...
    def __xor__(self, other):
        """startai.Container special method for the ge operator, calling
        :code:`operator.ge` for each of the corresponding leaves of the two
        containers.
        ...
        >>> x = startai.Container(a=startai.array([89]), b=startai.array([2]))
        >>> y = startai.Container(a=startai.array([12]), b=startai.array([3]))
        >>> z = x ^ y
        >>> print(z)
        {
            a: startai.array([85]),
    ...
    def __rshift__(self, other):
        """startai.Container special method for the right shift operator, calling
        ...
        >>> x = startai.Container(a=128, b=43)
        >>> y = startai.Container(a=5, b=3)
        >>> z = x >> y
        >>> print(z)
        {
            a: 4,
        ...
        >>> x = startai.Container(a=startai.array([16, 40, 120]),
        ...                   b=startai.array([15, 45, 143]))
        >>> y = startai.Container(a=startai.array([1, 2, 3]),
        ...                   b=startai.array([0, 3, 4]))
        >>> z = x >> y
        >>> print(z)
        {
            a: startai.array([8, 10, 15]),
            b: startai.array([15, 5, 8])
        }
    ...
    def __rrshift__(self, other):
        """startai.Container reverse special method for the right shift operator,
        ...
        >>> print(y)
        {
            a: startai.array([64, 32, 16]),
            b: startai.array([8, 4, 2])
        }
        """
        return self.cont_map(lambda x, kc: other >> x, map_sequences=True)
