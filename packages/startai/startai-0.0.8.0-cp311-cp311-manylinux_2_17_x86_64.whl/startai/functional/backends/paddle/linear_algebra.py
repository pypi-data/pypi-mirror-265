...
def matrix_rank(
    ...
    *,
    ...
    atol = (
        atol if atol is not None else startai.finfo(x.dtype).eps * max(x.shape[-2:]) * sigma
    )
...
def tensorsolve(
    ...
    *,
    ...
    # Implemented as a composite function in startai.functional.startai.linear_algebra
