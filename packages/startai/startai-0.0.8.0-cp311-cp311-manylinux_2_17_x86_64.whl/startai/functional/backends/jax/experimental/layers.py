...
# local
import startai
from startai import output_to_native_arrays
from startai.functional.backends.jax import JaxArray
from startai.functional.backends.jax.random import RNG
from startai.functional.startai.experimental.general import _correct_startai_callable
from startai.functional.startai.layers import (
    _handle_padding,
    _validate_max_pool_params,
    _depth_max_pooling_helper,
)
from startai.functional.startai.experimental.layers import (
    _padding_ceil_mode,
    _get_size,
)
...
from startai.functional.backends.jax.experimental.manipulation import _to_nested_tuple
...
def fft(
    ...
    *,
    ...
    if norm not in {"backward", "ortho", "forward"}:
        raise startai.utils.exceptions.StartaiError(f"Unrecognized normalization mode {norm}")
...
def reduce_window(
    ...
    *,
    ...
    if not isinstance(padding, str):
        ...
        # this is similarly a problem in the jax backend of startai.pad
