...
from startai.functional.frontends.tensorflow.general_functions import _num_to_bit_list
from startai_tests.test_startai.test_frontends.test_numpy.test_creation_routines.test_from_shape_or_value import (  # noqa : E501
    _input_fill_and_dtype,
)
from startai_tests.test_startai.test_frontends.test_tensorflow.test_tensor import (
    _array_and_shape,
)  # noqa : E501
...
def _x_cast_dtype_shape(draw):
    ...
    #     .map(lambda t: t[0])
    #     .filter(lambda t: startai.can_cast(x_dtype[0], t))
    # )
