...
from startai_tests.test_startai.helpers.pipeline_helper import BackendHandler
...
def pow_helper(draw, available_dtypes=None):
    ...
    def cast_filter(dtype1_x1_dtype2):
        ...
        with BackendHandler.update_backend(test_globals.CURRENT_BACKEND) as startai_backend:
            if startai_backend.can_cast(dtype1, dtype2):
                return True
        return False
    ...
    with BackendHandler.update_backend(test_globals.CURRENT_BACKEND) as startai_backend:
        if startai_backend.is_int_dtype(dtype2):
            max_val = startai_backend.iinfo(dtype2).max
        else:
            max_val = startai_backend.finfo(dtype2).max
...
# abs
@handle_test(
    fn_tree="functional.startai.abs",
...
# acos
@handle_test(
    fn_tree="functional.startai.acos",
...
# acosh
@handle_test(
    fn_tree="functional.startai.acosh",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float_and_complex"),
        min_value=1,
...
# add
@handle_test(
    fn_tree="functional.startai.add",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("numeric"),
        num_arrays=2,
...
# angle
@handle_test(
    fn_tree="functional.startai.angle",
    dtype_and_x=helpers.dtype_and_values(
...
# asin
@handle_test(
    fn_tree="functional.startai.asin",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float_and_complex"),
        safety_factor_scale="log",
        large_abs_safety_factor=4,
...
# asinh
@handle_test(
    fn_tree="functional.startai.asinh",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float_and_complex"),
        large_abs_safety_factor=4,
        small_abs_safety_factor=4,
...
# atan
@handle_test(
    fn_tree="functional.startai.atan",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float_and_complex"),
        large_abs_safety_factor=4,
        small_abs_safety_factor=4,
...
# atan2
@handle_test(
    fn_tree="functional.startai.atan2",
    dtype_and_x=helpers.dtype_and_values(
...
# atanh
@handle_test(
    fn_tree="functional.startai.atanh",
    dtype_and_x=helpers.dtype_and_values(
        min_value=1e-30,
        max_value=1e30,
        available_dtypes=helpers.get_dtypes("float_and_complex"),
...
# bitwise_and
@handle_test(
    fn_tree="functional.startai.bitwise_and",
    dtype_and_x=helpers.dtype_and_values(
...
# bitwise_invert
@handle_test(
    fn_tree="functional.startai.bitwise_invert",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=st.one_of(st.just(("bool",)), helpers.get_dtypes("integer")),
        array_api_dtypes=True,
    ),
...
# bitwise_left_shift
@handle_test(
    fn_tree="functional.startai.bitwise_left_shift",
    dtype_and_x=helpers.dtype_and_values(
...
# bitwise_or
@handle_test(
    fn_tree="functional.startai.bitwise_or",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=st.one_of(st.just(("bool",)), helpers.get_dtypes("integer")),
        num_arrays=2,
        array_api_dtypes=True,
...
# bitwise_right_shift
@handle_test(
    fn_tree="functional.startai.bitwise_right_shift",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("integer"),
        num_arrays=2,
        array_api_dtypes=True,
...
# bitwise_xor
@handle_test(
    fn_tree="functional.startai.bitwise_xor",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=st.one_of(st.just(("bool",)), helpers.get_dtypes("integer")),
        num_arrays=2,
        array_api_dtypes=True,
...
# ceil
@handle_test(
    fn_tree="functional.startai.ceil",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("numeric"),
...
# cos
@handle_test(
    fn_tree="functional.startai.cos",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float_and_complex")
    ),
)
...
# cosh
@handle_test(
    fn_tree="functional.startai.cosh",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float_and_complex"),
    ),
)
...
@handle_test(
    fn_tree="functional.startai.deg2rad",
    dtype_and_x=helpers.dtype_and_values(
...
# divide
@handle_test(
    fn_tree="functional.startai.divide",
    test_gradients=st.just(False),
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("numeric", full=False),
        num_arrays=2,
...
# equal
@handle_test(
    fn_tree="functional.startai.equal",
    dtype_and_x=helpers.dtype_and_values(
...
# erf
@handle_test(
    fn_tree="functional.startai.erf",
...
# exp
@handle_test(
    fn_tree="functional.startai.exp",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float_and_complex")
    ),
)
...
# exp2
@handle_test(
    fn_tree="functional.startai.exp2",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float_and_complex"),
        min_value=-10,
        max_value=10,
...
# expm1
@handle_test(
    fn_tree="functional.startai.expm1",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float_and_complex"),
...
# floor
@handle_test(
    fn_tree="functional.startai.floor",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("numeric")
    ),
)
...
@handle_test(
    fn_tree="functional.startai.floor_divide",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("numeric"),
        num_arrays=2,
        allow_inf=False,
...
# fmin
@handle_test(
    fn_tree="functional.startai.fmin",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("valid"),
        min_value=-10,
        max_value=10,
...
# fmod
@handle_test(
    fn_tree="functional.startai.fmod",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("valid"),
        num_arrays=2,
        shared_dtype=False,
...
def test_fmod(dtype_and_x, test_flags, backend_fw, fn_name, on_device):
    ...
    if (np.any(x[0] < 0) or np.any(x[1] < 0)) and startai.current_backend_str() == "jax":
...
# gcd
@handle_test(
    fn_tree="functional.startai.gcd",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("integer"),
        num_arrays=2,
        shared_dtype=False,
...
# greater
@handle_test(
    fn_tree="functional.startai.greater",
    dtype_and_x=helpers.dtype_and_values(
...
# greater_equal
@handle_test(
    fn_tree="functional.startai.greater_equal",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("numeric"), num_arrays=2
    ),
    test_gradients=st.just(False),
...
# imag
@handle_test(
    fn_tree="functional.startai.imag",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("valid"),
        min_value=-5,
        max_value=5,
...
# isfinite
@handle_test(
    fn_tree="functional.startai.isfinite",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("numeric")
    ),
    test_gradients=st.just(False),
...
# isinf
@handle_test(
    fn_tree="functional.startai.isinf",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("numeric")
    ),
...
# isnan
@handle_test(
    fn_tree="functional.startai.isnan",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("numeric")
    ),
    test_gradients=st.just(False),
...
# isreal
@handle_test(
    fn_tree="functional.startai.isreal",
    dtype_and_x=helpers.dtype_and_values(
...
# lcm
@handle_test(
    fn_tree="functional.startai.lcm",
    dtype_and_x=helpers.dtype_and_values(
...
# less
@handle_test(
    fn_tree="functional.startai.less",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("numeric"),
        num_arrays=2,
        min_num_dims=1,
...
# less_equal
@handle_test(
    fn_tree="functional.startai.less_equal",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("numeric"),
        num_arrays=2,
        large_abs_safety_factor=6,
...
# log
@handle_test(
    fn_tree="functional.startai.log",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float_and_complex"),
        safety_factor_scale="log",
    ),
...
# log10
@handle_test(
    fn_tree="functional.startai.log10",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float_and_complex"),
        safety_factor_scale="log",
    ),
...
# log1p
@handle_test(
    fn_tree="functional.startai.log1p",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float_and_complex"),
        small_abs_safety_factor=2,
        large_abs_safety_factor=2.1,
...
# log2
@handle_test(
    fn_tree="functional.startai.log2",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float_and_complex"),
        safety_factor_scale="log",
    ),
...
# logaddexp
@handle_test(
    fn_tree="functional.startai.logaddexp",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float"),
        num_arrays=2,
...
# logaddexp2
@handle_test(
    fn_tree="functional.startai.logaddexp2",
    dtype_and_x=helpers.dtype_and_values(
...
# logical_and
@handle_test(
    fn_tree="functional.startai.logical_and",
    dtype_and_x=helpers.dtype_and_values(
...
# logical_not
@handle_test(
    fn_tree="functional.startai.logical_not",
    dtype_and_x=helpers.dtype_and_values(available_dtypes=helpers.get_dtypes("valid")),
    test_gradients=st.just(False),
)
...
# logical_or
@handle_test(
    fn_tree="functional.startai.logical_or",
    dtype_and_x=helpers.dtype_and_values(
...
# logical_xor
@handle_test(
    fn_tree="functional.startai.logical_xor",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("valid"), num_arrays=2
    ),
    test_gradients=st.just(False),
...
# maximum
@handle_test(
    fn_tree="functional.startai.maximum",
...
# minimum
@handle_test(
    fn_tree="functional.startai.minimum",
    dtype_and_x_and_use_where=min_max_helper(),
    test_gradients=st.just(False),
    ground_truth_backend="jax",
)
...
# multiply
@handle_test(
    fn_tree="functional.startai.multiply",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("valid"), num_arrays=2
    ),
...
# nan_to_num
@handle_test(
    fn_tree="functional.startai.nan_to_num",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float"),
        min_num_dims=1,
        max_num_dims=3,
...
# negative
@handle_test(
    fn_tree="functional.startai.negative",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("numeric")
    ),
)
...
# not_equal
@handle_test(
    fn_tree="functional.startai.not_equal",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("valid", full=False),
        num_arrays=2,
...
# positive
@handle_test(
    fn_tree="functional.startai.positive",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("numeric")
    ),
)
...
# pow
@handle_test(
    fn_tree="functional.startai.pow",
...
@handle_test(
    fn_tree="functional.startai.rad2deg",
    dtype_and_x=helpers.dtype_and_values(available_dtypes=helpers.get_dtypes("valid")),
)
...
# real
@handle_test(
    fn_tree="functional.startai.real",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("real_and_complex")
    ),
)
...
# reciprocal
@handle_test(
    fn_tree="functional.startai.reciprocal",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("numeric"),
        small_abs_safety_factor=4,
        large_abs_safety_factor=4,
...
# remainder
@handle_test(
    fn_tree="functional.startai.remainder",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("numeric"),
        num_arrays=2,
        large_abs_safety_factor=6,
...
# round
@handle_test(
    fn_tree="functional.startai.round",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("numeric")
    ),
...
# sign
@handle_test(
    fn_tree="functional.startai.sign",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("numeric"),
...
# sin
@handle_test(
    fn_tree="functional.startai.sin",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float_and_complex")
    ),
)
...
# sinh
@handle_test(
    fn_tree="functional.startai.sinh",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float_and_complex")
    ),
)
...
# sqrt
@handle_test(
    fn_tree="functional.startai.sqrt",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float_and_complex"),
        allow_inf=False,
...
# square
@handle_test(
    fn_tree="functional.startai.square",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("numeric"),
        large_abs_safety_factor=2,
        safety_factor_scale="log",
...
# subtract
@handle_test(
    fn_tree="functional.startai.subtract",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("numeric"),
        num_arrays=2,
        large_abs_safety_factor=2.5,
...
# tan
@handle_test(
    fn_tree="functional.startai.tan",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float_and_complex")
    ),
)
...
# tanh
@handle_test(
    fn_tree="functional.startai.tanh",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float_and_complex")
    ),
...
@handle_test(
    fn_tree="functional.startai.trapz",
...
# trunc
@handle_test(
    fn_tree="functional.startai.trunc",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("numeric")
    ),
)
...
# trunc_divide
@handle_test(
    fn_tree="functional.startai.trunc_divide",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("numeric"),
        num_arrays=2,
        large_abs_safety_factor=2,
