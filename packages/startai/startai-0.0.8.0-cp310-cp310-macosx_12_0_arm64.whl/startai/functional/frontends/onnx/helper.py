from startai.functional.frontends.onnx.proto import NodeProto

from startai_tests.test_startai.helpers.testing_helpers import _import_fn
...
def make_node(
    ...
    fn_tree = "startai.functional.frontends.onnx." + op_type
