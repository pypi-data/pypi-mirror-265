import startai
from startai.functional.frontends.sklearn.base import BaseEstimator as XGBModelBase
from startai.functional.frontends.sklearn.base import ClassifierMixin as XGBClassifierBase
...
class XGBModel(XGBModelBase):
    ...
    def get_params(self, deep=True):
        ...
        if isinstance(params["random_state"], int):
            startai.seed(seed_value=params["random_state"])
