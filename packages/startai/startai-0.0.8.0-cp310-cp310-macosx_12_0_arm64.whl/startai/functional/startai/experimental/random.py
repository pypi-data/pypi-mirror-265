...
@handle_device
def dirichlet(
    alpha: Union[startai.Array, startai.NativeArray, float, Sequence[float]],
    /,
    *,
    ...
    --------
    >>> alpha = [1.0, 2.0, 3.0]
    >>> startai.dirichlet(alpha)
    startai.array([0.10598304, 0.21537054, 0.67864642])

    >>> alpha = [1.0, 2.0, 3.0]
    >>> startai.dirichlet(alpha, size = (2,3))
    ...
    """
    return startai.current_backend().dirichlet(
        alpha,
        size=size,
        dtype=dtype,
        seed=seed,
...
@handle_device
def beta(
    a: Union[float, startai.NativeArray, startai.Array],
    b: Union[float, startai.NativeArray, startai.Array],
    /,
    *,
    ...
    ret
        ...
        a beta distribution.
    """
    return startai.current_backend().beta(
...
@handle_device
def gamma(
    alpha: Union[float, startai.NativeArray, startai.Array],
    beta: Union[float, startai.NativeArray, startai.Array],
    /,
    *,
    shape: Optional[Union[float, startai.NativeArray, startai.Array]] = None,
    device: Optional[Union[startai.Device, startai.NativeDevice]] = None,
    dtype: Optional[Union[startai.Dtype, startai.NativeDtype]] = None,
    seed: Optional[int] = None,
    out: Optional[startai.Array] = None,
    ...
    """
    return startai.current_backend().gamma(
...
@handle_device
def poisson(
    lam: Union[float, startai.Array, startai.NativeArray],
    *,
    shape: Optional[Union[startai.Shape, startai.NativeShape]] = None,
    device: Optional[Union[startai.Device, startai.NativeDevice]] = None,
    dtype: Optional[Union[startai.Dtype, startai.NativeDtype]] = None,
    ...
    >>> lam = [1.0, 2.0, 3.0]
    >>> startai.poisson(lam, shape = (2,3))
    startai.array([[0., 2., 2.],
               [1., 2., 3.]])
    """
    return startai.current_backend(lam).poisson(
        lam,
        shape=shape,
        device=device,
        dtype=dtype,
...
@handle_device
def bernoulli(
    probs: Union[float, startai.Array, startai.NativeArray],
    *,
    ...
    """
    return startai.current_backend(probs).bernoulli(
        probs,
        logits=logits,
        shape=shape,
        device=device,
