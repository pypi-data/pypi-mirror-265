...
def searchsorted(
    ...
    *,
    ...
    if sorter is not None:
        sorter_dtype = startai.as_native_dtype(sorter.dtype)
        assert startai.is_int_dtype(sorter_dtype), TypeError(
    ...
    ret_dtype = startai.as_native_dtype(ret_dtype)
    func_out = out
    if startai.exists(out) and out.dtype != ret_dtype:
        func_out = None
