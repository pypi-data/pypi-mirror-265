"""Collection of Numpy random functions, wrapped to fit Startai syntax and
signature."""
...
def random_uniform(
    *,
    ...
    shape: Optional[Union[startai.NativeShape, Sequence[int], np.ndarray]] = None,
    dtype: np.dtype,
...
def randint(
    ...
    *,
    shape: Optional[Union[startai.NativeShape, Sequence[int]]] = None,
    device: Optional[str] = None,
    dtype: Optional[Union[np.dtype, startai.Dtype]] = None,
    seed: Optional[int] = None,
    out: Optional[np.ndarray] = None,
) -> np.ndarray:
    if not dtype:
