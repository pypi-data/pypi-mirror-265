            ...
            if not os.path.exists(path):
                if initial:
                    ...
                    logging.warning(
                        ...
                        "case, calling startai.utils.cleanup_and_fetch_binaries() should "
                        "fetch the binaries binaries. Feel free to create an issue on "
                        "https://github.com/khulnasoft/startai.git in case of the former\n"
                    )
                    logging.warning(
...
def cleanup_and_fetch_binaries(clean=True):
    ...
    if os.path.exists(binaries_path):
                ...
                for path in binaries_paths:
                    ...
                    try:
                        response = request.urlopen(
                            "https://github.com/khulnasoft/binaries/raw/"
        ...
        if terminate:
            ...
            print(
                "Couldn't download all binaries. Try importing startai to get more "
