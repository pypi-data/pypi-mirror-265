...
class _ContainerWithLayersExperimental(ContainerBase):
    ...
    def static_max_pool1d(
        ...
        kernel: Union[int, Tuple[int, ...], startai.Container],
        strides: Union[int, Tuple[int, ...], startai.Container],
        padding: Union[str, int, Tuple[int], List[Tuple[int, int]], startai.Container],
        /,
        *,
        data_format: Union[str, startai.Container] = "NWC",
        dilation: Union[int, Tuple[int], startai.Container] = 1,
        ceil_mode: Union[bool, startai.Container] = False,
        ...
        """startai.Container static method variant of startai.max_pool1d. This method
        simply wraps the function, and so the docstring for startai.max_pool1d also
        ...
        Examples
        --------
        >>> a = startai.arange(12.).reshape((2,2,3))
        >>> b = startai.arange(24.).reshape((2,3,4))
        >>> x = startai.Container({'a': a, 'b': b})
        >>> print(startai.Container.static_max_pool1d(x,2, 2, "VALID"))
        {
            a: startai.array([[[3., 4., 5.]],
                          [[9., 10., 11.]]]),
    ...
    def max_pool1d(
        ...
        *,
        ...
        """startai.Container instance method variant of `startai.max_pool1d`. This
        method simply wraps the function, and so the docstring for
        `startai.max_pool1d` also applies to this method with minimal changes.
    ...
    def static_max_pool2d(
        ...
        *,
        ...
        """startai.Container static method variant of startai.max_pool2dd. This method
        simply wraps the function, and so the docstring for startai.max_pool2d also
        applies to this method with minimal changes.
        ...
        Examples
        --------
        >>> a = startai.arange(12).reshape((2, 1, 3, 2))
        >>> b = startai.arange(48).reshape((2, 4, 3, 2))
        >>> x = startai.Container({'a': a, 'b': b})
        >>> print(startai.Container.static_max_pool2d(x, (2, 2), (1, 1), "SAME"))
        {
            a: (<class startai.array.array.Array> shape=[2, 1, 3, 2]),
            b: (<class startai.array.array.Array> shape=[2, 4, 3, 2])
        }
        """
        return ContainerBase.cont_multi_map_in_function(
            "max_pool2d",
    ...
    def max_pool2d(
        ...
        *,
        ...
        """startai.Container instance method variant of `startai.max_pool2d`. This
        method simply wraps the function, and so the docstring for
        `startai.max_pool2d` also applies to this method with minimal changes.
        ...
        Examples
        --------
        >>> a = startai.arange(24.).reshape((1, 2, 3, 4))
        >>> b = startai.arange(48.).reshape((2, 4, 3, 2))
        >>> x = startai.Container(a=a, b=b)
        >>> y = x.max_pool2d(3, 1, "VALID")
        >>> print(y)
        {
            a: startai.array([], shape=(1, 0, 1, 4)),
            b: startai.array([[[[16., 17.]],
                           [[22., 23.]]],
                         [[[40., 41.]],
                           [[46., 47.]]]])
        }
    ...
    def static_max_pool3d(
        ...
        *,
        ...
        """startai.Container static method variant of startai.max_pool3d. This method
        simply wraps the function, and so the docstring for startai.max_pool3d also
        applies to this method with minimal changes.
        ...
        Examples
        --------
        >>> a = startai.arange(12).reshape((1, 2, 1, 3, 2))
        >>> b = startai.arange(48).reshape((2, 2, 2, 3, 2))
        >>> x = startai.Container({'a': a, 'b': b})
        >>> print(startai.Container.static_max_pool3d(x, 2, 1, "VALID"))
        {
            a: startai.array([], shape=(1, 1, 0, 2, 2)),
            b: startai.array([[[[[20, 21],
                             [22, 23]]]],
                       [[[[44, 45],
                             [46, 47]]]]])
        }
    ...
    def max_pool3d(
        ...
        *,
        ...
        Examples
        --------
        >>> a = startai.arange(24.).reshape((1, 2, 3, 4, 1))
        >>> b = startai.arange(48.).reshape((2, 4, 3, 2, 1))
        >>> x = startai.Container(a=a, b=b)
        >>> print(x.max_pool3d(3, 1, "VALID"))
        {
            a: startai.array([], shape=(1, 0, 1, 2, 1)),
            b: startai.array([], shape=(2, 2, 1, 0, 1))
        }
        """
    ...
    def static_avg_pool1d(
        ...
        *,
        data_format: Union[str, startai.Container] = "NWC",
        count_include_pad: Union[bool, startai.Container] = False,
        ceil_mode: Union[bool, startai.Container] = False,
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        prune_unapplied: Union[bool, startai.Container] = False,
        ...
        """startai.Container static method variant of startai.avg_pool1d. This method
        simply wraps the function, and so the docstring for startai.avg_pool1d also
        applies to this method with minimal changes.
        ...
        >>> b = startai.arange(24.).reshape((2,3,4))
        >>> x = startai.Container({'a': a, 'b': b})
        >>> print(startai.Container.static_avg_pool1d(x,2, 2, "VALID"))
        {
            a: startai.array([[[1.5, 2.5, 3.5]],
                          [[7.5, 8.5, 9.5]]]),
    ...
    def avg_pool1d(
        ...
        *,
        ...
        """startai.Container instance method variant of `startai.avg_pool1d`. This
        method simply wraps the function, and so the docstring for
        `startai.avg_pool1d` also applies to this method with minimal changes.
    ...
    def static_avg_pool2d(
        x: Union[startai.Array, startai.NativeArray, startai.Container],
        kernel: Union[int, Tuple[int], Tuple[int, int], startai.Container],
        ...
        *,
        ...
        count_include_pad: Union[bool, startai.Container] = False,
        ceil_mode: Union[bool, startai.Container] = False,
        divisor_override: Optional[Union[int, startai.Container]] = None,
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        prune_unapplied: Union[bool, startai.Container] = False,
        map_sequences: Union[bool, startai.Container] = False,
        ...
        """startai.Container static method variant of startai.avg_pool2d. This method
        simply wraps the function, and so the docstring for startai.avg_pool2d also
        applies to this method with minimal changes.
        ...
        >>> b = startai.arange(48).reshape((2, 4, 3, 2))
        >>> x = startai.Container({'a': a, 'b': b})
        >>> y = startai.Container.static_avg_pool2d(x, (2, 2), (1, 1), "SAME")
        >>> print(y)
        {
            a: (<class startai.data_classes.array.array.Array> shape=[2, 1, 3, 2]),
            b: (<class startai.data_classes.array.array.Array> shape=[2, 4, 3, 2])
        }
        """
        return ContainerBase.cont_multi_map_in_function(
            "avg_pool2d",
    ...
    def avg_pool2d(
        ...
        *,
        ...
        """startai.Container instance method variant of `startai.avg_pool2d`. This
        method simply wraps the function, and so the docstring for
        `startai.avg_pool2d` also applies to this method with minimal changes.
    ...
    def static_avg_pool3d(
        x: Union[startai.Array, startai.NativeArray, startai.Container],
        kernel: Union[int, Tuple[int], Tuple[int, int, int], startai.Container],
        strides: Union[int, Tuple[int], Tuple[int, int, int], startai.Container],
        padding: Union[str, startai.Container],
        /,
        *,
        data_format: Union[str, startai.Container] = "NDHWC",
        ...
        """startai.Container static method variant of startai.avg_pool3d. This method
        simply wraps the function, and so the docstring for startai.avg_pool3d also
        applies to this method with minimal changes.
        ...
        >>> b = startai.arange(48).reshape((2, 2, 2, 3, 2))
        >>> x = startai.Container({'a': a, 'b': b})
        >>> print(startai.Container.static_avg_pool3d(x, 2, 1, "VALID"))
        {
            a: startai.array([], shape=(1, 1, 0, 2, 2)),
            b: startai.array([[[[[10., 11.],
                             [12., 13.]]]],
                       [[[[34., 35.],
                             [36., 37.]]]]])
        }
        ...
        >>> print(x.avg_pool3d(2, 1, "VALID"))
        {
            a: startai.array([[[[[8.5],
                            ...
                            [[12.5],
                             [13.5],
                             [14.5]]]]]),
            b: (<class startai.data_classes.array.array.Array> shape=[2, 3, 2, 1, 1])
        }
        """
    ...
    def static_dct(
        ...
        /,
        *,
        type: Union[Literal[1, 2, 3, 4], startai.Container] = 2,
        n: Optional[Union[int, startai.Container]] = None,
        axis: Union[int, startai.Container] = -1,
        norm: Optional[Union[Literal["ortho"], startai.Container]] = None,
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        prune_unapplied: Union[bool, startai.Container] = False,
        map_sequences: Union[bool, startai.Container] = False,
        ...
        """startai.Container static method variant of startai.dct. This method simply
        wraps the function, and so the docstring for startai.dct also applies to
        ...
        >>> startai.Container.static_dct(x, type=2, norm='ortho')
        {
            a: startai.array([102., -51.5, 0., -5.39, 0., -1.61, 0.,
                        -0.406]),
            b: startai.array([12.7, -6.44, 0., -0.673, 0., -0.201, 0.,
                        -0.0507])
        }
        ...
        >>> x = startai.Container(a=startai.array([  8, 16,  24,  32,   40,   48,   56,   64]),
        ...                   b=startai.array([11., 54, 23., 13., 255., 255., 132., 182.]))
        >>> n = startai.Container(a=9, b=5)
        >>> type = startai.Container(a=2, b=4)
        >>> norm = startai.Container(a="ortho", b=None)
        >>> startai.Container.static_dct(x, type=type, n=n, norm=norm)
        {
            a: startai.array([96., -28.2, -31.9, 22.9, -26., 19.8, -17., 10.9,
                        -5.89]),
            b: startai.array([242., -253., 286., -515., 467.])
        }
        """
        return ContainerBase.cont_multi_map_in_function(
            "dct",
    ...
    def dct(
        ...
        *,
        ...
        """startai.Container instance method variant of startai.dct. This method simply
        wraps the function, and so the docstring for startai.dct also applies to
        this method with minimal changes.
    ...
    def static_idct(
        ...
        *,
        ...
        """startai.Container static method variant of startai.idct. This method simply
        wraps the function, and so the docstring for startai.idct also applies to
        this method with minimal changes.
        ...
        >>> x = startai.Container(a=startai.array([8, 16, 24, 32, 40, 48, 56, 64]),
        ...                   b=startai.array([1,  2,  3,  4,  5,  6,  7,  8]))
        >>> startai.Container.static_idct(x, type=2, norm='ortho')
        {
        ...
        >>> type = startai.Container(a=2, b=4)
        >>> norm = startai.Container(a="ortho", b=None)
        >>> startai.Container.static_idct(x, type=type, n=n, norm=norm)
        {
            a: startai.array([86.29723358, -66.6950531, 9.93914509, 2.88008738,
                          -16.18951225, 18.06697273, -17.57439804, 11.68861485,
                          -4.41308832]),
            b: startai.array([242.0700836, -253.2449036, 285.6711426, -514.501709,
                          467.4924011])
        }
        """
        return ContainerBase.cont_multi_map_in_function(
    ...
    def idct(
        ...
        *,
        ...
        """startai.Container instance method variant of startai.idct. This method
        simply wraps the function, and so the docstring for startai.idct also
        applies to this method with minimal changes.
        ...
        >>> x.idct(type=2, norm='ortho')
        {
            a: startai.array([79.49862671, -70.37691498, 30.00390816, -23.58938599,
                  13.92713165, -10.078475, 5.19664812, -1.95411837]),
            b: startai.array([9.94, -8.79711437, 3.76, -2.94867325, 1.74089146,
                  -1.25980937, 0.64958102, -0.2442648])
        }
        """
    ...
    def _static_fft(
        ...
        dim: Union[int, startai.Container],
        /,
        *,
        norm: Union[str, startai.Container] = "backward",
        n: Optional[Union[int, Tuple[int], startai.Container]] = None,
        out: Optional[startai.Container] = None,
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        prune_unapplied: Union[bool, startai.Container] = False,
        ...
        """startai.Container static method variant of startai.fft. This method simply
        wraps the function, and so the docstring for startai.fft also applies to
        this method with minimal changes.
        ...
        Examples
        --------
        >>> a = startai.array(np.array([ 6.+0.j, -2.+2.j, -2.+0.j, -2.-2.j]))
        >>> b = startai.array(np.exp(2j * np.pi * np.arange(8) / 8))
        >>> c = startai.Container(a=a, b=b)
        >>> dims = startai.Container(a=0, b=0)
        >>> startai.Container.static_fft(c, dims)
        {
        a: startai.array([0.+0.j, 12.+0.j, 8.+0.j, 4.+0.j]),
        b: startai.array([-3.44509285e-16+1.14423775e-17j, 8.00000000e+00-8.11483250e-16j,
    ...
    def fft(
        ...
        *,
        ...
        """startai.Container instance method variant of startai.fft. This method simply
        wraps the function, and so the docstring for startai.fft also applies to
        this method with minimal changes.
    ...
    def static_ifft(
        ...
        *,
        ...
        """startai.Container static method variant of startai.ifft. This method simply
        wraps the function, and so the docstring for startai.ifft also applies to
        this method with minimal changes.
        ...
        >>> c = startai.Container(a=a, b=b)
        >>> dims = startai.Container(a=0, b=0)
        >>> startai.Container.static_ifft(c, dims)
        {
        a: startai.array([0.+0.j, 1.+0.j, 2.+0.j, 3.+0.j]),
        b: startai.array([-4.30636606e-17+1.43029718e-18j, 0.00000000e+00+1.53080850e-17j,
    ...
    def ifft(
        ...
        *,
        ...
        """startai.Container instance method variant of startai.ifft. This method
        simply wraps the function, and so the docstring for startai.ifft also
        applies to this method with minimal changes.
    ...
    def static_embedding(
        ...
        /,
        *,
        max_norm: Optional[Union[int, startai.Container]] = None,
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        prune_unapplied: Union[bool, startai.Container] = False,
        map_sequences: Union[bool, startai.Container] = False,
    ...
    def static_dft(
        ...
        *,
        axis: Union[int, startai.Container] = 1,
        inverse: Union[bool, startai.Container] = False,
        onesided: Union[bool, startai.Container] = False,
        dft_length: Optional[Union[int, Tuple[int], startai.Container]] = None,
        norm: Union[str, startai.Container] = "backward",
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        prune_unapplied: Union[bool, startai.Container] = False,
    ...
    def static_interpolate(
        x: Union[startai.Array, startai.NativeArray, startai.Container],
        size: Union[Sequence[int], int, startai.Container],
        /,
        *,
        mode: Union[
            Literal[
        ...
        scale_factor: Optional[Union[Sequence[int], int, startai.Container]] = None,
        recompute_scale_factor: Optional[Union[bool, startai.Container]] = None,
        align_corners: Optional[Union[bool, startai.Container]] = None,
        antialias: Union[bool, startai.Container] = False,
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        prune_unapplied: Union[bool, startai.Container] = False,
        map_sequences: Union[bool, startai.Container] = False,
    ...
    def static_adaptive_avg_pool1d(
        ...
        output_size: Union[int, startai.Container],
        *,
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        prune_unapplied: Union[bool, startai.Container] = False,
        ...
        """startai.Container static method variant of startai.adaptive_avg_pool1d. This
        method simply wraps the function, and so the docstring for
        startai.adaptive_avg_pool1d also applies to this method with minimal
        changes.
    ...
    def static_adaptive_avg_pool2d(
        input: Union[startai.Array, startai.NativeArray, startai.Container],
        output_size: Union[Sequence[int], int, startai.Container],
        /,
        *,
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        ...
        """startai.Container static method variant of startai.adaptive_avg_pool2d. This
        method simply wraps the function, and so the docstring for
        startai.adaptive_avg_pool2d also applies to this method with minimal
        changes.
    ...
    def static_adaptive_max_pool2d(
        ...
        *,
        ...
        """startai.Container static method variant of startai.adaptive_max_pool2d. This
        method simply wraps the function, and so the docstring for
        startai.adaptive_max_pool2d also applies to this method with minimal
        changes.
    ...
    def static_ifftn(
        x: startai.Container,
        s: Optional[Union[int, Tuple[int, ...], startai.Container]] = None,
        axes: Optional[Union[int, Tuple[int, ...], startai.Container]] = None,
        *,
        norm: Union[str, startai.Container] = "backward",
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        ...
        """startai.Container static method variant of startai.ifftn.

        This method simply wraps the function, and so the docstring for
        startai.ifftn  also applies to this method with minimal changes.
    ...
    def ifftn(
        ...
        *,
        ...
        --------
        >>> x = startai.Container(
        ...         a=startai.array([[0.247306+0.908323j, 0.494955+0.90395j,
        ...
        ...         b=startai.array([[0.24730653+0.90832391j, 0.49495562+0.9039565j,
        ...                       0.98193269+0.49560517j],
        ...                      [0.93280757+0.48075343j, 0.28526384+0.3351205j,
        ...                       0.2343787 +0.83528011j],
        ...                      [0.18791352+0.30690572j, 0.82115787+0.96195183j,
        ...
        >>> print(y)
        {
            a: startai.array([[0.8344667+0.98222595j],
                          [-0.48472244+0.30233797j]]),
            b: startai.array([[0.8344667+0.98222595j],
                          [-0.48472244+0.30233797j]])
        }
        """
    ...
    def static_rfft(
        ...
        *,
        ...
        axis: Union[int, startai.Container] = -1,
        norm: Union[
            Literal["backward", "ortho", "forward"], startai.Container
        ] = "backward",
        out: Optional[Union[startai.Array, startai.Container]] = None,
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        ...
        """startai.Container static method variant of startai.rfft.

        This method simply wraps the function, and so the docstring for
        startai.rfft also applies to this method with minimal changes.
        ...
        >>> y =  startai.Container.static_rfft(x)
        >>> print(y)
        {
    ...
    def rfft(
        ...
        *,
        ...
        """startai.Container instance method variant of startai.rfft. This method
        simply wraps the function, and so the docstring for startai.rfft also
        applies to this method with minimal changes.
    ...
    def static_rfftn(
        ...
        *,
        ...
        """startai.Container static method variant of startai.rfftn.

        This method simply wraps the function, and so the docstring for
        startai.rfftn also applies to this method with minimal changes.
    ...
    def rfftn(
        self: Union[startai.Array, startai.NativeArray, startai.Container],
        s: Optional[Union[Sequence[int], startai.Container]] = None,
        axes: Optional[Union[int, Tuple[int], startai.Container]] = None,
        *,
        norm: Union[str, startai.Container] = "backward",
        out: Optional[Union[startai.Array, startai.Container]] = None,
    ...
    @staticmethod
    def static_stft(
        signals: startai.Container,
        frame_length: Union[int, startai.Container],
        frame_step: Union[int, startai.Container],
        /,
        *,
        fft_length: Optional[Union[int, startai.Container]] = None,
        window_fn: Optional[Union[Callable, startai.Container]] = None,
        pad_end: Optional[Union[bool, startai.Container]] = False,
        name: Optional[Union[str, startai.Container]] = None,
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        prune_unapplied: Union[bool, startai.Container] = False,
        map_sequences: Union[bool, startai.Container] = False,
    ...
    def _static_sliding_window(
        input: Union[startai.Array, startai.NativeArray, startai.Container],
        window_size: Union[int, Tuple[int, int], Tuple[int, int, int], startai.Container],
        /,
        *,
        stride: Union[int, Tuple[int, int], startai.Container] = 1,
        dilation: Union[int, Tuple[int, int], startai.Container] = 1,
        ...
        """startai.Container static method variant of startai.sliding_window. This
        method simply wraps the function, and so the docstring for
        startai.sliding_window also applies to this method with minimal changes.
        ...
        ...                  [21, 22, 23, 24]])
        ... )
        >>> result = startai.Container._static_sliding_window(x, (2, 2))
        >>> print(result)
        {
            a: startai.array([[[ 1,  2,  5,  6],
                           [ 2,  3,  6,  7],
                           [ 3,  4,  7,  8]],
    ...
    def sliding_window(
        ...
        *,
        ...
        """startai.Container instance method variant of startai.sliding_window. This
        method simply wraps the function, and so the docstring for
        startai.sliding_window also applies to this method with minimal changes.
    ...
    def static_max_unpool1d(
        ...
        *,
        ...
        data_format: Union[str, startai.Container] = "NCW",
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        prune_unapplied: Union[bool, startai.Container] = False,
        map_sequences: Union[bool, startai.Container] = False,
    ) -> startai.Container:
        """startai.Container static method variant of startai.max_unpool1d.
    ...
    def static_rnn(
        ...
        *,
        ...
        """startai.Container static method variant of startai.rnn.
