...
# local
from startai.functional.frontends.numpy import mgrid, ogrid
import startai_tests.test_startai.helpers as helpers
from startai_tests.test_startai.helpers import handle_frontend_test, handle_frontend_method
...
def test_numpy_arange(
    ...
    helpers.test_frontend_function(
        input_dtypes=[startai.as_startai_dtype("int8")],
        frontend=frontend,
...
@handle_frontend_method(
    class_tree="startai.functional.frontends.numpy.mgrid",
...
# ogrid
@handle_frontend_method(
    class_tree="startai.functional.frontends.numpy.ogrid",
