...
# gelu
@handle_test(
    fn_tree="functional.startai.gelu",
...
# hardswish
@handle_test(
    fn_tree="functional.startai.hardswish",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float_and_complex"),
...
# leaky_relu
@handle_test(
    fn_tree="functional.startai.leaky_relu",
    dtype_and_x=helpers.dtype_and_values(
...
# log_softmax
@handle_test(
    fn_tree="functional.startai.log_softmax",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float_and_complex"),
        min_num_dims=2,
...
# mish
@handle_test(
    fn_tree="functional.startai.mish",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float_and_complex"),
...
# relu
@handle_test(
    fn_tree="functional.startai.relu",
    dtype_and_x=helpers.dtype_and_values(
...
# sigmoid
@handle_test(
    fn_tree="functional.startai.sigmoid",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float_and_complex"),
        large_abs_safety_factor=8,
        small_abs_safety_factor=8,
...
# softmax
@handle_test(
    fn_tree="functional.startai.softmax",
    dtype_and_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float_and_complex"),
        min_num_dims=1,
        large_abs_safety_factor=8,
...
# softplus
@handle_test(
    fn_tree="functional.startai.softplus",
    dtype_and_x=helpers.dtype_and_values(
