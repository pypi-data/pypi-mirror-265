...
valid_float_dtypes = {"1.26.3 and below": (startai.float16, startai.float32, startai.float64)}
valid_uint_dtypes = {
    "1.26.3 and below": (startai.uint8, startai.uint16, startai.uint32, startai.uint64)
}
valid_complex_dtypes = {"1.26.3 and below": (startai.complex64, startai.complex128)}
...
# invalid data types
# update these to add new dtypes
invalid_dtypes = {"1.26.3 and below": (startai.bfloat16,)}
invalid_numeric_dtypes = {"1.26.3 and below": (startai.bfloat16,)}
invalid_int_dtypes = {"1.26.3 and below": ()}
invalid_float_dtypes = {"1.26.3 and below": (startai.bfloat16,)}
...
def closest_valid_dtype(type=None, /, as_native=False):
    if type is None:
        ...
        type = {"bfloat16": startai.float16}[type]
