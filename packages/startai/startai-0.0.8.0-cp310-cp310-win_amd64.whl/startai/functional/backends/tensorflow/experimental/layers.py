...
from startai.functional.startai.experimental.layers import _padding_ceil_mode, _get_size
...
def max_pool1d(
    ...
    *,
    ...
    permuted_x = False
    if data_format == "NCW" and startai.dev(x) == "cpu":
...
def max_pool2d(
    ...
    *,
    ...
    permuted_x = False
    if data_format == "NCHW" and startai.dev(x) == "cpu":
...
def max_pool3d(
    ...
    *,
    ...
    permuted_x = False
    if data_format == "NCDHW" and startai.dev(x) == "cpu":
...
def avg_pool3d(
    ...
    *,
    ...
    if divisor_override is not None:
        # sum pooling then dividing by divisor_override if it is provided
        res = startai.conv_general_dilated(
            x,
...
def dropout(
    ...
    *,
    ...
    x = startai.astype(x, dtype) if dtype and x.dtype != dtype else x
...
def rnn(
    ...
    *,
    ...
    step_function = inputs_to_startai_arrays(output_to_native_arrays(step_function))
