...
valid_float_dtypes = {
    "2.15.0 and below": (startai.bfloat16, startai.float16, startai.float32, startai.float64)
}
valid_uint_dtypes = {
    "2.15.0 and below": (startai.uint8, startai.uint16, startai.uint32, startai.uint64)
}
valid_complex_dtypes = {"2.15.0 and below": (startai.complex64, startai.complex128)}
