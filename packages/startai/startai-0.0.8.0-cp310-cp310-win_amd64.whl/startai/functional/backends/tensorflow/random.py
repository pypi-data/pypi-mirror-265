...
Collection of TensorFlow random functions, wrapped to fit Startai syntax and
signature.
"""
...
def random_uniform(
    *,
    ...
    shape: Optional[Union[startai.NativeShape, Sequence[int], tf.Tensor]] = None,
    dtype: DType,
...
def randint(
    ...
    *,
    shape: Optional[Union[startai.NativeShape, Sequence[int]]] = None,
    device: Optional[str] = None,
    dtype: Optional[Union[DType, startai.Dtype]] = None,
    seed: Optional[int] = None,
    out: Optional[Union[tf.Tensor, tf.Variable]] = None,
) -> Union[tf.Tensor, tf.Variable]:
    if not dtype:
