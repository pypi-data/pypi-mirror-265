...
def can_cast(from_, to, casting="safe"):
    ...
    if startai.is_array(from_):
        from_ = startai.as_startai_dtype(startai.dtype(from_))
    ...
    if isinstance(to, (str, type)):
        ...
        raise startai.utils.exceptions.StartaiException("to must be dtype or dtype specifier")
...
def min_scalar_type(a, /):
    if startai.is_array(a) and a.shape == ():
        a = a.item()
