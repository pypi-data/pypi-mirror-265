...
class _ContainerWithCreationExperimental(ContainerBase):
    ...
    def static_hann_window(
        window_length: Union[int, startai.Container],
        periodic: Union[bool, startai.Container] = True,
        ...
        *,
        ...
        """startai.Container static method variant of startai.hann_window. This method
        simply wraps the function, and so the docstring for startai.hann_window
        ...
        >>> x = startai.Container(a=3, b=5)
        >>> startai.Container.static_hann(x)
        {
            a: startai.array([0.0000, 0.7500, 0.7500])
            b: startai.array([0.0000, 0.3455, 0.9045, 0.9045, 0.3455])
        }
        """
    ...
    def hann_window(
        ...
        *,
        ...
        """startai.Container instance method variant of startai.hann_window. This
        method simply wraps the function, and so the docstring for
        startai.hann_window also applies to this method with minimal changes.
    ...
    def static_kaiser_window(
        window_length: Union[int, startai.Container],
        periodic: Union[bool, startai.Container] = True,
        beta: Union[float, startai.Container] = 12.0,
        *,
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        prune_unapplied: Union[bool, startai.Container] = False,
        map_sequences: Union[bool, startai.Container] = False,
        dtype: Optional[Union[startai.Array, startai.NativeArray, startai.Container]] = None,
        out: Optional[startai.Container] = None,
    ) -> startai.Container:
        """startai.Container static method variant of startai.kaiser_window. This
        method simply wraps the function, and so the docstring for
        startai.kaiser_window also applies to this method with minimal changes.
        ...
        --------
        >>> x = startai.Container(a=3, b=5)
        >>> startai.Container.static_kaiser_window(x, True, 5)
        {
            a: startai.array([0.2049, 0.8712, 0.8712]),
            a: startai.array([0.0367, 0.7753, 0.7753]),
        }
        """
        return ContainerBase.cont_multi_map_in_function(
            "kaiser_window",
    ...
    def kaiser_window(
        ...
        *,
        ...
        """startai.Container instance method variant of startai.kaiser_window. This
        method simply wraps the function, and so the docstring for
        startai.kaiser_window also applies to this method with minimal changes.
    ...
    def static_kaiser_bessel_derived_window(
        ...
        *,
        ...
        startai.kaiser_bessel_derived_window. This method simply wraps the
        function, and so the docstring for startai.kaiser_bessel_derived_window
        also applies to this method with minimal changes.
        ...
        --------
        >>> x = startai.Container(a=3, b=5)
        >>> startai.Container.static_kaiser_bessel_derived_window(x, True, 5)
        {
            a: startai.array([0.70710677, 0.70710677]),
            b: startai.array([0.18493208, 0.9827513 , 0.9827513 , 0.18493208]),
        }
        """
        return ContainerBase.cont_multi_map_in_function(
    ...
    def static_hamming_window(
        ...
        *,
        ...
        map_sequences: Union[bool, startai.Container] = False,
        periodic: Union[bool, startai.Container] = True,
        alpha: Union[float, startai.Container] = 0.54,
        beta: Union[float, startai.Container] = 0.46,
        dtype: Optional[Union[startai.Array, startai.NativeArray, startai.Container]] = None,
        out: Optional[startai.Container] = None,
    ) -> startai.Container:
        """startai.Container static method variant of startai.hamming_window. This
        method simply wraps the function, and so the docstring for
        startai.hamming_window also applies to this method with minimal changes.
        ...
        --------
        >>> x = startai.Container(a=3, b=5)
        >>> startai.Container.static_hamming_window(x, periodic=True, alpha=0.2, beta=2)
        {
            a: startai.array([-1.8000,  1.2000,  1.2000]),
            b: startai.array([-1.8000, -0.4180,  1.8180,  1.8180, -0.4180])
        }
        """
        return ContainerBase.cont_multi_map_in_function(
            "hamming_window",
    ...
    def hamming_window(
        ...
        *,
        ...
        """startai.Container instance method variant of startai.hamming_window. This
        method simply wraps the function, and so the docstring for
        startai.hamming_window also applies to this method with minimal changes.
    ...
    def static_vorbis_window(
        ...
        *,
        ...
        """startai.Container static method variant of startai.vorbis_window. This
        method simply wraps the function, and so the docstring for
        startai.vorbis_window also applies to this method with minimal changes.
        ...
        --------
        >>> x = startai.Container(a=3, b=5)
        >>> startai.Container.static_vorbis_window(x)
        {
            a: startai.array([0., 0.38268343, 0.92387953, 1., 0.92387953,
                          0.38268343]),
            b: startai.array([0., 0.14943586, 0.51644717, 0.85631905, 0.98877142,
    ...
    def vorbis_window(
        ...
        *,
        ...
        """startai.Container instance method variant of startai.vorbis_window. This
        method simply wraps the function, and so the docstring for
        startai.vorbis_window also applies to this method with minimal changes.
    ...
    def static_tril_indices(
        n_rows: Union[int, startai.Container],
        n_cols: Optional[Union[int, startai.Container]] = None,
    ...
    def static_eye_like(
        ...
        *,
        ...
        """startai.Container static method variant of startai.eye_like. This method
        simply wraps the function, and so the docstring for startai.eye_like also
        ...
        >>> y = startai.Container.static_eye_like(x)
        >>> print(y)
        {
            a: startai.array([[1.]]),
            b: startai.array([[1.]])
    ...
    def eye_like(
        ...
        *,
        ...
        """startai.Container instance method variant of startai.eye_like. This method
        simply wraps the function, and so the docstring for startai.eye_like also
        applies to this method with minimal changes.
    ...
    def static_unsorted_segment_min(
        data: startai.Container,
        segment_ids: startai.Container,
        num_segments: Union[int, startai.Container],
        *,
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        prune_unapplied: Union[bool, startai.Container] = False,
        ...
        r"""startai.Container instance method variant of startai.unsorted_segment_min.
        This method simply wraps the function, and so the docstring for
        startai.unsorted_segment_min also applies to this method with minimal
        changes.
    ...
    def static_unsorted_segment_sum(
        ...
        *,
        ...
        r"""startai.Container instance method variant of startai.unsorted_segment_sum.
        This method simply wraps the function, and so the docstring for
        startai.unsorted_segment_sum also applies to this method with minimal
        changes.
    ...
    def static_blackman_window(
        ...
        *,
        ...
        """startai.Container static method variant of startai.blackman_window. This
        method simply wraps the function, and so the docstring for
        startai.blackman_window also applies to this method with minimal changes.
        ...
        With one :class:`startai.Container` input:
        >>> x = startai.Container(a=3, b=5)
        >>> startai.Container.static_blackman_window(x)
        {
            a: startai.array([-1.38777878e-17,  6.30000000e-01,  6.30000000e-01])
            b: startai.array([-1.38777878e-17,  2.00770143e-01,  8.49229857e-01,
    ...
    def blackman_window(
        ...
        *,
        ...
        """startai.Container instance method variant of startai.blackman_window. This
        method simply wraps the function, and so the docstring for
        startai.blackman_window also applies to this method with minimal changes.
    ...
    def static_mel_weight_matrix(
        num_mel_bins: Union[int, startai.Container],
        dft_length: Union[int, startai.Container],
        sample_rate: Union[int, startai.Container],
        lower_edge_hertz: Optional[Union[float, startai.Container]] = 0.0,
        upper_edge_hertz: Optional[Union[float, startai.Container]] = 3000.0,
        *,
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        prune_unapplied: Union[bool, startai.Container] = False,
        ...
        r"""startai.Container instance method variant of startai.mel_weight_matrix. This
        method simply wraps the function, and so the docstring for
        startai.mel_weight_matrix also applies to this method with minimal changes.
    ...
    def static_unsorted_segment_mean(
        data: startai.Container,
        segment_ids: Union[startai.Array, startai.Container],
        num_segments: Union[int, startai.Container],
        *,
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        ...
        num_segments : Union[int, startai.Container]
            An integer or array representing the total number of distinct segment IDs.
        key_chains : Optional[Union[List[str], Dict[str, str], startai.Container]], optional
            The key-chains to apply or not apply the method to. Default is None.
        to_apply : Union[bool, startai.Container], optional
            If True, the method will be applied to key-chains, otherwise key-chains will
            be skipped. Default is True.
        prune_unapplied : Union[bool, startai.Container], optional
            Whether to prune key-chains for which the function was not applied.
            Default is False.
        map_sequences : Union[bool, startai.Container], optional
    ...
    def unsorted_segment_mean(
        ...
        Example
        --------
        >>> data = startai.Container(a=startai.array([0., 1., 2., 4.]),
        ...                      b=startai.array([3., 4., 5., 6.]))
        >>> segment_ids = startai.array([0, 0, 1, 1])
        >>> num_segments = 2
        >>> result = startai.unsorted_segment_mean(data, segment_ids, num_segments)
        >>> print(result)
        {
            a: startai.array([0.5, 3.0]),
            b: startai.array([3.5, 5.5])
        }

        >>> data = startai.Container(a=startai.array([0., 1., 2., 4., 5., 6.]),
        ...                      b=startai.array([3., 4., 5., 6., 7., 8.]))
        >>> segment_ids = startai.array([0, 0, 1, 1, 2, 2])
        >>> num_segments = 3
        >>> result = startai.unsorted_segment_mean(data, segment_ids, num_segments)
        >>> print(result)
        {
            a: startai.array([0.5, 3.0, 5.5]),
            b: startai.array([3.5, 5.5, 7.5])
        }
        """
    ...
    @staticmethod
    def static_polyval(
        coeffs: startai.Container,
        x: Union[startai.Container, int, float],
        *,
        key_chains: Optional[Union[List[str], Dict[str, str]]] = None,
        to_apply: bool = True,
        prune_unapplied: bool = False,
        ...
        r"""startai.Container static method variant of startai.polyval. This method
        simply wraps the function, and so the docstring for startai.polyval also
        applies to this method with minimal changes.
    ...
    def polyval(
        ...
        r"""startai.Container instance method variant of startai.polyval. This method
        simply wraps the function, and so the docstring for startai.polyval also
        applies to this method with minimal changes.
