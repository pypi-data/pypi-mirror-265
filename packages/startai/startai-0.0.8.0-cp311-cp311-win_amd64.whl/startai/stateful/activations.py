"""Collection of Startai neural network activations as stateful classes."""
...
class GEGLU(Module):
    ...
    def _forward(self, inputs):
        ...
        """
        x, gates = startai.split(inputs, num_or_size_splits=2, axis=-1)
        return startai.gelu(gates) * x
...
class ReLU(Module):
    ...
    def _forward(self, x):
        ...
        """
        return startai.relu(x, complex_mode=self._complex_mode)
...
class LogSoftmax(Module):
    ...
    def _forward(self, x):
        ...
        """
        return startai.log_softmax(x, axis=self._axis, complex_mode=self._complex_mode)
...
class Softmax(Module):
    ...
    def _forward(self, x):
        ...
        """
        return startai.softmax(x, axis=self._axis, complex_mode=self._complex_mode)
...
class Softplus(Module):
    ...
    def _forward(self, x):
        ...
        """
        return startai.softplus(x, beta=self._beta, threshold=self._threshold)
...
class Sigmoid(Module):
    ...
    def _forward(self, x):
        ...
        """
        return startai.sigmoid(x, complex_mode=self._complex_mode)
...
class Tanh(Module):
    ...
    def _forward(self, x):
        ...
        """
        return startai.tanh(x, complex_mode=self._complex_mode)
...
class ReLU6(Module):
    ...
    def _forward(self, x):
        ...
        """
        return startai.relu6(x, complex_mode=self._complex_mode)
...
class Hardswish(Module):
    ...
    def _forward(self, x):
        ...
        """
        return startai.hardswish(x, complex_mode=self._complex_mode)
...
class PReLU(Module):
    ...
    def _forward(self, x):
        ...
        """
        return startai.prelu(x, self._slope)
...
class ELU(Module):
    ...
    def _forward(self, x):
        ...
        """
        return startai.elu(x, alpha=self._alpha)
...
class LogSigmoid(Module):
    ...
    def _forward(self, x):
        ...
        """
        return startai.logsigmoid(x, complex_mode=self._complex_mode)
