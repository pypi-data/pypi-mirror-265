...
class _ContainerWithLinearAlgebra(ContainerBase):
    ...
    def _static_matmul(
        ...
        /,
        *,
        transpose_a: Union[bool, startai.Container] = False,
        transpose_b: Union[bool, startai.Container] = False,
        adjoint_a: Union[bool, startai.Container] = False,
        adjoint_b: Union[bool, startai.Container] = False,
        ...
        """startai.Container static method variant of startai.matmul. This method
        simply wraps the function, and so the docstring for startai.matul also
        ...
        Examples
        --------
        >>> x = startai.Container(a = startai.array([[3., -1.], [-1., 3.]]) ,
        ...                   b = startai.array([[2., 1.], [1., 1.]]))
        >>> y = startai.Container.static_matmul(x, x)
        >>> print(y)
        {
            a: startai.array([[10., -6.],
                          [-6., 10.]]),
            b: startai.array([[5., 3.],
                          [3., 2.]])
        }
    ...
    def matmul(
        ...
        *,
        ...
        """startai.Container instance method variant of startai.matmul. This method
        simply wraps the function, and so the docstring for startai.matmul also
        applies to this method with minimal changes.
    ...
    def _static_cholesky(
        ...
        /,
        *,
        upper: Union[bool, startai.Container] = False,
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        prune_unapplied: Union[bool, startai.Container] = False,
        map_sequences: Union[bool, startai.Container] = False,
        ...
        """startai.Container static method variant of startai.cholesky. This method
        ...
        >>> x = startai.Container(a=startai.array([[3., -1.], [-1., 3.]]),
        ...                      b=startai.array([[2., 1.], [1., 1.]]))
        >>> y = startai.Container.static_cholesky(x, upper='false')
        >>> print(y)
        {
            a: startai.array([[1.73, -0.577],
                            [0., 1.63]]),
            b: startai.array([[1.41, 0.707],
                            [0., 0.707]])
         }
        With multiple :class:`startai.Container` inputs:
        >>> x = startai.Container(a=startai.array([[3., -1], [-1., 3.]]),
        ...                      b=startai.array([[2., 1.], [1., 1.]]))
        >>> upper = startai.Container(a=1, b=-1)
        >>> y = startai.Container.static_roll(x, upper=False)
        >>> print(y)
        {
            a: startai.array([[3., 3.],
                         [-1., -1.]]),
    ...
    def cholesky(
        ...
        *,
        ...
        """startai.Container instance method variant of startai.cholesky. This method
        simply wraps the function, and so the docstring for startai.cholesky also
        applies to this method with minimal changes.
    ...
    def _static_cross(
        ...
        *,
        ...
        """startai.Container static method variant of startai.cross. This method simply
        ...
        >>> x = startai.array([9., 0., 3.])
        >>> y = startai.Container(a=startai.array([1., 1., 0.]), b=startai.array([1., 0., 1.]))
        >>> z = startai.Container.static_cross(x, y)
        >>> print(z)
        {
            a: startai.array([-3., 3., 9.]),
            b: startai.array([0., -6., 0.])
        }

        With multiple :class:`startai.Container` inputs:

        >>> x = x = startai.Container(a=startai.array([5., 0., 0.]), b=startai.array([0., 0., 2.]))
        >>> y = startai.Container(a=startai.array([0., 7., 0.]), b=startai.array([3., 0., 0.]))
        >>> z = startai.Container.static_cross(x, y)
        >>> print(z)
        {
            a: startai.array([0., 0., 35.]),
            b: startai.array([0., 6., 0.])
        }
        """
        return ContainerBase.cont_multi_map_in_function(
    ...
    def cross(
        ...
        *,
        ...
        """startai.Container instance method variant of startai.cross. This method
        simply wraps the function, and so the docstring for startai.cross also
        applies to this method with minimal changes.
        ...
        Examples
        --------
        >>> x = startai.Container(a=startai.array([5., 0., 0.]), b=startai.array([0., 0., 2.]))
        >>> y = startai.Container(a=startai.array([0., 7., 0.]), b=startai.array([3., 0., 0.]))
        >>> z = x.cross(y)
        >>> print(z)
        {
    ...
    def det(
        ...
        *,
        ...
        >>> y = x.det()
        >>> print(y)
        {a:startai.array(8.),b:startai.array(1.)}
        """
    ...
    def _static_diagonal(
        ...
        *,
        ...
        axis1: Union[int, startai.Container] = -2,
        axis2: Union[int, startai.Container] = -1,
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        prune_unapplied: Union[bool, startai.Container] = False,
        map_sequences: Union[bool, startai.Container] = False,
        ...
        """startai.Container static method variant of startai.diagonal. This method
        ...
        ret
            ...
            the docstring for startai.diagonal.
        ...
        >>> d = startai.Container.static_diagonal(x)
        >>> print(d)
        {
            a:startai.array([1., 4.]),
            b:startai.array([5., 8.])
        ...
        >>> d = startai.Container.static_diagonal(offset=-1, axis1=0)
        >>> print(d)
        {
            a:startai.array([3., 7.]),
            b:startai.array([-3., 6.])
    ...
    def diagonal(
        ...
        *,
        ...
        """startai.Container instance method variant of startai.diagonal. This method
        simply wraps the function, and so the docstring for startai.diagonal also
        applies to this method with minimal changes.
    ...
    def _static_diag(
        ...
        /,
        *,
        k: Union[int, startai.Container] = 0,
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        prune_unapplied: Union[bool, startai.Container] = False,
        map_sequences: Union[bool, startai.Container] = False,
    ...
    def diag(
        ...
        *,
        ...
        """startai.Container instance method variant of startai.diag. This method
        simply wraps the function, and so the docstring for startai.diag also
        applies to this method with minimal changes.

        Examples
        --------
        >>> x = startai.Container(a=[[0, 1, 2],
        >>>                      [3, 4, 5],
        >>>                      [6, 7, 8]])
        >>> startai.diag(x, k=1)
        {
    ...
    def _static_eigh(
        ...
        /,
        *,
        UPLO: Union[str, startai.Container] = "L",
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        prune_unapplied: Union[bool, startai.Container] = False,
        map_sequences: Union[bool, startai.Container] = False,
    ...
    def eigh(
        ...
        *,
        ...
        """startai.Container instance method variant of startai.eigh. This method
        simply wraps the function, and so the docstring for startai.eigh also
        applies to this method with minimal changes.

        Parameters
        ----------
        self : startai.Container
            Startai container having shape `(..., M, M)` and whose
        ...
        Examples
        --------
        With `startai.Container` inputs:

        >>> x = startai.Container(a=startai.array([[[1.,2.],[2.,1.]]]),
        ...                   b=startai.array([[[2.,4.],[4.,2.]]]))
        >>> y = x.eigh()
        >>> print(y)
        {
            a: startai.array([[-1., 3.]]),
    ...
    def _static_eigvalsh(
        ...
        *,
        ...
        """startai.Container static method variant of startai.eigvalsh. This method
        ...
        >>> x = startai.Container(a=startai.array([[[1.,2.,3.],[2.,4.,5.],[3.,5.,6.]]]),
        ...                   b=startai.array([[[1.,1.,2.],[1.,2.,1.],[2.,1.,1.]]]),
        ...                   c=startai.array([[[2.,2.,2.],[2.,3.,3.],[2.,3.,3.]]]))
        >>> e = startai.Container.static_eigvalsh(x)
        >>> print(e)
        {
            a: startai.array([[-0.51572949, 0.17091519, 11.3448143]]),
            b: startai.array([[-1., 1., 4.]]),
            c: startai.array([[-8.88178420e-16, 5.35898387e-01, 7.46410179e+00]])
        }
        """
        return ContainerBase.cont_multi_map_in_function(
            "eigvalsh",
    ...
    def eigvalsh(
        ...
        *,
        ...
        """startai.Container instance method variant of startai.eigvalsh. This method
        simply wraps the function, and so the docstring for startai.eigvalsh also
        applies to this method with minimal changes.
    ...
    def _static_inner(
        ...
        *,
        ...
        """startai.Container static method variant of startai.inner. This method simply
        wraps the function, and so the docstring for startai.inner also applies to
        this method with minimal changes.
        ...
        Examples
        --------
        >>> x1 = startai.Container(a=startai.array([[1, 2], [3, 4]]))
        >>> x2 = startai.Container(a=startai.array([5, 6]))
        >>> y = startai.Container.static_inner(x1, x2)
        >>> print(y)
        {
            a: startai.array([17, 39])
        }
        """
        return ContainerBase.cont_multi_map_in_function(
            "inner",
    ...
    def inner(
        ...
        *,
        ...
        """startai.Container instance method variant of startai.inner. This method
        simply wraps the function, and so the docstring for startai.inner also
        applies to this method with minimal changes.
        ...
        >>> x1 = startai.Container(a=startai.array([[1, 2], [3, 4]]))
        >>> x2 = startai.Container(a=startai.array([5, 6]))
        >>> y = startai.Container.inner(x1, x2)
        >>> print(y)
        {
            a: startai.array([17, 39])
        }
    ...
    def _static_inv(
        ...
        /,
        *,
        adjoint: Union[bool, startai.Container] = False,
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        prune_unapplied: Union[bool, startai.Container] = False,
        map_sequences: Union[bool, startai.Container] = False,
        ...
        """startai.Container static method variant of startai.inv. This method simply
        ...
        >>> x = startai.Container(a=startai.array([[0., 1.], [4., 4.]]),
        ...                      b=startai.array([[4., 4.], [2., 1.]]))
        >>> y = startai.Container.static_inv(x)
        >>> print(y)
        {
            a: startai.array([[-1, 0.25], [1., 0.]]),
            b: startai.array([-0.25, 1.], [0.5, -1.])
        }
        """
        return ContainerBase.cont_multi_map_in_function(
            "inv",
    ...
    def inv(
        ...
        *,
        ...
        """startai.Container instance method variant of startai.inv. This method simply
        wraps the function, and so the docstring for startai.inv also applies to
        this method with minimal changes.
    ...
    def _static_pinv(
        ...
        /,
        *,
        rtol: Optional[Union[float, Tuple[float], startai.Container]] = None,
        out: Optional[startai.Container] = None,
    ) -> startai.Container:
        """startai.Container special method variant of startai.pinv. This method simply
        ...
        --------
        >>> x = startai.Container(a= startai.array([[1., 2.], [3., 4.]]))
        >>> y = startai.Container.static_pinv(x)
        >>> print(y)
        {
            a: startai.array([[-2., 1.],
                          [1.5, -0.5]])
        ...
        >>> x = startai.Container(a=startai.array([[1., 2.], [3., 4.]]))
        >>> out = startai.Container(a=startai.zeros((2, 2)))
        >>> startai.Container.static_pinv(x, rtol=1e-1, out=out)
        >>> print(out)
        {
            a: startai.array([[0.0426, 0.0964],
                          [0.0605, 0.1368]])
        }
        """
        return ContainerBase.cont_multi_map_in_function(
    ...
    def pinv(
        ...
        *,
        ...
        """startai.Container instance method variant of startai.pinv. This method
        simply wraps the function, and so the docstring for startai.pinv also
        applies to this method with minimal changes.
        ...
        >>> print(y)
        {
            a: startai.array([[-1.99999988, 1.],
                          [1.5, -0.5]])
        }

        >>> x = startai.Container(a = startai.array([[1., 2.], [3., 4.]]))
        >>> out = startai.Container(a = startai.zeros(x["a"].shape))
        >>> x.pinv(out=out)
        >>> print(out)
        {
            a: startai.array([[-1.99999988, 1.],
    ...
    def _static_matrix_norm(
        ...
        /,
        *,
        ord: Union[int, float, Literal[inf, -inf, "fro", "nuc"], startai.Container] = "fro",
        axis: Tuple[int, int, startai.Container] = (-2, -1),
        ...
        """startai.Container static method variant of startai.matrix_norm. This method
        ...
        Examples
        --------
        >>> x = startai.Container(a=startai.array([[1.1, 2.2], [1., 2.]]), \
                              b=startai.array([[1., 2.], [3., 4.]]))
        >>> y = startai.Container.static_matrix_norm(x, ord=1)
        >>> print(y)
        {
            a: startai.array(4.2),
            b: startai.array(6.)
        ...
        >>> x = startai.Container(a=startai.arange(12, dtype=float).reshape((3, 2, 2)), \
                              b=startai.arange(8, dtype=float).reshape((2, 2, 2)))
        >>> ord = startai.Container(a=1, b=float('inf'))
        >>> axis = startai.Container(a=(1, 2), b=(2, 1))
        >>> k = startai.Container(a=False, b=True)
        >>> y = startai.Container.static_matrix_norm(x, ord=ord, axis=axis, keepdims=k)
        >>> print(y)
        {
            a: startai.array([4.24, 11.4, 19.2]),
            b: startai.array([[[3.7]],
                          [[11.2]]])
        }
        """
    ...
    def matrix_norm(
        ...
        *,
        ...
        """startai.Container instance method variant of startai.matrix_norm. This
        method simply wraps the function, and so the docstring for
        startai.matrix_norm also applies to this method with minimal changes.
        ...
        >>> x = startai.Container(a=startai.arange(12, dtype=float).reshape((3, 2, 2)), \
                              b=startai.arange(8, dtype=float).reshape((2, 2, 2)))
        >>> ord = startai.Container(a="nuc", b=startai.inf)
        >>> axis = startai.Container(a=(1, 2), b=(2, 1))
        >>> k = startai.Container(a=True, b=False)
        >>> y = x.matrix_norm(ord=ord, axis=axis, keepdims=k)
        >>> print(y)
        {
            a: startai.array([[[4.24]],
                         [[11.4]],
                         [[19.2]]]),
            b: startai.array([4., 12.])
        }
        """
    ...
    def _static_matrix_rank(
        ...
        /,
        *,
        atol: Optional[Union[float, Tuple[float], startai.Container]] = None,
        rtol: Optional[Union[float, Tuple[float], startai.Container]] = None,
        hermitian: Optional[Union[bool, startai.Container]] = False,
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        prune_unapplied: Union[bool, startai.Container] = False,
        map_sequences: Union[bool, startai.Container] = False,
        ...
        """startai.Container static method variant of startai.matrix_rank. This method
        ...
        ...                   b=startai.array([[1., 0.], [0., 0.]]))
        >>> y = startai.Container.static_matrix_rank(x)
        >>> print(y)
        {
            a: startai.array(2.),
            b: startai.array(1.)
    ...
    def matrix_rank(
        ...
        *,
        ...
        """startai.Container instance method variant of startai.matrix_rank. This
    ...
    def _static_matrix_transpose(
        ...
        /,
        *,
        conjugate: Union[bool, startai.Container] = False,
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        prune_unapplied: Union[bool, startai.Container] = False,
        map_sequences: Union[bool, startai.Container] = False,
        ...
        Examples
        --------
        With :code:`startai.Container` instance method:

        >>> x = startai.Container(a=startai.array([[1., 1.], [0., 3.]]), \
                        b=startai.array([[0., 4.], [3., 1.]]))
        >>> y = startai.Container.static_matrix_transpose(x)
        >>> print(y)
        {
            a: startai.array([[1., 0.],
                          [1., 3.]]),
    ...
    def _static_outer(
        ...
        *,
        ...
        """startai.Container static method variant of startai.outer. This method simply
        wraps the function, and so the docstring for startai.outer also applies to
        this method with minimal changes.
        ...
        -------
        ret
            an startai container whose shape is (..., N1, N2).
        ...
        Example
        -------
        >>> x1 =startai.Container( a=startai.array([[1, 2, 3], [4, 5, 6]]))
        >>> x2 = startai.Container(a=startai.array([1, 2, 3]))
        >>> y = startai.Container.static_outer(x1, x2)
        >>> print(y)
        startai.array([[[ 1.,  2.,  3.],
                    [ 2.,  4.,  6.],
                    [ 3.,  6.,  9.]],
    ...
    def outer(
        ...
        *,
        ...
        startai.Container class. It calculates the outer product of two input arrays or
        containers along the last dimension and returns the resulting container. The
        input arrays should be either startai.Container, startai.Array, or startai.NativeArray. The
        ...
        map_sequences : bool
            ...
            Default is False.
        out : Optional[startai.Container]
    ...
    def _static_qr(
        ...
        /,
        *,
        mode: Union[str, startai.Container] = "reduced",
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        prune_unapplied: Union[bool, startai.Container] = False,
        map_sequences: Union[bool, startai.Container] = False,
        ...
        """startai.Container static method variant of startai.qr. This method simply
        ...
        Examples
        --------
        >>> x = startai.Container(a = startai.native_array([[1., 2.], [3., 4.]]),
        ...                   b = startai.array([[2., 3.], [4. ,5.]]))
        >>> q,r = startai.Container.static_qr(x, mode='complete')
        >>> print(q)
        {
            a: startai.array([[-0.31622777, -0.9486833],
                        [-0.9486833, 0.31622777]]),
            b: startai.array([[-0.4472136, -0.89442719],
                        [-0.89442719, 0.4472136]])
        }
        >>> print(r)
        {
            a: startai.array([[-3.16227766, -4.42718872],
                        [0., -0.63245553]]),
            b: startai.array([[-4.47213595, -5.81377674],
                        [0., -0.4472136]])
        }
        """
        return ContainerBase.cont_multi_map_in_function(
    ...
    def qr(
        ...
        *,
        ...
        """startai.Container instance method variant of startai.qr. This method simply
        wraps the function, and so the docstring for startai.qr also applies to
        this method with minimal changes.
    ...
    def _static_slogdet(
        ...
        *,
        ...
        """startai.Container static method variant of startai.slogdet. This method
        simply wraps the function, and so the docstring for startai.slogdet also
        applies to this method with minimal changes.
        ...
        ...                                [2.0, 1.0]]))
        >>> y = startai.Container.static_slogdet(x)
        >>> print(y)
        {
            a: [
                sign = startai.array(-1.),
                logabsdet = startai.array(0.6931472)
            ],
            b: [
                sign = startai.array(-1.),
                logabsdet = startai.array(1.0986123)
            ]
        }
        """
        return ContainerBase.cont_multi_map_in_function(
    ...
    def slogdet(
        ...
        *,
        ...
        """startai.Container instance method variant of startai.slogdet. This method
        simply wraps the function, and so the docstring for startai.slogdet also
        applies to this method with minimal changes.
        ...
        [{
            ...
            a: startai.array(0.69314718),
            b: startai.array(1.09861231)
        }]
        """
    ...
    def _static_svd(
        ...
        *,
        ...
        full_matrices: Union[bool, startai.Container] = True,
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        prune_unapplied: Union[bool, startai.Container] = False,
        map_sequences: Union[bool, startai.Container] = False,
        out: Optional[startai.Container] = None,
    ) -> Union[startai.Container, Tuple[startai.Container, ...]]:
        """startai.Container static method variant of startai.svd. This method simply
        ...
        .. note::
            ...
            vectors irrespective of the value of compute_uv, however Startai will
        ...
        ret
            A container of a namedtuples ``(U, S, Vh)``. More details in startai.svd.
        ...
        >>> y = startai.random_normal(shape = (2, 4))
        >>> z = startai.Container(a=x, b=y)
        >>> ret = startai.Container.static_svd(z)
        >>> aU, aS, aVh = ret.a
        >>> bU, bS, bVh = ret.b
    ...
    def svd(
        ...
        *,
        ...
        """startai.Container instance method variant of startai.svd. This method simply
        wraps the function, and so the docstring for startai.svd also applies to
        this method with minimal changes.
        ...
        {
            a: (<class startai.data_classes.array.array.Array> shape=[9, 9]),
            b: startai.array([[-0.3475602, -0.93765765],
                          [-0.93765765, 0.3475602]])
        } {
            a: startai.array([3.58776021, 3.10416126, 2.80644298, 1.87024701, 1.48127627,
                          0.79101127]),
            b: startai.array([1.98288572, 0.68917423])
        } {
            a: (<class startai.data_classes.array.array.Array> shape=[6, 6]),
            b: (<class startai.data_classes.array.array.Array> shape=[4, 4])
        }
        """
    ...
    def _static_tensordot(
        ...
        /,
        *,
        axes: Union[int, Tuple[List[int], List[int]], startai.Container] = 2,
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        prune_unapplied: Union[bool, startai.Container] = False,
        map_sequences: Union[bool, startai.Container] = False,
    ...
    def _static_tensorsolve(
        ...
        /,
        *,
        axes: Optional[Union[int, Tuple[List[int], List[int]], startai.Container]] = None,
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        prune_unapplied: Union[bool, startai.Container] = False,
        map_sequences: Union[bool, startai.Container] = False,
    ...
    def _static_trace(
        ...
        *,
        offset: Union[int, startai.Container] = 0,
        axis1: Union[int, startai.Container] = 0,
        axis2: Union[int, startai.Container] = 1,
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        prune_unapplied: Union[bool, startai.Container] = False,
        ...
        """startai.Container static method variant of startai.trace. This method
        ...
        With :class:`startai.Container` input:
        >>> x = startai.Container(
        ...    a = startai.array([[7, 1, 2],
        ...                   [1, 3, 5],
        ...                   [0, 7, 4]]),
        ...    b = startai.array([[4, 3, 2],
        ...                   [1, 9, 5],
        ...                   [7, 0, 6]])
        )
    ...
    def trace(
        ...
        *,
        ...
        """startai.Container instance method variant of startai.trace. This method
        Returns the sum along the specified diagonals of a matrix (or a stack
        of matrices).
    ...
    def _static_vector_norm(
        ...
        *,
        ...
        keepdims: Union[bool, startai.Container] = False,
        ord: Union[int, float, Literal[inf, -inf], startai.Container] = 2,
        dtype: Optional[Union[startai.Dtype, startai.NativeDtype, startai.Container]] = None,
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        prune_unapplied: Union[bool, startai.Container] = False,
        ...
        """startai.Container static method variant of startai.vector_norm. This method
        simply wraps the function, and so the docstring for startai.vector_norm
        also applies to this method with minimal changes.
        ...
        Examples
        --------
        >>> x = startai.Container(a = [1., 2., 3.], b = [-2., 0., 3.2])
        >>> y = startai.Container.static_vector_norm(x)
        >>> print(y)
        {
            a: startai.array([3.7416575]),
            b: startai.array([3.77359247])
        }
        """
        return ContainerBase.cont_multi_map_in_function(
            "vector_norm",
    ...
    def vector_norm(
        ...
        *,
        ...
        r"""startai.Container instance method variant of startai.vector_norm. This
        method simply wraps the function, and so the docstring for
        startai.vector_norm also applies to this method with minimal changes.
    ...
    def _static_vector_to_skew_symmetric_matrix(
        vector: Union[startai.Array, startai.NativeArray, startai.Container],
        /,
        *,
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
    ...
    def _static_vander(
        ...
        /,
        *,
        N: Optional[Union[int, startai.Container]] = None,
        increasing: Union[bool, startai.Container] = False,
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        prune_unapplied: Union[bool, startai.Container] = False,
        map_sequences: Union[bool, startai.Container] = False,
        ...
        """startai.Container static method variant of startai.vander. This method
        simply wraps the function, and so the docstring for startai.vander also
        applies to this method with minimal changes.

        Parameters
        ----------
        x
            startai container that contains 1-D arrays.
        N
        ...
        >>> x = startai.Container(
                a = startai.array([1, 2, 3, 5])
                b = startai.array([6, 7, 8, 9])
            )
        >>> startai.Container.static_vander(x)
        {
            a: startai.array(
                    [[  1,   1,   1,   1],
                    [  8,   4,   2,   1],
    ...
    def vander(
        ...
        *,
        ...
        """startai.Container instance method variant of startai.vander. This method
    ...
    def static_general_inner_product(
        x1: Union[startai.Container, startai.Array, startai.NativeArray],
        x2: Union[startai.Container, startai.Array, startai.NativeArray],
        n_modes: Optional[Union[int, startai.Container]] = None,
        /,
        *,
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        ...
        """startai.Container static method variant of startai.general_inner_product.
        ...
        --------
        >>> x = startai.Container(
                a=startai.reshape(startai.arange(4), (2, 2)),
                b=startai.reshape(startai.arange(8), (2, 4)),
            )
        >>> startai.Container.general_inner_product(x, 1)
            {
                a: startai.array(6),
                b: startai.array(28)
            }
    ...
    def general_inner_product(
        ...
        *,
        ...
        """startai.Container instance method variant of startai.general_inner_product.

        This method simply wraps the function, and so the docstring for
        startai.general_inner_product also applies to this method with
        minimal changes.
        """
