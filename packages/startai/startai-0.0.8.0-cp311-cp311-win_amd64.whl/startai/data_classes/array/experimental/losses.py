...
class _ArrayWithLossesExperimental(abc.ABC):
    def l1_loss(
        ...
        *,
        ...
        """startai.Array instance method variant of startai.l1_loss. This method simply
        wraps the function, and so the docstring for startai.l1_loss also applies
        ...
        >>> y = startai.array([0.7, 1.8, 2.9])
        >>> z = x.l1_loss(y)
        >>> print(z)
        startai.array(0.20000000000000004)
        """
        return startai.l1_loss(self._data, target, reduction=reduction, out=out)
    ...
    def log_poisson_loss(
        ...
        *,
        ...
        """startai.Array instance method variant of startai.log_poisson_loss. This
        method simply wraps the function, and so the docstring for startai.l1_loss
        ...
        """
        return startai.log_poisson_loss(
            self._data,
            target,
    ...
    def huber_loss(
        ...
        *,
        ...
        """startai.Array instance method variant of huber_loss. This method simply
    ...
    def smooth_l1_loss(
        ...
        *,
        ...
        """startai.Array instance method variant of startai. smooth_l1_loss. This
        method simply wraps the function, and so the docstring for
        startai.smooth_l1_loss also applies to this method with minimal changes.
        ...
        >>> y = startai.array([2, 2, 2, 2])
        >>> z = x.smooth_l1_loss(y, beta=0.5)
        >>> print(z)
        startai.array(0.8125)
        """
        return startai.smooth_l1_loss(
    ...
    def soft_margin_loss(
        ...
        *,
        ...
        """startai.Array instance method variant of startai.soft_margin_loss. This
        method simply wraps the function, and so the docstring for
        ...
        >>> print(z)
        startai.array([0.35667497, 0.22314353, 1.60943791])
        """
        return startai.soft_margin_loss(self._data, target, reduction=reduction, out=out)
    ...
    def kl_div(
        ...
        *,
        ...
        """startai.Array instance method variant of startai.kl_div. This method simply
        wraps the function, and so the docstring for startai.kl_div also applies to
        this method with minimal changes.
        ...
        >>> print(output_array)
        startai.array(0.0916)
        """
        return startai.kl_div(
    ...
    def poisson_nll_loss(
        ...
        *,
        ...
        >>> print(loss)
        startai.array(16.1977562)
        """
        return startai.poisson_nll_loss(
            self._data,
            target,
            log_input=log_input,
            full=full,
    ...
    def hinge_embedding_loss(
        ...
        *,
        ...
        >>> input_tensor = startai.array([1, 2, 3], dtype=startai.float64)
        >>> target_tensor = startai.array([1, -1, -1], dtype=startai.float64)
        >>> input_tensor.hinge_embedding_loss(target_tensor, margin=2.0)
        startai.array(0.33333333)
        """
        return startai.hinge_embedding_loss(
            self._data,
            target,
            margin=margin,
            reduction=reduction,
