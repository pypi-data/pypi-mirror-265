...
class _ArrayWithStatisticalExperimental(abc.ABC):
    def histogram(
        ...
        /,
        *,
        bins: Optional[Union[int, startai.Array, startai.NativeArray, str]] = None,
        axis: Optional[Union[startai.Array, startai.NativeArray]] = None,
        ...
        """startai.Array instance method variant of startai.histogram. This method
    ...
    def median(
        ...
        *,
        ...
        """startai.Array instance method variant of startai.median. This method simply
        wraps the function, and so the docstring for startai.median also applies to
        ...
        """
        return startai.median(self._data, axis=axis, keepdims=keepdims, out=out)
    ...
    def nanmean(
        ...
        *,
        ...
        """startai.Array instance method variant of startai.nanmean. This method simply
        wraps the function, and so the docstring for startai.nanmean also applies
    ...
    def nanmin(
        ...
        *,
        ...
        """startai.Array instance method variant of startai.nanmin. This method simply
        ...
        Examples
        --------
        >>> a = startai.array([[1, 2], [3, startai.nan]])
        >>> a.nanmin(a)
        1.0
        >>> a.nanmin(a, axis=0)
        startai.array([1., 2.])
        """
        return startai.nanmin(
            self._data,
            axis=axis,
            keepdims=keepdims,
            out=out,
    ...
    def nanprod(
        ...
        *,
        ...
        """startai.Array instance method variant of startai.nanprod. This method simply
    ...
    def quantile(
        ...
        *,
        ...
        """startai.Array instance method variant of startai.quantile. This method
    ...
    def corrcoef(
        ...
        *,
        ...
        """startai.Array instance method variant of startai.corrcoef. This method
        ...
        Examples
        --------
        >>> a = startai.array([[0., 1., 2.], [2., 1., 0.]])
        >>> a.corrcoef()
            startai.array([[ 1., -1.],
                       [-1.,  1.]])
        >>> a.corrcoef(rowvar=False)
            startai.array([[ 1., nan, -1.],
                       [nan, nan, nan],
                       [-1., nan,  1.]])
        """
        return startai.corrcoef(self._data, y=y, rowvar=rowvar, out=out)
    ...
    def nanmedian(
        ...
        *,
        ...
        """startai.Array instance method variant of startai.nanmedian. This method
        ...
        >>> a = startai.array([[10.0, startai.nan, 4], [3, 2, 1]])
        >>> a.nanmedian()
            startai.array(3.)
        >>> a.nanmedian(axis=0)
            startai.array([6.5, 2. , 2.5])
        """
    ...
    def bincount(
        ...
        *,
        ...
        Examples
        --------
        >>> a = startai.array([0, 1, 1, 3, 2, 1, 7])
        >>> a.bincount()
            startai.array([1, 3, 1, 1, 0, 0, 0, 1])
        >>> a.bincount(minlength=10)
            startai.array([1, 3, 1, 1, 0, 0, 0, 1, 0, 0])
        >>> a.bincount(weights=startai.array([0.3, 0.5, 0.2, 0.7, 1., 0.6, 1.]))
            startai.array([0.3, 1.3, 1. , 0.7, 0. , 0. , 0. , 1. ])
        """
        return startai.bincount(
            self._data,
            weights=weights,
            minlength=minlength,
            out=out,
    ...
    def igamma(
        ...
        *,
        ...
        """startai.Array instance method variant of startai.igamma. This method simply
        wraps the function, and so the docstring for startai.igamma also applies to
        this method with minimal changes.
    ...
    def cov(
        self: startai.Array,
        x2: Optional[Union[startai.Array, startai.NativeArray]] = None,
        /,
        *,
        rowVar: bool = True,
        bias: bool = False,
        ...
        """startai.Array instance method variant of startai.cov. This method simply
    ...
    def cummax(
        ...
        *,
        ...
        """startai.Array instance method variant of startai.cummax. This method simply
        wraps the function, and so the docstring for startai.cummax also applies to
        this method with minimal changes.
        ...
        --------
        >>> x = startai.array([1, 2, 5, 4, 3])
        >>> y = x.cummax()
        >>> print(y)
        (startai.array([1, 2, 5, 5, 5]), startai.array([0, 1, 2, 2, 2]))
    ...
    def cummin(
        ...
        *,
        ...
        """startai.Array instance method variant of startai.cummin. This method simply
        wraps the function, and so the docstring for startai.cummin also applies to
        this method with minimal changes.
