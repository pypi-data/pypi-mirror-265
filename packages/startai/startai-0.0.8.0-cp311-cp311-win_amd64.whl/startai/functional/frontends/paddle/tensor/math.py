...
def clip_(x, min=None, max=None, name=None):
    ...
    if max is None:
        max = startai.max(x)
    res = startai.clip(x, min, max)
    if res.dtype != x.dtype:
        res = startai.astype(res, x.dtype)
    return res
...
def exp_(x, name=None):
    return startai.inplace_update(x, exp(x))


@with_supported_dtypes({"2.6.0 and below": ("float32", "float64")}, "paddle")
@to_startai_arrays_and_back
def floor_(x, name=None):
    return startai.inplace_update(x, floor(x))


@with_supported_dtypes({"2.6.0 and below": ("float32", "float64")}, "paddle")
@to_startai_arrays_and_back
def lerp_(x, y, weight, name=None):
    return startai.inplace_update(x, lerp(x, y, weight))


@with_unsupported_dtypes({"2.6.0 and below": ("float16", "bfloat16")}, "paddle")
@to_startai_arrays_and_back
def reciprocal_(x, name=None):
    return startai.inplace_update(x, reciprocal(x))


@with_unsupported_dtypes({"2.6.0 and below": ("float16", "bfloat16")}, "paddle")
@to_startai_arrays_and_back
def round_(x, name=None):
    return startai.inplace_update(x, round(x))


@with_supported_dtypes({"2.6.0 and below": ("float32", "float64")}, "paddle")
def rsqrt_(x, name=None):
    return startai.inplace_update(x, reciprocal(sqrt(x)))


@with_supported_dtypes({"2.6.0 and below": ("float32", "float64")}, "paddle")
@to_startai_arrays_and_back
def sqrt_(x, name=None):
    return startai.inplace_update(x, sqrt(x))


@with_supported_dtypes({"2.6.0 and below": ("float32", "float64")}, "paddle")
@to_startai_arrays_and_back
def subtract_(x, y, name=None):
    return startai.inplace_update(x, subtract(x, y))


@with_supported_dtypes({"2.6.0 and below": ("float32", "float64")}, "paddle")
@to_startai_arrays_and_back
def tanh_(x, name=None):
    return startai.inplace_update(x, tanh(x))
