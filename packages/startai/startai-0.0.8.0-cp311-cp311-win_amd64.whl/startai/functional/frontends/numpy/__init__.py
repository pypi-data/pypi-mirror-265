...
def promote_numpy_dtypes(
    ...
    type1, type2 = startai.as_startai_dtype(type1), startai.as_startai_dtype(type2)
    try:
...
def promote_types_of_numpy_inputs(
    ...
    """Promote the dtype of the given startai array inputs to a common dtype based
...
from startai.functional.frontends.numpy.mathematical_functions.miscellaneous import (
    _absolute,
    _cbrt,
    _copysign,
    _fabs,
...
from startai.functional.frontends.numpy.mathematical_functions.arithmetic_operations import (  # noqa
    _add,
    _divide,
    _float_power,
    _floor_divide,
...
from startai.functional.frontends.numpy.mathematical_functions.trigonometric_functions import (  # noqa
    _arccos,
    _arcsin,
    _arctan,
    _cos,
...
from startai.functional.frontends.numpy.mathematical_functions.handling_complex_numbers import (  # noqa
    _conj,
)

from startai.functional.frontends.numpy.mathematical_functions.hyperbolic_functions import (
    _arccosh,
    _arcsinh,
    _arctanh,
    _cosh,
...
from startai.functional.frontends.numpy.mathematical_functions.rounding import (
    _ceil,
    _trunc,
    _floor,
    _rint,
...
from startai.functional.frontends.numpy.logic.comparison import (
    _equal,
    _greater,
    _greater_equal,
    _less,
...
from startai.functional.frontends.numpy.mathematical_functions.exponents_and_logarithms import (  # noqa
    _exp,
    _exp2,
    _expm1,
    _log,
...
from startai.functional.frontends.numpy.logic.array_type_testing import (
    _isfinite,
    _isinf,
    _isnan,
)

from startai.functional.frontends.numpy.logic.logical_operations import (
    _logical_and,
    _logical_not,
    _logical_or,
    _logical_xor,
...
from startai.functional.frontends.numpy.linalg.matrix_and_vector_products import (
    _matmul,
    dot,
    einsum,
)

from startai.functional.frontends.numpy.mathematical_functions.extrema_finding import (
    _maximum,
    _minimum,
    _fmax,
    _fmin,
...
from startai.functional.frontends.numpy.mathematical_functions.floating_point_routines import (  # noqa
    _nextafter,
    _signbit,
    _spacing,
)
