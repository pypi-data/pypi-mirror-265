...
from startai.functional.backends.paddle import backend_version
from startai.utils.exceptions import StartaiNotImplementedException
from startai.functional.startai.random import _check_bounds_and_get_shape

# local
import startai
from paddle.device import core
from startai import with_supported_device_and_dtypes
...
def bernoulli(
    ...
    *,
    ...
    shape: Optional[Union[startai.NativeArray, Sequence[int]]] = None,
    device: core.Place = None,
    dtype: paddle.dtype,
    seed: Optional[int] = None,
    out: Optional[paddle.Tensor] = None,
