"""Collection of Paddle random functions, wrapped to fit Startai syntax and
signature."""
...
from startai.functional.startai.random import (
...
def random_uniform(
    *,
    ...
    shape: Optional[Union[paddle.Tensor, startai.NativeShape, Sequence[int]]] = None,
    dtype: paddle.dtype,
...
def randint(
    ...
    *,
    shape: Optional[Union[startai.NativeShape, Sequence[int]]] = None,
    device: core.Place = None,
    dtype: Optional[Union[paddle.dtype, startai.Dtype]] = None,
    seed: Optional[int] = None,
    out: Optional[paddle.Tensor] = None,
) -> paddle.Tensor:
    if not dtype:
