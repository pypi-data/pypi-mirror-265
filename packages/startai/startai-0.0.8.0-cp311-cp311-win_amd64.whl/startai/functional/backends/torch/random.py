"""Collection of PyTorch random functions, wrapped to fit Startai syntax and
signature."""
...
def random_uniform(
    *,
    ...
    shape: Optional[Union[torch.Tensor, startai.NativeShape, Sequence[int]]] = None,
    dtype: torch.dtype,
...
def randint(
    ...
    *,
    shape: Optional[Union[startai.NativeShape, Sequence[int]]] = None,
    device: torch.device = None,
    dtype: Optional[Union[torch.dtype, startai.Dtype]] = None,
    seed: Optional[int] = None,
    out: Optional[torch.Tensor] = None,
) -> torch.Tensor:
    if not dtype:
