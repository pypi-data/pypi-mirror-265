...
# local
from startai.func_wrapper import with_unsupported_dtypes, handle_out_argument
from .. import backend_version
import startai
from startai.functional.startai.experimental.manipulation import _to_tf_padding
...
def concat_from_sequence(
    ...
    *,
    ...
    for i in input_sequence:
        highest_dtype = startai.as_native_dtype(startai.promote_types(highest_dtype, i.dtype))
