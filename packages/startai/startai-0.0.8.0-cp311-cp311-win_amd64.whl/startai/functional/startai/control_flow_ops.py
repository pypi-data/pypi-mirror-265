...
def if_else(
    ...
    body_fn: Callable,
    orelse_fn: Callable,
    vars: Dict[str, Union[startai.Array, startai.NativeArray]],
) -> Any:
    ...
    >>> vars = (1,)
    >>> result = startai.if_else(cond, body_fn, orelse_fn, vars)
    >>> print(result)
    2
    ...
    >>> vars = startai.array([1, 2, 3])
    >>> result = startai.if_else(cond, body_fn, orelse_fn, vars=(vars,))
    >>> print(result)
    startai.array([0.5, 1.0, 1.5])
    """
...
def while_loop(
    ...
    >>> result = startai.while_loop(test_fn, body_fn, vars= (i,))
    >>> print(result)
    (3,)
    ...
    >>> vars = (i, j)
    >>> result = startai.while_loop(test_fn, body_fn, vars=vars)
    >>> print(result)
    (3, 8)
    """
...
def for_loop(
    ...
    body_fn: Callable,
    vars: Iterable[Union[startai.Array, startai.NativeArray]],
):
