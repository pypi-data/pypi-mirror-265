...
def test_constant(
    ...
    ret_startai, ret_gt = helpers.test_method(
    ...
    assert ret_startai.shape == ret_gt.shape
    assert ret_startai.dtype == ret_gt.dtype
    assert startai.all(startai.equal(ret_startai, startai.array(constant)))
...
def test_first_layer_siren(
    ...
    assert ret_startai.shape == ret_gt.shape
    assert ret_startai.dtype == ret_gt.dtype
    assert startai.all(startai.less(startai.abs(ret_startai), startai.array(bound)))
...
def test_ones(
    ...
    assert ret_startai.shape == ret_gt.shape
    assert ret_startai.dtype == ret_gt.dtype
    assert startai.all(startai.equal(ret_startai, startai.array(1.0)))
...
def test_zeros(
    ...
    assert ret_startai.shape == ret_gt.shape
    assert ret_startai.dtype == ret_gt.dtype
    assert startai.all(startai.equal(ret_startai, startai.array(0.0)))
