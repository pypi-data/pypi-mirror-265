...
from startai_tests.test_startai.test_frontends.test_jax.test_numpy.test_manipulations import (
    _get_input_and_reshape,
)

CLASS_TREE = "startai.functional.frontends.jax.numpy.ndarray"
...
def test_jax_array_at(x_y_index, backend_fw):
    with BackendHandler.update_backend(backend_fw) as startai_backend:
        jax_frontend = startai_backend.utils.dynamic_import.import_module(
            "startai.functional.frontends.jax"
        )
        xy, idx = x_y_index
