...
from startai_tests.test_startai.helpers.hypothesis_helpers.general_helpers import (
    matrix_is_stable,
)
...
@handle_test(
    fn_tree="functional.startai.cholesky",
...
# cross
@handle_test(
    fn_tree="functional.startai.cross",
...
# det
@handle_test(
    fn_tree="functional.startai.det",
    dtype_x=_det_helper(),
)
...
# diag
@handle_test(
    fn_tree="functional.startai.diag",
...
# diagonal
@handle_test(
    fn_tree="functional.startai.diagonal",
    dtype_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("numeric"),
        min_num_dims=2,
        max_num_dims=2,
...
# eigh
@handle_test(
    fn_tree="functional.startai.eigh",
...
# eigvalsh
@handle_test(
    fn_tree="functional.startai.eigvalsh",
    dtype_x=_get_dtype_and_matrix(symmetric=True),
    UPLO=st.sampled_from(("L", "U")),
    test_gradients=st.just(False),
)
...
# inner
@handle_test(
    fn_tree="functional.startai.inner",
...
# inv
@handle_test(
    fn_tree="functional.startai.inv",
    dtype_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float"),
...
# matmul
@handle_test(
    fn_tree="functional.startai.matmul",
...
# matrix_norm
@handle_test(
    fn_tree="functional.startai.matrix_norm",
...
# matrix_power
@handle_test(
    fn_tree="functional.startai.matrix_power",
    dtype_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float"),
        min_value=1e-3,
        max_value=20,
...
# matrix_rank
@handle_test(
    fn_tree="functional.startai.matrix_rank",
...
# matrix_transpose
@handle_test(
    fn_tree="functional.startai.matrix_transpose",
...
# outer
@handle_test(
    fn_tree="functional.startai.outer",
    dtype_xy=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("numeric"),
        num_arrays=2,
        min_value=1,
...
# pinv
@handle_test(
    fn_tree="functional.startai.pinv",
    dtype_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float"),
        min_num_dims=2,
        max_num_dims=5,
...
# execute with grads error
@handle_test(
    fn_tree="functional.startai.slogdet",
    dtype_x=_det_helper(),
    test_with_out=st.just(False),
)
...
@handle_test(
    fn_tree="functional.startai.solve",
...
# svd
@handle_test(
    fn_tree="functional.startai.svd",
    dtype_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float"),
        min_num_dims=3,
        max_num_dims=5,
...
def test_svd(*, dtype_x, uv, fm, test_flags, backend_fw, fn_name, on_device):
    ...
    if uv:
        ...
        with BackendHandler.update_backend("numpy") as startai_backend:
            S_mat = (
                S
                * startai_backend.eye(
...
# svdvals
@handle_test(
    fn_tree="functional.startai.svdvals",
    dtype_x=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("float"),
        min_value=0,
        max_value=50,
...
# tensordot
@handle_test(
    fn_tree="functional.startai.tensordot",
...
# trace
@handle_test(
    fn_tree="functional.startai.trace",
...
# vander
@handle_test(
    fn_tree="functional.startai.vander",
...
# vecdot
@handle_test(
    fn_tree="functional.startai.vecdot",
    dtype_x1_x2_axis=dtype_value1_value2_axis(
        available_dtypes=helpers.get_dtypes("numeric"),
...
# vector_norm
@handle_test(
    fn_tree="functional.startai.vector_norm",
...
def test_vector_norm(
    *, dtype_values_axis, kd, ord, dtype, test_flags, backend_fw, fn_name, on_device
    ...
    with BackendHandler.update_backend(backend_fw) as startai_backend:
        arr = startai_backend.array([[1.0, 2.0, 3.0], [-1.0, 2.0, 4.0]])
        arr_normed_inf = startai_backend.vector_norm(arr, axis=0, ord=float("inf"))
        arr_normed_min_inf = startai_backend.vector_norm(arr, axis=0, ord=float("-inf"))
...
@handle_test(
    fn_tree="functional.startai.vector_to_skew_symmetric_matrix",
