...
# clip
@handle_test(
    fn_tree="functional.startai.clip",
...
# concat
@handle_test(
    fn_tree="functional.startai.concat",
...
# constant_pad
@handle_test(
    fn_tree="functional.startai.constant_pad",
...
# expand_dims
@handle_test(
    fn_tree="functional.startai.expand_dims",
...
# flip
@handle_test(
    fn_tree="functional.startai.flip",
    dtype_value=helpers.dtype_and_values(
...
# permute_dims
@handle_test(
    fn_tree="functional.startai.permute_dims",
    dtype_value=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("valid", full=True),
        shape=st.shared(helpers.get_shape(min_num_dims=1), key="value_shape"),
    ),
...
# repeat
@handle_test(
    fn_tree="functional.startai.repeat",
    dtype_value=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("valid", full=True),
        shape=st.shared(helpers.get_shape(min_num_dims=1), key="value_shape"),
    ),
...
@handle_test(
    fn_tree="functional.startai.reshape",
    dtype_value=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("valid", full=True),
        shape=st.shared(helpers.get_shape(), key="value_shape"),
    ),
...
# roll
@handle_test(
    fn_tree="functional.startai.roll",
    dtype_value=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("valid"),
        shape=st.shared(helpers.get_shape(min_num_dims=1), key="value_shape"),
    ...
    shift=helpers.dtype_and_values(
        available_dtypes=[startai.int32],
        max_num_dims=1,
...
@handle_test(
    fn_tree="functional.startai.split",
    dtype_value=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("valid"),
        shape=st.shared(helpers.get_shape(min_num_dims=1), key="value_shape"),
    ),
...
# squeeze
@handle_test(
    fn_tree="functional.startai.squeeze",
    dtype_value=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("valid", full=True),
        shape=st.shared(helpers.get_shape(), key="value_shape"),
    ),
...
# stack
@handle_test(
    fn_tree="functional.startai.stack",
...
# swapaxes
@handle_test(
    fn_tree="functional.startai.swapaxes",
    dtype_value=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("valid", full=True),
...
@handle_test(
    fn_tree="functional.startai.tile",
    dtype_value=helpers.dtype_and_values(
        available_dtypes=helpers.get_dtypes("valid", full=True),
        shape=st.shared(helpers.get_shape(min_num_dims=1), key="value_shape"),
    ),
...
# unstack
@handle_test(
    fn_tree="functional.startai.unstack",
...
# zero_pad
@handle_test(
    fn_tree="functional.startai.zero_pad",
