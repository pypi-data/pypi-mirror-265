...
# cumprod
@handle_test(
    fn_tree="functional.startai.cumprod",
...
@handle_test(
    fn_tree="functional.startai.cumsum",
    dtype_x_axis_castable=_get_castable_dtype(),
    exclusive=st.booleans(),
    reverse=st.booleans(),
    test_gradients=st.just(False),
...
# einsum
@handle_test(
    fn_tree="functional.startai.einsum",
...
# max
@handle_test(
    fn_tree="functional.startai.max",
...
# mean
@handle_test(
    fn_tree="functional.startai.mean",
...
# min
@handle_test(
    fn_tree="functional.startai.min",
...
# prod
@handle_test(
    fn_tree="functional.startai.prod",
    dtype_x_axis_castable=_get_castable_dtype(),
    keep_dims=st.booleans(),
)
def test_prod(
...
# std
@handle_test(
    fn_tree="functional.startai.std",
...
# sum
@handle_test(
    fn_tree="functional.startai.sum",
    dtype_x_axis_castable=_get_castable_dtype(),
    keep_dims=st.booleans(),
    test_gradients=st.just(False),
)
...
# var
@handle_test(
    fn_tree="functional.startai.var",
