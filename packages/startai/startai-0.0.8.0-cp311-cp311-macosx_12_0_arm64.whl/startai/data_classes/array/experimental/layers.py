...
class _ArrayWithLayersExperimental(abc.ABC):
    def max_pool1d(
        ...
        *,
        ...
        """startai.Array instance method variant of `startai.max_pool1d`. This method
        simply wraps the function, and so the docstring for `startai.max_pool1d`
    ...
    def max_pool2d(
        ...
        *,
        ...
        """startai.Array instance method variant of `startai.max_pool2d`. This method
        simply wraps the function, and so the docstring for `startai.max_pool2d`
        also applies to this method with minimal changes.
    ...
    def avg_pool1d(
        ...
        *,
        ...
        """startai.Array instance method variant of `startai.avg_pool1d`. This method
        simply wraps the function, and so the docstring for `startai.avg_pool1d`
        also applies to this method with minimal changes.
    ...
    def avg_pool2d(
        ...
        *,
        ...
        """startai.Array instance method variant of `startai.avg_pool2d`. This method
        simply wraps the function, and so the docstring for `startai.avg_pool2d`
        also applies to this method with minimal changes.
    ...
    def dct(
        ...
        *,
        ...
        """startai.Array instance method variant of startai.dct. This method simply
        ...
        startai.array([ 102.,  -51.5,   0.,  -5.39,   0.,  -1.61,   0., -0.406])
        """
        return startai.dct(
            self._data,
            type=type,
    ...
    def idct(
        ...
        *,
        ...
        """startai.Array instance method variant of startai.idct. This method simply
    ...
    def fft(
        ...
        *,
        ...
        """startai.Array instance method variant of startai.ifft. This method simply
        ...
        Examples
        --------
        >>> a = startai.array((np.exp(2j * np.pi * np.arange(8) / 8)))
        >>> a.fft(0)
    ...
    def embedding(
        ...
        *,
        ...
        return startai.embedding(self._data, indices, max_norm=max_norm, out=out)
    ...
    def adaptive_avg_pool1d(
        ...
        """
        return startai.adaptive_avg_pool1d(
            self._data,
            output_size,
        )
    ...
    def adaptive_avg_pool2d(
        ...
        *,
        ...
        """
        return startai.adaptive_avg_pool2d(
            self._data,
            output_size,
            data_format=data_format,
        )
    ...
    def adaptive_max_pool2d(
        ...
        -------
            ...
            (C, S_0, S_1), where S = `output_size`
        """
        return startai.adaptive_max_pool2d(
            self._data,
            output_size,
        )
    ...
    def adaptive_max_pool3d(
        ...
        return startai.adaptive_max_pool3d(
            self._data,
            output_size,
        )
        ...
        *,
        ...
        array([[ 50.  +0.j        ,   0.  +0.j        ,   0.  +0.j        , # may vary
            ...
            [-12.5-17.20477401j,   0.  +0.j        ,   0.  +0.j        ,
                0.  +0.j        ,   0.  +0.j        ]])
        """
        return startai.fft2(self._data, s=s, dim=dim, norm=norm, out=out)
    ...
    def ifftn(
        ...
        *,
        ...
        ...                 [0.18791352+0.30690572j, 0.82115787+0.96195183j,
        ...                 0.44719226+0.72654048j]])
        >>> y = startai.ifftn(x, s=[2, 1], axes=[0, 1], norm='ortho')
        >>> print(y)
        startai.array([[ 0.8344667 +0.98222595j],
               [-0.48472244+0.30233797j]])
        """
        return startai.ifftn(self._data, s=s, axes=axes, norm=norm, out=out)
    ...
    def rfft(
        ...
        *,
        ...
        """startai.Array instance method variant of startai.rfft. This method simply
        wraps the function, and so the docstring for startai.rfft also applies to
        this method with minimal changes.
        ...
        """
        return startai.rfft(self, n=n, axis=axis, norm=norm, out=out)
    ...
    def rfftn(
        ...
        *,
        ...
        """
        return startai.rfftn(self._data, s=s, axes=axes, norm=norm, out=out)
