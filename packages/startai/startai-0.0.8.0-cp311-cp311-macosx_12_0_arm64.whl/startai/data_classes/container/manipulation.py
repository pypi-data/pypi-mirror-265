...
class _ContainerWithManipulation(ContainerBase):
    ...
    def _static_concat(
        ...
        *,
        ...
        """startai.Container static method variant of startai.concat.

        This method simply wraps the function, and so the docstring for
        startai.concat also applies to this method with minimal changes.
        """
    ...
    def concat(
        ...
        *,
        ...
        """startai.Container instance method variant of startai.concat.
    ...
    def _static_expand_dims(
        ...
        *,
        ...
        axis: Union[int, Sequence[int], startai.Container] = 0,
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        prune_unapplied: Union[bool, startai.Container] = False,
        map_sequences: Union[bool, startai.Container] = False,
        ...
        """startai.Container static method variant of startai.expand_dims. This method
        ...
        >>> x = startai.Container(a=startai.array([0., 1.]),
        ...                   b=startai.array([3., 4.]),
        ...                   c=startai.array([6., 7.]))
        >>> y = startai.Container.static_expand_dims(x, axis=1)
        >>> print(y)
        {
            a: startai.array([[0.],
                          [1.]]),
        ...
        ...                   c=startai.array([6., 7., 8.]))
        >>> container_axis = startai.Container(a=0, b=-1, c=(0,1))
        >>> y = startai.Container.static_expand_dims(x, axis=container_axis)
        >>> print(y)
        {
    ...
    def expand_dims(
        ...
        *,
        ...
        """startai.Container instance method variant of startai.expand_dims. This
        method simply wraps the function, and so the docstring for
        startai.expand_dims also applies to this method with minimal changes.
    ...
    def _static_split(
        ...
        *,
        ...
        num_or_size_splits: Optional[
            Union[int, Sequence[int], startai.Array, startai.NativeArray, startai.Container]
        ] = None,
        axis: Union[int, startai.Container] = 0,
        with_remainder: Union[bool, startai.Container] = False,
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        prune_unapplied: Union[bool, startai.Container] = False,
        map_sequences: Union[bool, startai.Container] = False,
    ) -> List[startai.Container]:
        """startai.Container static method variant of startai.split. This method simply
        ...
        Examples
        --------
        >>> x = startai.Container(a=startai.array([2, 1, 5, 9]), b=startai.array([3, 7, 2, 11]))
        >>> y = startai.Container.static_split(x, num_or_size_splits=2)
        >>> print(y)
        [{
            a: startai.array([2, 1]),
            b: startai.array([3, 7])
    ...
    def split(
        ...
        *,
        ...
        """startai.Container instance method variant of startai.split. This method
    ...
    def _static_permute_dims(
        x: startai.Container,
        /,
        axes: Union[Tuple[int, ...], startai.Container],
        *,
        copy: Optional[Union[bool, startai.Container]] = None,
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        ...
        """startai.Container static method variant of startai.permute_dims. This method
        ...
        >>> y = startai.Container.static_permute_dims(x, axes=(1, 0))
        >>> print(y)
        {
            a:startai.array([[0.],[1.],[2.]]),
            b:startai.array([[3.],[4.],[5.]])
    ...
    def permute_dims(
        ...
        *,
        ...
        """startai.Container instance method variant of startai.permute_dims. This
        method simply wraps the function, and so the docstring for
        startai.permute_dims also applies to this method with minimal changes.
    ...
    def _static_flip(
        ...
        *,
        ...
        """startai.Container static method variant of startai.flip. This method simply
        ...
        >>> y = startai.Container.static_flip(x)
        >>> print(y)
        {
        ...
        >>> x = startai.Container(a=startai.array([-1, 0, 1]),
        ...                   b=startai.array([2, 3, 4]))
        >>> y = startai.Container.static_flip(x, axis=0)
        >>> print(y)
        {
            a: startai.array([1, 0, -1]),
            b: startai.array([4, 3, 2])
    ...
    def flip(
        ...
        *,
        ...
        """startai.Container instance method variant of startai.flip. This method
        simply wraps the function, and so the docstring for startai.flip also
        applies to this method with minimal changes.
    ...
    def _static_reshape(
        ...
        *,
        ...
        allowzero: Union[bool, startai.Container] = True,
    ) -> startai.Container:
        """startai.Container static method variant of startai.reshape. This method
        simply wraps the function, and so the docstring for startai.reshape also
        applies to this method with minimal changes.
        ...
        >>> y = startai.Container.static_reshape(x, (3,2))
        >>> print(y)
        {
            a: startai.array([[0, 1],
                          [2, 3],
        ...
        >>> x = startai.Container(a=startai.array([0, 1, 2, 3, 4, 5]),
        ...                   b=startai.array([0, 1, 2, 3, 4, 5]))
        >>> y = startai.Container.static_reshape(x, (3,2), order='F')
        >>> print(y)
        {
            a: startai.array([[0, 3],
                          [1, 4],
    ...
    def reshape(
        ...
        *,
        ...
        """startai.Container instance method variant of startai.reshape. This method
        simply wraps the function, and so the docstring for startai.reshape also
        applies to this method with minimal changes.
    ...
    def _static_roll(
        x: Union[startai.Array, startai.NativeArray, startai.Container],
        /,
        shift: Union[int, Tuple[int, ...], startai.Container],
        *,
        ...
        """startai.Container static method variant of startai.roll. This method simply
        ...
        >>> x = startai.Container(a=startai.array([0., 1., 2.]),
        ...                   b=startai.array([3., 4., 5.]))
        >>> y = startai.Container.static_roll(x, 1)
        >>> print(y)
        {
        ...
        >>> y = startai.Container.static_roll(x, shift)
        >>> print(y)
        {
            a: startai.array([2., 0., 1.]),
    ...
    def roll(
        self: startai.Container,
        /,
        shift: Union[int, Sequence[int], startai.Container],
        *,
        axis: Optional[Union[int, Sequence[int], startai.Container]] = None,
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        ...
        """startai.Container instance method variant of startai.roll. This method
        simply wraps the function, and so the docstring for startai.roll also
        applies to this method with minimal changes.
    ...
    def _static_squeeze(
        x: startai.Container,
        /,
        axis: Union[int, Sequence[int], startai.Container],
        *,
        copy: Optional[Union[bool, startai.Container]] = None,
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        ...
        """startai.Container static method variant of startai.squeeze. This method
        simply wraps the function, and so the docstring for startai.squeeze also
        applies to this method with minimal changes.
        ...
        Examples
        --------
        >>> x = startai.Container(a=startai.array([[[10.], [11.]]]),
        ...                   b=startai.array([[[11.], [12.]]]))
        >>> y = startai.Container.static_squeeze(x, 0)
        >>> print(y)
        {
            a: startai.array([[10., 11.]]),
            b: startai.array([[11., 12.]])
        }

        >>> x = startai.Container(a=startai.array([[[10.], [11.]]]),
        ...                   b=startai.array([[[11.], [12.]]]))
        >>> y = startai.Container.static_squeeze(x, [0, 2])
        >>> print(y)
        {
            a: startai.array([[10.], [11.]]),
            b: startai.array([[11.], [12.]])
    ...
    def squeeze(
        ...
        /,
        *,
        axis: Optional[Union[int, Sequence[int], startai.Container]],
        copy: Optional[Union[bool, startai.Container]] = None,
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        prune_unapplied: Union[bool, startai.Container] = False,
        ...
        """startai.Container instance method variant of startai.squeeze. This method
        simply wraps the function, and so the docstring for startai.squeeze also
        applies to this method with minimal changes.
    ...
    def _static_stack(
        ...
        *,
        ...
        axis
            ...
            in the docstring for startai.stack.
        ...
        >>> z = startai.Container.static_stack(x,axis = 1)
        >>> print(z)
        {
            a: startai.array([[0, 2],
                        [1, 3]]),
        ...
        >>> z = startai.Container.static_stack([x,y])
        >>> print(z)
        {
            a: startai.array([[[0, 1],
                        [2, 3]],
        ...
        >>> x = startai.Container(a=startai.array([[0, 1], [2,3]]), b=startai.array([[4, 5]]))
        >>> y = startai.Container(a=startai.array([[3, 2], [1,0]]), b=startai.array([[1, 0]]))
        >>> z = startai.Container.static_stack([x,y],axis=1)
        >>> print(z)
        {
            a: startai.array([[[0, 1],
                        [3, 2]],
    ...
    def _static_repeat(
        x: Union[startai.Array, startai.NativeArray, startai.Container],
        /,
        repeats: Union[int, Iterable[int], startai.Container],
        *,
        axis: Optional[Union[int, Sequence[int], startai.Container]] = None,
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        ...
        """startai.Container static method variant of startai.repeat. This method
        simply wraps the function, and so the docstring for startai.repeat also
        applies to this method with minimal changes.

        Examples
        --------
        >>> x = startai.Container(a=startai.array([0., 1., 2.]), b=startai.array([3., 4., 5.]))
        >>> y = startai.Container.static_repeat(2)
        >>> print(y)
        {
            a: startai.array([0., 0., 1., 1., 2., 2.]),
            b: startai.array([3., 3., 4., 4., 5., 5.])
        }
        """
        return ContainerBase.cont_multi_map_in_function(
            "repeat",
    ...
    def repeat(
        ...
        *,
        ...
        """startai.Container instance method variant of startai.repeat. This method
        simply wraps the function, and so the docstring for startai.repeat also
        applies to this method with minimal changes.
    ...
    def _static_tile(
        x: startai.Container,
        /,
        repeats: Union[Iterable[int], startai.Container],
        *,
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        prune_unapplied: Union[bool, startai.Container] = False,
        ...
        """startai.Container static method variant of startai.tile. This method simply
        ...
        --------
        >>> x = startai.Container(a=startai.array([[0, 1], [2,3]]), b=startai.array([[4, 5]]))
        >>> y = startai.Container.static_tile((2,3))
        >>> print(y)
        {
            a: startai.array([[0,1,0,1,0,1],
                          [2,3,2,3,2,3],
                          [0,1,0,1,0,1],
                          [2,3,2,3,2,3]]),
            b: startai.array([[4,5,4,5,4,5],
                          [4,5,4,5,4,5]])
        }
        """
        return ContainerBase.cont_multi_map_in_function(
    ...
    def tile(
        ...
        *,
        ...
        """startai.Container instance method variant of startai.tile. This method
        simply wraps the function, and so the docstring for startai.tile also
        applies to this method with minimal changes.
        ...
        >>> print(y)
        {
            a: (<class startai.data_classes.array.array.Array> shape=[4, 6]),
            b: (<class startai.data_classes.array.array.Array> shape=[2, 6])
        }
        """
    ...
    def _static_constant_pad(
        x: startai.Container,
        /,
        pad_width: Union[Iterable[Tuple[int]], startai.Container],
        *,
        value: Union[Number, startai.Container] = 0,
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        to_apply: Union[bool, startai.Container] = True,
        prune_unapplied: Union[bool, startai.Container] = False,
        map_sequences: Union[bool, startai.Container] = False,
        ...
        """startai.Container static method variant of startai.constant_pad. This method
        ...
        >>> y = startai.Container.static_constant_pad(x, pad_width = [[2, 3]])
        >>> print(y)
        {
            a: startai.array([0, 0, 1, 2, 3, 0, 0, 0]),
            b: startai.array([0, 0, 4, 5, 6, 0, 0, 0])
        }
        """
        return ContainerBase.cont_multi_map_in_function(
            "constant_pad",
    ...
    def constant_pad(
        ...
        *,
        ...
        """startai.Container instance method variant of startai.constant_pad. This
        method simply wraps the function, and so the docstring for
        startai.constant_pad also applies to this method with minimal changes.
    ...
    def _static_zero_pad(
        ...
        *,
        ...
        """startai.Container static method variant of startai.zero_pad. This method
    ...
    def zero_pad(
        ...
        *,
        ...
        """startai.Container instance method variant of startai.zero_pad. This method
        simply wraps the function, and so the docstring for startai.zero_pad also
        applies to this method with minimal changes.
    ...
    def _static_swapaxes(
        x: startai.Container,
        axis0: Union[int, startai.Container],
        axis1: Union[int, startai.Container],
        /,
        *,
        copy: Optional[Union[bool, startai.Container]] = None,
        key_chains: Optional[Union[List[str], Dict[str, str], startai.Container]] = None,
        ...
        """startai.Container static method variant of startai.swapaxes. This method
        simply wraps the function, and so the docstring for startai.swapaxes also
        applies to this method with minimal changes.
    ...
    def swapaxes(
        ...
        *,
        ...
        """startai.Container instance method variant of startai.swapaxes. This method
        simply wraps the function, and so the docstring for startai.swapaxes also
        applies to this method with minimal changes.
    ...
    def _static_unstack(
        ...
        *,
        ...
        """startai.Container static method variant of startai.unstack. This method
        ...
        >>> y = startai.Container.static_unstack(x, axis=0)
        >>> print(y)
        [{
            a: startai.array([[1, 2],
                         [3, 4]]),
        ...
        >>> x = startai.Container(a=startai.array([[[1, 2], [3, 4]], [[5, 6], [7, 8]]]),
                            b=startai.array([[[9, 10], [11, 12]], [[13, 14], [15, 16]]]))
        >>> y = startai.Container.static_unstack(x, axis=1, keepdims=True)
        >>> print(y)
        [{
            a: startai.array([[[1, 2]],
                         [[5, 6]]]),
    ...
    def unstack(
        ...
        *,
        ...
        """startai.Container instance method variant of startai.unstack. This method
        simply wraps the function, and so the docstring for startai.unstack also
        applies to this method with minimal changes.
    ...
    def _static_clip(
        ...
        *,
        ...
        """startai.Container static method variant of startai.clip. This method simply
        ...
        >>> x = startai.Container(a=startai.array([0., 1., 2.]),
        ...                   b=startai.array([3., 4., 5.]))
        >>> y = startai.Container.static_clip(x, 1., 5.)
        >>> print(y)
        {
        ...
        >>> x = startai.Container(a=startai.array([0., 1., 2.]),
        ...                   b=startai.array([3., 4., 5.]))
        >>> x_min = startai.Container(a=0, b=0)
        >>> x_max = startai.Container(a=1, b=1)
        >>> y = startai.Container.static_clip(x, x_min, x_max)
        >>> print(y)
        {
    ...
    def clip(
        ...
        *,
        ...
        """startai.Container instance method variant of startai.clip. This method
        simply wraps the function, and so the docstring for startai.clip also
        applies to this method with minimal changes.
