...
def divide(
    ...
    *,
    ...
    if startai.is_float_dtype(x1.dtype) or startai.is_complex_dtype(x1.dtype):
        ...
        ret = np.asarray(ret, dtype=startai.default_float_dtype(as_native=True))
    return ret
...
def logaddexp2(
    ...
    *,
    ...
    if not startai.is_float_dtype(x1):
        x1 = x1.astype(startai.default_float_dtype(as_native=True))
        x2 = x2.astype(startai.default_float_dtype(as_native=True))
