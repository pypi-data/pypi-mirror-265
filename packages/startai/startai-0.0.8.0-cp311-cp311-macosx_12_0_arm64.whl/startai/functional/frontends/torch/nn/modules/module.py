...
# local
from startai.functional.frontends.torch.nn.parameter import Parameter
from startai.functional.frontends.torch.tensor import Tensor


class Module(startai.Module):
    _version: int = 1
    training: bool
                    ...
                    (
                        {
                            ...
                            and not isinstance(_v, startai.Container)
                        }
                    ),
                    **v,
                )
    ...
    def _replace_update_v(self, new_v, native=None):
        ...
        native = startai.default(native, self)
