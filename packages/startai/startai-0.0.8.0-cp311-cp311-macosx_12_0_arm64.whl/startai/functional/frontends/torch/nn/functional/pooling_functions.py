...
def adaptive_avg_pool1d(input, output_size):
    return startai.adaptive_avg_pool1d(input, output_size)
...
def adaptive_max_pool2d(
    ...
    return startai.adaptive_max_pool2d(input, output_size)
...
def adaptive_max_pool3d(
    ...
    return startai.adaptive_max_pool3d(input, output_size)
...
def lp_pool1d(input, norm_type, kernel_size, stride=None, ceil_mode=False):
    ...
    out = startai.avg_pool1d(
        startai.pow(input, norm_type),
        kernel_size,
        stride,
        padding,
    ...
    return startai.pow(startai.multiply(out, kernel_mul), p)
...
def lp_pool2d(input, norm_type, kernel_size, stride=None, ceil_mode=False):
    ...
    if not isinstance(kernel_size, int):
        ...
        kernel_mul = kernel_size
    p = startai.divide(1.0, norm_type) if norm_type != 0 else 1.0
    return startai.pow(startai.multiply(out, kernel_mul), p).astype(input.dtype)
