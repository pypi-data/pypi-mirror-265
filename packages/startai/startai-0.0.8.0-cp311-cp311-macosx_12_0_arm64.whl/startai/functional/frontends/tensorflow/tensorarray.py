...
class TensorArray:
    def __init__(
        ...
        self._element_shape = (
            startai.Shape(element_shape) if element_shape is not None else element_shape
        )
    ...
    def read(self, index, name=None):
        if isinstance(index, EagerTensor):
            index = startai.to_scalar(index.startai_array)
