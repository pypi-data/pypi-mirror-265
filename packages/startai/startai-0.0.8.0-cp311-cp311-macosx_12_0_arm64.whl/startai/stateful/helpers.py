...
from startai.func_wrapper import _get_first_array
...
class ModuleHelpers:
    def _find_variables(
        ...
        *,
        ...
        """
        _visited = startai.default(_visited, {})
        vs = Container()
    ...
    def _call(self, *args, v=None, buffers=None, **kwargs):
        ...
        if not self._built:
            ...
            self.build(
                ...
                **kwargs,
                from_call=True,
                dtype=first_arr.dtype if startai.exists(first_arr) else startai.default_dtype(),
            )
    ...
    def _compute_module_dict(self):
        ...
        for key, value in self.__dict__.items():
            if isinstance(value, startai.Module):
