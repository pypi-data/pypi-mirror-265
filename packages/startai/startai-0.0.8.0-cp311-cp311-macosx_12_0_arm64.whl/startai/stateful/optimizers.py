# For Review
"""Collection of Startai optimizers."""
...
class Optimizer(abc.ABC):
    def __init__(
        ...
        self._dev = startai.default(device, startai.default_device())
        self._count = startai.array([0], device=self._dev)
    ...
    @abc.abstractmethod
    def _step(self, v: startai.Container, grads: startai.Container):
    ...
    def _step_fn(
        self, v: startai.Container, grads: startai.Container, ignore_missing: bool = False
    ):
    ...
    @abc.abstractmethod
    def set_state(self, state: startai.Container):
...
class Adam(Optimizer):
    ...
    def _step(self, v: startai.Container, grads: startai.Container):
        ...
        new_v, self._mw, self._vw = startai.adam_update(
            v,
            grads,
            self._lr if isinstance(self._lr, float) else self._lr(),
            self._mw,
    ...
    @property
    def state(self):
        return startai.Container({"mw": self._mw, "vw": self._vw})
...
class LAMB(Optimizer):
    ...
    def _step(self, v: startai.Container, grads: startai.Container):
        ...
        new_v, self._mw, self._vw = startai.lamb_update(
            v,
            grads,
            self._lr if isinstance(self._lr, float) else self._lr(),
            self._mw,
