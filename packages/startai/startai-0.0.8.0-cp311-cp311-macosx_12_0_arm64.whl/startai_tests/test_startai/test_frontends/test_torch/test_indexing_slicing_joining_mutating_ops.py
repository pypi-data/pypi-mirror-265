...
from startai_tests.test_startai.test_functional.test_core.test_manipulation import _get_splits
...
@handle_frontend_test(
    ...
    xs_dtypes_dim_idx=_arrays_dim_idx_n_dtypes_extend(
        ...
        unsupport_dtypes=startai.function_unsupported_dtypes(
            startai.functional.frontends.torch.index_reduce
        ),
    ),
