...
from startai import set_exception_trace_mode
from startai_tests.test_startai.helpers import globals as test_globals
from startai_tests.test_startai.helpers.available_frameworks import available_frameworks  # noqa
from startai_tests.test_startai.helpers.multiprocessing import backend_proc, frontend_proc
...
if "ARRAY_API_TESTS_MODULE" not in os.environ:
    os.environ["ARRAY_API_TESTS_MODULE"] = "startai.functional.backends.numpy"
...
def pytest_configure(config):
    ...
    # Startai Exception traceback
    set_exception_trace_mode(config.getoption("--startai-tb"))
...
def pytest_addoption(parser):
    ...
    parser.addoption(
        ...
        action="store_true",
        default=False,
        help="Force the testing pipeline to use startai.set_backend for backend setting",
    )
