...
# local
import startai
from startai.functional.startai.layers import _get_embed_dim, _pack_padded_sequence
from startai_tests.test_startai import helpers
from startai_tests.test_startai.helpers import handle_frontend_test
from startai_tests.test_startai.test_functional.test_nn.test_layers import _mha_helper
...
def test_torch_multi_head_attention_forward(
    *,
    ...
    # of startai.multi_head_attention's arguments given by _mha_helper
    kwargs = {
        "query": q,
        "key": k,
        "value": v,
    ...
    helpers.test_frontend_function(
        input_dtypes=[str(r.dtype) for r in kwargs.values() if startai.is_array(r)],
        backend_to_test=backend_fw,
        frontend=frontend,
        test_flags=test_flags,
        fn_tree=fn_tree,
