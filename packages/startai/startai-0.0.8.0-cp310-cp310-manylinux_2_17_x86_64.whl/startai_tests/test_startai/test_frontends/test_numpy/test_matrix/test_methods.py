...
from startai_tests.test_startai.helpers import handle_frontend_method, handle_frontend_test
import startai.functional.frontends.numpy as startai_np


CLASS_TREE = "startai.functional.frontends.numpy.matrix"
...
def test_numpy_ndim(matrices):
    data, data_gt = matrices
    startai.utils.assertions.check_equal(data.ndim, data_gt.ndim, as_array=False)
...
def test_numpy_shape(matrices):
    data, data_gt = matrices
    startai.utils.assertions.check_equal(data.shape, data_gt.shape, as_array=False)
...
def test_numpy_size(matrices):
    data, data_gt = matrices
    startai.utils.assertions.check_equal(data.size, data_gt.size, as_array=False)
