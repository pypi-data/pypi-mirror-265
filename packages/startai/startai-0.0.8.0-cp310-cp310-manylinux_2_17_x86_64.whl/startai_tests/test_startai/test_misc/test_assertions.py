...
import contextlib
import pytest
from startai.utils.assertions import (
    check_all,
    check_all_or_any_fn,
    check_any,
...
from startai.utils.assertions import _check_jax_x64_flag
import startai
...
@pytest.mark.parametrize(
    ...
    [
        # INVALID CASES
        ((1, 2, 0), startai.array, "all", [3]),
        ((0, 0), startai.array, "all", [2]),
        ((1, 1), startai.array, "any", [3]),
        ((0, 0, 1), startai.array, "any", [3]),
        ((1, 0, 1), startai.array, "all_any", [3]),
        # VALID
        ((1, 1), startai.array, "any", [2]),
        ((0, 1), startai.array, "any", [1]),
        ((1, 1, 2), startai.array, "all", [3]),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        # INVALID CASES
        (startai.array([1, 2, 3]), startai.array([1]), 2, 3),
        (startai.array([[1, 2, 3], [4, 5, 6]]), startai.array([[0], [2]]), 1, 2),
        (startai.array([[1, 2, 3], [4, 5, 6]]), startai.array([[0, 1], [1, 2], [2, 3]]), 1, 0),
        (startai.array([1, 2, 3]), startai.array([[1, 2]]), 1, 0),
        # VALID
        (startai.array([1, 2, 3]), startai.array([1]), 0, 1),
        (startai.array([[1, 2, 3], [4, 5, 6]]), startai.array([0, 2]), -1, 0),
        (startai.array([[1, 2, 3], [4, 5, 6]]), startai.array([[0, 1], [1, 2]]), -1, 0),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        # INVALID CASES
        (startai.array([1, 2, 3]), startai.array([1]), 2),
        (startai.array([[1, 2, 3], [4, 5, 6]]), startai.array([0, 2]), 1),
        (startai.array([[1, 2, 3], [4, 5, 6]]), startai.array([[0, 1], [1, 2], [2, 3]]), 1),
        (startai.array([1, 2, 3]), startai.array([[1, 2]]), 0),
        # VALID
        (startai.array([1, 2, 3]), startai.array([1]), 0),
        (startai.array([[1, 2, 3], [4, 5, 6]]), startai.array([0, 2]), 0),
        (startai.array([[1, 2, 3], [4, 5, 6]]), startai.array([[0, 1], [1, 2]]), 1),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        # INVALID CASES
        (startai.array([1]), startai.array([1, 2])),
        (startai.array([[1], [1], [2]]), startai.array([1, 2])),
        # VALID
        (startai.array([1, 2]), startai.array([1])),
        (startai.array([[[1]]]), startai.array([1, 2])),
    ],
)
...
@pytest.mark.parametrize(
    ("x", "allowed_types"),
    [(5.0, float), (startai.array(5), type(startai.array(8))), (5, float), ([5, 10], tuple)],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (startai.array([1.0, 2.0, 3.0]), startai.array([4, 5, 6])),
        (startai.array([1, 2, 3]), startai.array([4j, 5 + 1j, 6])),
        (startai.array([1j]), startai.array([2, 3 + 4j])),
    ],
)
...
@pytest.mark.parametrize(
    ("x1", "x2"),
    [
        (startai.array([1, 2, 3]), startai.array([[4, 5, 6], [2, 3, 1]])),
        (startai.array([[1.0, 2.0], [3.0, 4.0]]), startai.array([4, 5, 6])),
        (startai.array([1, 2]), startai.array([3, 4, 5])),
        (startai.array([1]), startai.array([2])),
        (startai.array([1, 2]), startai.array([2, 3])),
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        # INVALID CASES
        (startai.array([1, 2, 3]), startai.array([0, 1, 0], dtype=startai.int32), 2.0),
        (startai.array([1, 2, 3]), startai.array([0, 1, 0], dtype=startai.int32), 0),
        (startai.array([1, 2, 3]), startai.array([0, 1, 0], dtype=startai.int32), -2),
        (startai.array([1, 2, 3]), startai.array([0.0, 1.0, 0.0], dtype=startai.float16), 0),
        (startai.array([1, 2]), startai.array([0, 1, 0], dtype=startai.int32), 0),
        (startai.array([1, 2, 3]), startai.array([0, 1], dtype=startai.int32), 0),
        (startai.array([1, 2, 3]), startai.array([0, 1, 2], dtype=startai.int32), 2),
        # VALID
        (
            startai.array([1, 2, 3]),
            startai.array([0, 1, 0], dtype=startai.int32),
            2,
        ),
        (startai.array([1, 2, 3]), startai.array([0, 1, 0], dtype=startai.int32), startai.array([2])),
    ],
)
