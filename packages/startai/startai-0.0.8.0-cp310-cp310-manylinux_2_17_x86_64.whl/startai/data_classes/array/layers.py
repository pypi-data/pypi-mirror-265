...
class _ArrayWithLayers(abc.ABC):
    def linear(
        ...
        *,
        ...
        """startai.Array instance method variant of startai.linear. This method simply
        wraps the function, and so the docstring for startai.linear also applies to
        ...
        >>> y = x.linear(w, bias=b)
        >>> print(y)
        startai.array([[ 16.4,  35.2,  54. ],
                   [ 36.2,  84.7, 133. ],
                   [ 56. , 134. , 212. ]])
        """
        return startai.linear(
            self._data,
            weight,
            bias=bias,
            out=out,
    ...
    def dropout(
        ...
        *,
        ...
        """startai.Array instance method variant of startai.dropout. This method simply
        wraps the function, and so the docstring for startai.dropout also applies
    ...
    def dropout1d(
        ...
        *,
        ...
        """startai.Array instance method variant of startai.dropout1d. This method
    ...
    def dropout2d(
        ...
        *,
        ...
        """startai.Array instance method variant of startai.dropout2d. This method
        simply wraps the function, and so the docstring for startai.dropout1d also
        applies to this method with minimal changes.
        ...
        Examples
        --------
        >>> x = startai.array([[1, 1, 1], [2, 2, 2]])
        >>> y = x.dropout2d(0.5)
        >>> print(y)
        startai.array([[0., 0., 2.],
               [4., 4., 4.]])
        """
        return startai.dropout2d(
            self._data,
            prob,
            training=training,
            data_format=data_format,
    ...
    def dropout3d(
        ...
        *,
        ...
        """startai.Array instance method variant of startai.dropout3d. This method
    ...
    def scaled_dot_product_attention(
        ...
        *,
        ...
        """startai.Array instance method variant of
        ...
        >>> startai.scaled_dot_product_attention(q, k, v, scale=1, dropout_p=0.1,
    ...
    def multi_head_attention(
        ...
        *,
        ...
        return startai.multi_head_attention(
            self._data,
            key=key,
            value=value,
            num_heads=num_heads,
    ...
    def conv1d(
        ...
        *,
        ...
        """startai.Array instance method variant of startai.conv1d. This method simply
        wraps the function, and so the docstring for startai.conv1d also applies to
        this method with minimal changes.
        ...
        Examples
        --------
        >>> x = startai.array([[[1., 2.], [3., 4.], [6., 7.], [9., 11.]]])  # NWC
        >>> filters = startai.array([[[0., 1.], [1., 1.]]])  # WIO (I == C)
    ...
    def conv1d_transpose(
        ...
        *,
        ...
        """startai.Array instance method variant of startai.conv1d_transpose. This
    ...
    def depthwise_conv2d(
        ...
        *,
        ...
        """startai.Array instance method variant of startai.depthwise_conv2d. This
        method simply wraps the function, and so the docstring for
        ...
        Examples
        --------
        >>> x = startai.randint(0, 255, shape=(1, 128, 128, 3)).astype(startai.float32) / 255.0
        >>> filters = startai.random_normal(mean=0, std=1, shape=[3, 3, 3])
        >>> y = x.depthwise_conv2d(filters, 2, 'SAME')
        >>> print(y.shape)
        (1, 64, 64, 3)
        """
        return startai.depthwise_conv2d(
            self._data,
            filters,
            strides,
            padding,
    ...
    def conv2d(
        ...
        *,
        ...
        """startai.Array instance method variant of `startai.conv2d`. This method
    ...
    def conv2d_transpose(
        ...
        *,
        ...
        """startai.Array instance method variant of `startai.conv2d_transpose`. This
        method simply wraps the function, and so the docstring for
        `startai.conv2d_transpose` also applies to this method with minimal
        changes.
    ...
    def conv3d(
        ...
        *,
        ...
        """startai.Array instance method variant of `startai.conv3d`. This method
        ...
        Examples
        --------
        >>> x = startai.ones((1, 3, 3, 3, 1)).astype(startai.float32)

        >>> filters = startai.ones((1, 3, 3, 1, 1)).astype(startai.float32)

        >>> result = x.conv3d(filters, 2, 'SAME')
        >>> print(result)
        startai.array([[[[[4.],[4.]],[[4.],[4.]]],[[[4.],[4.]],[[4.],[4.]]]]])
        """
    ...
    def conv3d_transpose(
        ...
        *,
        ...
        """startai.Array instance method variant of `startai.conv3d_transpose`. This
        method simply wraps the function, and so the docstring for
        `startai.conv3d_transpose` also applies to this method with minimal
        changes.
    ...
    def lstm_update(
        ...
        *,
        ...
        """startai.Array instance method variant of startai.lstm_update. This method
        simply wraps the function, and so the docstring for startai.lstm_update
        also applies to this method with minimal changes.
        ...
        Examples
        --------
        >>> x = startai.randint(0, 20, shape=(6, 20, 3))
        >>> h_i = startai.random_normal(shape=(6, 5))
        >>> c_i = startai.random_normal(shape=(6, 5))
        >>> kernel = startai.random_normal(shape=(3, 4 * 5))
        >>> rc = startai.random_normal(shape=(5, 4 * 5))
