...
class _ArrayWithUtility(abc.ABC):
    def all(
        ...
        *,
        ...
        """startai.Array instance method variant of startai.all. This method simply
        ...
        >>> x = startai.array([[[0, 1], [0, 0]], [[1, 2], [3, 4]]])
        >>> y = x.all(axis=1)
        >>> print(y)
        startai.array([[False, False],
               [ True,  True]])
        """
        return startai.all(self._data, axis=axis, keepdims=keepdims, out=out)
    ...
    def any(
        ...
        *,
        ...
        """startai.Array instance method variant of startai.any. This method simply
        ...
        startai.array([[ True, False],
               [ True,  True]])
        """
        return startai.any(self._data, axis=axis, keepdims=keepdims, out=out)
