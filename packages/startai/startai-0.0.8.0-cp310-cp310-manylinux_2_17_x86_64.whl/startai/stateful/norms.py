"""Collection of Startai normalization classes."""

# local
import startai
from startai.stateful.module import Module
from startai.stateful.initializers import Zeros, Ones
    ...
    def __init__(
        ...
        *,
        ...
        epsilon
            ...
            use global startai.min_base by default.
        elementwise_affine
...
class BatchNorm2D(Module):
    ...
    def _forward(self, inputs):
        ...
        """
        normalized, running_mean, running_var = startai.batch_norm(
            inputs,
            self.v.running_mean,
            self.v.running_var,
            eps=self._epsilon,
