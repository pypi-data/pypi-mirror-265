"""Converters from Native Modules to Startai Modules."""
...
def to_startai_module(
    ...
    trainable startai.Module instance.
    ...
    -------
    ret
        The new trainable startai.Module instance.
    """
    return current_backend().to_startai_module(
        native_module,
        native_module_class,
        args,
        kwargs,
...
class ModuleConverters:
    ...
    def from_haiku_module(
        ...
        """Convert a Haiku module instance to an Startai module instance.
        ...
        c_args = startai.default(constructor_args, [])
        c_kwargs = startai.default(constructor_kwargs, {})
        i_args = startai.default(instance_args, [])
        i_kwargs = startai.default(instance_kwargs, {})
        i_args, i_kwargs = startai.args_to_native(*i_args, **i_kwargs)
        ...
        from startai.stateful.module import _HaikuStartaiModule

        return _HaikuStartaiModule(
            *i_args,
            params_hk=params_hk,
    ...
    def from_flax_module(
        ...
        """Convert a Flax module instance to an Startai module instance.
        ...
        from startai.stateful.module import _FlaxStartaiModule

        return _FlaxStartaiModule(
            *i_args,
            params_fx=params_fx,
    ...
    def from_keras_module(
        ...
        """Convert a Keras module instance to an Startai module instance.
        ...
        from startai.stateful.module import _KerasStartaiModule

        return _KerasStartaiModule(
            *i_args,
            native_module=native_module,
            device=device,
            devices=devices,
    ...
    def from_paddle_module(
        ...
        """Convert a Paddle layer instance to an Startai module instance.
        ...
        if inspect.isclass(native_module):
            native_module = native_module(*c_args, **c_kwargs)
        from startai.stateful.module import _PaddleStartaiModule

        return _PaddleStartaiModule(
            *i_args,
            native_module=native_module,
            device=device,
            devices=devices,
    ...
    def from_torch_module(
        ...
        """Convert a Torch module instance to an Startai module instance.
        ...
        from startai.stateful.module import _TorchStartaiModule

        return _TorchStartaiModule(
            *i_args,
            native_module=native_module,
            device=device,
            devices=devices,
    ...
    def to_keras_module(self):
        """Convert a `startai.Module` module instance to a `tf.keras.Model`
        instance.
        ...
        class KerasModel(tf.keras.Model):
            def __init__(self, startai_module):
                super().__init__()
                self._startai_module = startai_module
                self._parameters = {}
            ...
            def _assign_variables(self):
                ...
                self._startai_module.v = self._startai_module.v.cont_map(
                    lambda x, kc: (
                        startai.to_new_backend(x.startai_array.data, native=True)
                        if hasattr(x, "_startai_array")
                        else startai.to_new_backend(x, native=True)
                    ),
                )
                self._startai_module.v.cont_map(
                    lambda x, kc: (
                        self.add_weight(
                ...
                self._startai_module.v.cont_map(
                    lambda x, kc: (
                        model_weights.append(startai.to_numpy(x)) if x is not None else x
                    )
                )
            ...
            def _propagate_params(self):
                def __update_param(startai_module, x, kc):
                    if kc not in self._parameters:
                        return x
                    # Update param in the underneath startai module
                    module = startai_module
                    keys = re.split("[/.]", kc)
                    for key in keys[:-1]:
                ...
                self._startai_module.v = self._startai_module.v.cont_map(
                    functools.partial(__update_param, self._startai_module),
                    inplace=True,
                )

            def call(self, *args, training=None, **kwargs):
                ret = self._startai_module(*args, **kwargs)
                ret = startai.nested_map(
                    lambda x: (
                        x.startai_array.data
                        if hasattr(x, "_startai_array")
                        else startai.to_native(x)
                    ),
                    ret,
                )
                return ret
            ...
            def __call__(self, *args, **kwargs):
                if startai.backend != "tensorflow":
                    startai.set_backend("tensorflow")
                    args, kwargs = startai.args_to_new_backend(*args, native=True, **kwargs)
                    startai.previous_backend()
                else:
                    args, kwargs = startai.args_to_new_backend(*args, native=True, **kwargs)
            ...
            def to_device(self, device):
                self._startai_module._module_graph.to_device(device)
                model_weights = startai.nested_map(
                    lambda x: (
                        startai.to_native(startai.to_device(x, device))
