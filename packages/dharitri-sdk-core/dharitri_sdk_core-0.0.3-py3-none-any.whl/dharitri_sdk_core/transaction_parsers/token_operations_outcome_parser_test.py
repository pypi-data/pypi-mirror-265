        ...
        TransactionLogsWrapper([
            TransactionEventWrapper(
                ...
                topics=[
                    ...
                    TransactionEventTopicWrapper("".encode()),
                    TransactionEventTopicWrapper("DCTRoleLocalMint".encode()),
                    TransactionEventTopicWrapper("DCTRoleLocalBurn".encode())
                ],
                data=""
            )
        ])
