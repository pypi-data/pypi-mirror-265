...
def test_create_transaction_for_registering_meta_dct():
    transaction = factory.create_transaction_for_registering_meta_dct(
        sender=frank,
        token_name="FRANK",
        token_ticker="FRANK",
        num_decimals=10,
    ...
    assert transaction.data
    assert transaction.data.decode() == "registerMetaDCT@4652414e4b@4652414e4b@0a@63616e467265657a65@74727565@63616e57697065@74727565@63616e5061757365@74727565@63616e5472616e736665724e4654437265617465526f6c65@74727565@63616e4368616e67654f776e6572@74727565@63616e55706772616465@66616c7365@63616e4164645370656369616c526f6c6573@66616c7365"
    assert transaction.sender == frank.to_bech32()
    assert transaction.receiver == "moa1qqqqqqqqqqqqqqqpqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqzllls29jpxv"
    assert transaction.value == 50000000000000000
...
def test_create_transaction_for_setting_special_role_on_non_fungible_token():
    transaction = factory.create_transaction_for_setting_special_role_on_non_fungible_token(
        ...
        add_role_dct_transfer_role=False
    )

    assert transaction.data
    assert transaction.data.decode() == "setSpecialRole@4652414e4b2d313163653365@1e8a8b6b49de5b7be10aaa158a5a6a4abb4b56cc08f524bb5e6cd5f211ad3e13@444354526f6c654e4654437265617465@444354526f6c654e465455706461746541747472696275746573@444354526f6c654e4654416464555249"
    assert transaction.sender == frank.to_bech32()
    assert transaction.receiver == "moa1qqqqqqqqqqqqqqqpqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqzllls29jpxv"
...
def test_create_transaction_for_creating_nft():
    ...
    assert transaction.data
    assert transaction.data.decode() == "DCTNFTCreate@4652414e4b2d616139653864@01@74657374@03e8@61626261@74657374@61@62"
...
def test_create_transaction_for_setting_special_role_on_fungible_token():
    ...
    assert transaction.data
    assert transaction.data.decode() == "setSpecialRole@4652414e4b2d313163653365@1e8a8b6b49de5b7be10aaa158a5a6a4abb4b56cc08f524bb5e6cd5f211ad3e13@444354526f6c654c6f63616c4d696e74"
    assert transaction.sender == frank.to_bech32()
    assert transaction.value == 0
...
def test_create_transaction_for_setting_special_role_on_semi_fungible_token():
    transaction = factory.create_transaction_for_setting_special_role_on_semi_fungible_token(
        ...
        add_role_dct_transfer_role=True,
    )

    assert transaction.data
    assert transaction.data.decode() == "setSpecialRole@4652414e4b2d313163653365@1e8a8b6b49de5b7be10aaa158a5a6a4abb4b56cc08f524bb5e6cd5f211ad3e13@444354526f6c654e4654437265617465@444354526f6c654e46544275726e@444354526f6c654e46544164645175616e74697479@4443545472616e73666572526f6c65"
    assert transaction.sender == frank.to_bech32()
    assert transaction.value == 0
...
def test_create_transaction_for_local_minting():
    ...
    assert transaction.data
    assert transaction.data.decode() == "DCTLocalMint@4652414e4b2d313163653365@0a"
    assert transaction.sender == frank.to_bech32()
    assert transaction.value == 0
...
def test_create_transaction_for_local_burning():
    ...
    assert transaction.data
    assert transaction.data.decode() == "DCTLocalBurn@4652414e4b2d313163653365@0a"
    assert transaction.sender == frank.to_bech32()
    assert transaction.value == 0
...
def test_create_transaction_for_updating_attributes():
    ...
    assert transaction.data
    assert transaction.data.decode() == "DCTNFTUpdateAttributes@4652414e4b2d313163653365@0a@74657374"
    assert transaction.sender == frank.to_bech32()
    assert transaction.value == 0
...
def test_create_transaction_for_adding_quantity():
    ...
    assert transaction.data
    assert transaction.data.decode() == "DCTNFTAddQuantity@4652414e4b2d313163653365@0a@0a"
    assert transaction.sender == frank.to_bech32()
    assert transaction.value == 0
...
def test_create_transaction_for_burning_quantity():
    ...
    assert transaction.data
    assert transaction.data.decode() == "DCTNFTBurn@4652414e4b2d313163653365@0a@0a"
    assert transaction.sender == frank.to_bech32()
    assert transaction.value == 0
