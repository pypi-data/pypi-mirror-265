...
from dharitri_sdk_core.transaction_intent import TransactionIntent
from dharitri_sdk_core.transaction_intents_factories.transaction_intent_builder import \
...
class IConfig(Protocol):
    ...
    gas_limit_dct_local_mint: int
    gas_limit_dct_local_burn: int
    gas_limit_set_special_role: int
    gas_limit_pausing: int
    gas_limit_freezing: int
    gas_limit_wiping: int
    gas_limit_dct_nft_create: int
    gas_limit_dct_nft_update_attributes: int
    gas_limit_dct_nft_add_quantity: int
    gas_limit_dct_nft_burn: int
    gas_limit_store_per_byte: int
    issue_cost: int
    dct_contract_address: IAddress
...
class TokenManagementTransactionIntentsFactory:
    ...
    def create_transaction_intent_for_issuing_fungible(
        ...
        return TransactionIntentBuilder(
            config=self._config,
            sender=sender,
            receiver=self._config.dct_contract_address,
...
IMPORTANT!
==========
You are about to issue (register) a new token. This will set the role "DCTRoleBurnForAll" (globally).
Once the token is registered, you can unset this role by calling "unsetBurnRoleGlobally" (in a separate transaction).""")
    ...
    def create_transaction_intent_for_registering_meta_dct(
        self,
        sender: IAddress,
        token_name: str,
        token_ticker: str,
    ...
    def create_transaction_intent_for_setting_special_role_on_fungible_token(
        ...
        parts: List[str] = [
            ...
            arg_to_string(token_identifier),
            arg_to_string(user),
            *([arg_to_string("DCTRoleLocalMint")] if add_role_local_mint else []),
            *([arg_to_string("DCTRoleLocalBurn")] if add_role_local_burn else [])
        ]
    ...
    def create_transaction_intent_for_setting_special_role_on_semi_fungible_token(
        ...
        add_role_dct_transfer_role: bool
    ) -> TransactionIntent:
        parts: List[str] = [
            "setSpecialRole",
            arg_to_string(token_identifier),
            arg_to_string(user),
            *([arg_to_string("DCTRoleNFTCreate")] if add_role_nft_create else []),
            *([arg_to_string("DCTRoleNFTBurn")] if add_role_nft_burn else []),
            *([arg_to_string("DCTRoleNFTAddQuantity")] if add_role_nft_add_quantity else []),
            *([arg_to_string("DCTTransferRole")] if add_role_dct_transfer_role else [])
        ]
    ...
    def create_transaction_intent_for_setting_special_role_on_non_fungible_token(
        ...
        parts: List[str] = [
            ...
            *([arg_to_string("DCTRoleNFTCreate")] if add_role_nft_create else []),
            *([arg_to_string("DCTRoleNFTBurn")] if add_role_nft_burn else []),
            *([arg_to_string("DCTRoleNFTUpdateAttributes")] if add_role_nft_update_attributes else []),
            *([arg_to_string("DCTRoleNFTAddURI")] if add_role_nft_add_uri else []),
            *([arg_to_string("DCTTransferRole")] if add_role_dct_transfer_role else [])
        ]
    ...
    def create_transaction_intent_for_creating_nft(
        ...
        return TransactionIntentBuilder(
            ...
            receiver=sender,
            value=None,
            execution_gas_limit=self._config.gas_limit_dct_nft_create + storage_gas_limit,
            data_parts=parts
        ).build()
    ...
    def create_transaction_intent_for_local_minting(
        ...
        return TransactionIntentBuilder(
            ...
            receiver=sender,
            value=None,
            execution_gas_limit=self._config.gas_limit_dct_local_mint,
            data_parts=parts
        ).build()
    ...
    def create_transaction_intent_for_local_burning(
        ...
        return TransactionIntentBuilder(
            ...
            receiver=sender,
            value=None,
            execution_gas_limit=self._config.gas_limit_dct_local_burn,
            data_parts=parts
        ).build()
    ...
    def create_transaction_intent_for_updating_attributes(
        ...
        return TransactionIntentBuilder(
            ...
            receiver=sender,
            value=None,
            execution_gas_limit=self._config.gas_limit_dct_nft_update_attributes,
            data_parts=parts
        ).build()
    ...
    def create_transaction_intent_for_adding_quantity(
        ...
        return TransactionIntentBuilder(
            ...
            receiver=sender,
            value=None,
            execution_gas_limit=self._config.gas_limit_dct_nft_add_quantity,
            data_parts=parts
        ).build()
    ...
    def create_transaction_intent_for_burning_quantity(
        ...
        return TransactionIntentBuilder(
            ...
            receiver=sender,
            value=None,
            execution_gas_limit=self._config.gas_limit_dct_nft_burn,
            data_parts=parts
        ).build()
