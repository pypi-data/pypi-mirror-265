from dharitri_sdk_wallet import ValidatorSecretKey, ValidatorSigner

from dharitri_sdk_core.address import Address
from dharitri_sdk_core.constants import DELEGATION_MANAGER_SC_ADDRESS
from dharitri_sdk_core.messages import ArbitraryMessage
from dharitri_sdk_core.transaction_intents_factories.delegation_transaction_intents_factory import \
...
class TestDelegationTransactionIntentsFactory:
    ...
    def test_create_transaction_intent_for_new_delegation_contract(self):
        intent = self.factory.create_transaction_intent_for_new_delegation_contract(
            sender=Address.from_bech32("moa18s6a06ktr2v6fgxv4ffhauxvptssnaqlds45qgsrucemlwc8rawqevhvh6"),
            total_delegation_cap=5000000000000000000000,
            service_fee=10,
            value=1250000000000000000000
        )

        assert intent.sender == "moa18s6a06ktr2v6fgxv4ffhauxvptssnaqlds45qgsrucemlwc8rawqevhvh6"
    ...
    def test_create_transaction_intent_for_adding_nodes(self):
        sender = Address.from_bech32("moa18s6a06ktr2v6fgxv4ffhauxvptssnaqlds45qgsrucemlwc8rawqevhvh6")
        delegation_contract = Address.from_bech32("moa1qqqqqqqqqqqqqqqpqqqqqqqqqqqqqqqqqqqqqqqqqqqqqtlllllszhvd5g")
        ...
        assert intent.sender == "moa18s6a06ktr2v6fgxv4ffhauxvptssnaqlds45qgsrucemlwc8rawqevhvh6"
        assert intent.receiver == "moa1qqqqqqqqqqqqqqqpqqqqqqqqqqqqqqqqqqqqqqqqqqqqqtlllllszhvd5g"
        assert intent.data
