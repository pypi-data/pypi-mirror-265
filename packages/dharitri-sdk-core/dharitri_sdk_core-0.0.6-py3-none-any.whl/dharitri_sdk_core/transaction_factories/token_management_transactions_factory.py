...
Once the token is registered, you can unset this role by calling "unsetBurnRoleGlobally" (in a separate transaction).""")
    ...
    def create_transaction_for_registering_meta_dct(
        self,
        sender: IAddress,
        token_name: str,
        token_ticker: str,
    ...
    def create_transaction_for_creating_nft(
        ...
        return TransactionBuilder(
            ...
            receiver=sender,
            amount=None,
            gas_limit=self._config.gas_limit_dct_nft_create + storage_gas_limit,
            add_data_movement_gas=True,
            data_parts=parts
        ).build()
    ...
    def create_transaction_for_local_minting(
        ...
        return TransactionBuilder(
            ...
            receiver=sender,
            amount=None,
            gas_limit=self._config.gas_limit_dct_local_mint,
            add_data_movement_gas=True,
            data_parts=parts
        ).build()
    ...
    def create_transaction_for_local_burning(
        ...
        return TransactionBuilder(
            ...
            receiver=sender,
            amount=None,
            gas_limit=self._config.gas_limit_dct_local_burn,
            add_data_movement_gas=True,
            data_parts=parts
        ).build()
    ...
    def create_transaction_for_updating_attributes(
        ...
        return TransactionBuilder(
            ...
            receiver=sender,
            amount=None,
            gas_limit=self._config.gas_limit_dct_nft_update_attributes,
            add_data_movement_gas=True,
            data_parts=parts
        ).build()
    ...
    def create_transaction_for_adding_quantity(
        ...
        return TransactionBuilder(
            ...
            receiver=sender,
            amount=None,
            gas_limit=self._config.gas_limit_dct_nft_add_quantity,
            add_data_movement_gas=True,
            data_parts=parts
        ).build()
    ...
    def create_transaction_for_burning_quantity(
        ...
        return TransactionBuilder(
            ...
            receiver=sender,
            amount=None,
            gas_limit=self._config.gas_limit_dct_nft_burn,
            add_data_movement_gas=True,
            data_parts=parts
        ).build()
