from dharitri_sdk_core.address import DEFAULT_HRP, Address
...
class TransactionsFactoryConfig:
    def __init__(self, chain_id: str) -> None:
        ...
        self.gas_limit_dct_local_mint: int = 300_000
        self.gas_limit_dct_local_burn: int = 300_000
        ...
        self.gas_limit_dct_nft_create: int = 3_000_000
        self.gas_limit_dct_nft_update_attributes: int = 1_000_000
        self.gas_limit_dct_nft_add_quantity: int = 1_000_000
        self.gas_limit_dct_nft_burn: int = 1_000_000
        self.gas_limit_store_per_byte: int = 50_000
        self.issue_cost: int = 50_000_000_000_000_000
        self.dct_contract_address: IAddress = Address.new_from_bech32("moa1qqqqqqqqqqqqqqqpqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqzllls29jpxv")
        ...
        self.gas_limit_dct_transfer = 200_000
        self.gas_limit_dct_nft_transfer = 200_000
        self.gas_limit_multi_dct_nft_transfer = 200_000
