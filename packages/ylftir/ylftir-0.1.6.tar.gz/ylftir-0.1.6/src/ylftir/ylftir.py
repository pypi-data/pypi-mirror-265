...
def ftir_deconvolution(
  ...
  `constrain_width` - tuple of lower and upper bounds for width, defaults to (0, np.inf)
  `constrain_amplitude` - tuple of lower and upper bounds for amplitude, defaults to (0, np.inf)
  ...
  solution, cov = curve_fit(problem, x / scale_x, y, init, maxfev=100000, bounds=([*pos_lb, *[bw]*n, *[ba]*n],[*pos_ub, *[tw]*n, *[ta]*n]))
