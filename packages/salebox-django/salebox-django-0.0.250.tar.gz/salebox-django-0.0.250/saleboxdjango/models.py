...
class Product(models.Model):
    ...
    json_1 = models.JSONField(blank=True, null=True)
    json_2 = models.JSONField(blank=True, null=True)
    json_3 = models.JSONField(blank=True, null=True)
    json_4 = models.JSONField(blank=True, null=True)
    json_5 = models.JSONField(blank=True, null=True)
    json_6 = models.JSONField(blank=True, null=True)
    json_7 = models.JSONField(blank=True, null=True)
    json_8 = models.JSONField(blank=True, null=True)
    json_9 = models.JSONField(blank=True, null=True)
    json_10 = models.JSONField(blank=True, null=True)
