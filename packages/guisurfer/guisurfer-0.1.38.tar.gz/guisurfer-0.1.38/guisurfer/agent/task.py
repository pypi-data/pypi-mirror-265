...
class Task(WithDB):
    ...
    def __init__(
        ...
        self._thread = thread if thread is not None else RoleThread()
    ...
    def post_message(
        ...
        print("\n\ncurrent thread: ", self._thread.__dict__)
    ...
    #     self._thread.post(role, msg, images, private, metadata)
    #     self.save()
    #     print("\n\ncurrent thread: ", self._feed.__dict__)
    ...
    #     self._feed.post(role, msg, images, metadata=metadata)
    #     self.save()
    #     print("\n\ncurrent feed: ", self._feed.__dict__)
