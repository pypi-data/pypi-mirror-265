...
class JobQueueConfig(object):
    ...
    def __init__(self, target_job_queue_id=None, target_job_queue_name=None, job_queue_spec=None, priority=-1, local_vars_configuration=None):  # noqa: E501
    ...
    def target_job_queue_id(self):
        """Gets the target_job_queue_id of this JobQueueConfig.  # noqa: E501
        ...
        :return: The target_job_queue_id of this JobQueueConfig.  # noqa: E501
        :rtype: str
        """
    ...
    def target_job_queue_id(self, target_job_queue_id):
        """Sets the target_job_queue_id of this JobQueueConfig.

        Identifier of the existing Job Queue this job should be added to. Note, only one of `target_job_queue_id`, `target_job_queue_name` or `job_queue_spec` could be provided  # noqa: E501

        :param target_job_queue_id: The target_job_queue_id of this JobQueueConfig.  # noqa: E501
        :type: str
        """
    ...
    def target_job_queue_name(self):
        """Gets the target_job_queue_name of this JobQueueConfig.  # noqa: E501
        ...
        :return: The target_job_queue_name of this JobQueueConfig.  # noqa: E501
        :rtype: str
        """
    ...
    def target_job_queue_name(self, target_job_queue_name):
        """Sets the target_job_queue_name of this JobQueueConfig.

        Existing Job Queue user-provided name (identifier), this job should be added to. Note, only one of `target_job_queue_id`, `target_job_queue_name` or `job_queue_spec` could be provided  # noqa: E501

        :param target_job_queue_name: The target_job_queue_name of this JobQueueConfig.  # noqa: E501
        :type: str
        """
    ...
    def job_queue_spec(self):
        """Gets the job_queue_spec of this JobQueueConfig.  # noqa: E501
        ...
        :return: The job_queue_spec of this JobQueueConfig.  # noqa: E501
        :rtype: JobQueueSpec
        """
    ...
    def job_queue_spec(self, job_queue_spec):
        """Sets the job_queue_spec of this JobQueueConfig.

        Spec of the Job Queue definition that should be created and associated with this job. Note, only one of `target_job_queue_id`, `target_job_queue_name` or `job_queue_spec` could be provided  # noqa: E501

        :param job_queue_spec: The job_queue_spec of this JobQueueConfig.  # noqa: E501
        :type: JobQueueSpec
        """
    ...
    def priority(self):
        ...
        Job's relative priority (only relevant for Job Queues of type PRIORITY). Valid values range from 0 (highest) to +inf (lowest). Default value is '-1' (unset)  # noqa: E501
