...
import os
from typing import Any, DefaultDict, Dict, Generator, Optional, Set, Tuple
...
def setup_anyscale_client(
    ...
    Tuple[AnyscaleClient, FakeExternalAPIClient, FakeInternalAPIClient, TestLogger],
    None,
    None,
]:
    ...
    with patch.dict(os.environ, mock_os_environ):
        yield anyscale_client, fake_external_client, fake_internal_client, logger
...
class TestWorkspaceMethods:
    ...
    def test_call_inside_workspace_outside_workspace(
        ...
        setup_anyscale_client: Tuple[
            AnyscaleClient, FakeExternalAPIClient, FakeInternalAPIClient, TestLogger
        ],
    ):
        anyscale_client, _, _, _ = setup_anyscale_client
    ...
    def test_call_get_current_workspace_cluster_outside_workspace(
        ...
        anyscale_client, fake_external_client, _, _ = setup_anyscale_client
...
class TestGetCloudID:
    ...
    def test_get_by_name(
        ...
        anyscale_client, _, fake_internal_client, _ = setup_anyscale_client
...
class TestClusterEnv:
    def test_get_cluster_env_build_id_from_containerfile_reused_cluster_env(
        ...
        anyscale_client, fake_external_client, _, logger = setup_anyscale_client
    ...
    def test_get_cluster_env_build_id_from_containerfile(
        ...
        if mark_build_fail:
            ...
            assert (
                "Building image... See details: https://anyscale-test.com/container-images/apt_1/versions/bld_1."
