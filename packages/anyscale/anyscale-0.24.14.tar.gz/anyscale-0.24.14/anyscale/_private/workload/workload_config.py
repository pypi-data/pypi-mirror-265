...
class WorkloadConfig(ModelBase):
    ...
    containerfile: Optional[str] = field(
        ...
        repr=False,
        metadata={
            "docstring": "String representation of a containerfile that will be built into an image before running the workload. Exclusive with `image_uri`."
        },
    )
    ...
    compute_config: Union[None, str, Dict, ComputeConfig] = field(
        default=None,
        metadata={
