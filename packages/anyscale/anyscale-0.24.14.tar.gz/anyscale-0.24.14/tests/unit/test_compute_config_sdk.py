...
class TestCreateComputeConfig:
    ...
    def test_no_head_node_uses_cloud_default(
        ...
        if has_no_worker_nodes:
            ...
            assert created.head_node_type.resources == {"CPU": 0, "GPU": 0}
    ...
    def test_custom_head_node(
        ...
        if has_resources:
            assert created.head_node_type.resources == {"CPU": 1, "head_node": 1}
    ...
    def test_custom_worker_nodes(
        ...
        assert created.worker_node_types[2].resources == {"CPU": 1000}
                ...
                config=ComputeTemplateConfig(
                    ...
                    worker_node_types=[
                        InternalApiWorkerNodeType(
                            ...
                            instance_type="worker-node-instance-type-1",
                            min_workers=0,
                            max_workers=10,
                        ),
                        InternalApiWorkerNodeType(
                            name="worker-node-group-2",
                            instance_type="worker-node-instance-type-2",
                            resources=test_case.api_resources,
                            min_workers=5,
                            max_workers=5,
                        ),
