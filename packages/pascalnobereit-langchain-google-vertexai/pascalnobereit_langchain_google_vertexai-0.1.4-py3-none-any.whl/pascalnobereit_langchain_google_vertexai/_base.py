...
from pascalnobereit_langchain_google_vertexai._enums import HarmBlockThreshold, HarmCategory
from pascalnobereit_langchain_google_vertexai._utils import (
    get_client_info,
    get_user_agent,
    is_codey_model,
    is_gemini_model,
...
class _BaseVertexAIModelGarden(_VertexAIBase):
    ...
    def endpoint_path(self) -> str:
        ...
        ).replace("endpoints/","") # wrong default endpoint for claude 3 models
