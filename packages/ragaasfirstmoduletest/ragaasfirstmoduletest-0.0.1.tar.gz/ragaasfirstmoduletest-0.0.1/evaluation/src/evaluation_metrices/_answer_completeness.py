...
from LLMPrompts._prompts import ANSWER_COMPLETENESS_PROMPT
...
class AnswerCompletenessScore:
    
    def __init__(self):
        
        self.prompt = ANSWER_COMPLETENESS_PROMPT
    ...
    def _getscore(self, dataDict):
        ...
        Returns: (resultObj: AnswerCompletenessResult data object having corresponding filled values)
        """
        ...
        try:
            ...
            resultObj = AnswerCompletenessResult(**{'score':str(score),'reason':reason})
