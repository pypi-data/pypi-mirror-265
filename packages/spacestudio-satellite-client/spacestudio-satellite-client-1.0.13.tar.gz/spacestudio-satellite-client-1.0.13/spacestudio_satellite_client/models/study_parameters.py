...
class StudyParameters(BaseModel):
    ...
    previous_maneuver_computation: Optional[Computation] = Field(default=None, alias="previousManeuverComputation")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of previous_maneuver_computation
        if self.previous_maneuver_computation:
            _dict['previousManeuverComputation'] = self.previous_maneuver_computation.to_dict()
        return _dict
