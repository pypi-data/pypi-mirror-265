...
int_components = [ django_comp, flask_comp, middleware, jinja_comp, mako_comp, genshi_comp, cherrypy_comp, bottle_comp, pyramid_comp, fastapi_comp, starlette_comp, tornado_comp, streamlit_comp ]
