...
def check_agent_initialize_status(func):
    def wrapper(*args, **kwargs):
        ...
        if agent:
            ...
            print(f"[Error] APM Insight custom api called before initializing the agent ")
    ...
    def start_tracker(original, name: str= None):
        ...
        def wrapper(*args, **kwargs):
            ...
            if agent and is_txn_active():
                ...
                tracker_info = get_tracker_info((module+"." + method) if is_non_empty_string(module) else method , parent_tracker)
