...
Welcome to `mausam` contributor's guide.
...
If you experience bugs or general issues with `mausam`, please have a look
...
You can help improve `mausam` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`mausam` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `mausam`'s files. While this mechanism can
...
```
conda create -n mausam python=3 six virtualenv pytest pytest-cov
conda activate mausam
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/mausam.git
   cd mausam
   ```
...
5. Install [pre-commit]:
   ...
   `mausam` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/mausam
[issue tracker]: https://github.com/<USERNAME>/mausam/issues
