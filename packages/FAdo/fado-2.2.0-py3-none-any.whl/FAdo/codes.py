...
from . common import *
from . import fio
from . transducers import SFT, infixTransducer, prefixTransducer, suffixTransducer, \
    outfixTransducer, hypercodeTransducer
from . import fa
from . import fl
...
def editDistanceW(auto):
    ...
    Returns:
        tuple: The edit distance of the given regular language plus a witness pair
...
def exponentialDensityP(aut):
    ...
    def _listgcd(ll):
        if len(ll) == 1:
            return ll[0]
        return math.gcd(ll[0], _listgcd(ll[1:]))
