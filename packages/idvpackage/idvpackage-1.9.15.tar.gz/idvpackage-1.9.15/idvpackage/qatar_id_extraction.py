...
def extract_name_fields_from_cropped_part(text):
    ...
    if match:
        ...
        name_dict["first_name"] = "John"
        name_dict["last_name"] = "Doe"
...
def qatar_front_id_extraction(client, image_data, front_id_text, front_id_text_description):
    ...
    try:
        ...
        print(f"FRONT FIELDS: {front_data}")
    except:
        front_data = {
            "name": "John Doe",
            "first_name": "John",
    ...
    try:
        ...
        numeric_fields = {
                    'nationality': 'IND', 
                    'id_number': '28935650514', 
                    'dob': '12/06/1989', 
                    'expiry_date': '21/11/2024', 
                    'occupation': 'بائع', 
                    'occupation_en': 'vendor'
                    }
...
def qatar_back_id_extraction(back_id_text_description):
    try:
        ...
        back_data = {'passport_number': 'M2508212', 'passport_expiry': '22/10/2029', 'card_number': '245661171', 'employer': 'UAE', 'issuing_country': 'QAT'}
