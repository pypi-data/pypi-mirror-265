    ...
    def extract_back_id_info(self, back_id, country):
        ...
        if country == 'QAT':
            ...
            try:
                ...
                back_data = {'error': '', 'doc_type': 'national_identity_card', 'passport_number': 'XXXXXX', 'passport_expiry': '28/08/2031', 'card_number': '30628935650514', 'employer': 'میراکل تريدينغ اند سيرفيس', 'employer_en': 'Miracle Trading and Service', 'issuing_country': 'QAT', 'back_extracted_data': "رقم جواز السفر\nتاريخ انتهاء الجواز\nالرقم المسلسل:\nنوع الرخصة:\nالمستقدم :\nPassport Number:\nV8371636\nPassport Expiry:\nSerial No:\n28/08/2031\n30628935650514\nعمل\nمیراکل تريدينغ اند سيرفيس\nتوقيع حامل البطاقة\nResidency Type:\nEmployer:\nمدير عام الإدارة العامة للجوازات\nGeneral Director of the General\nDirectorate of Passports\nHolder's signature", 'back_coloured': True, 'doc_on_pp': 'clear', 'screenshot_result': 'clear', 'photo_on_screen_result': 'clear', 'back_blurred': 'clear', 'back_glare': 'clear'}
            #     back_data['error'] = 'bad_image'
            #     back_data['error_details'] = e
        # else:
        #     back_data['error'] = 'bad_image'
