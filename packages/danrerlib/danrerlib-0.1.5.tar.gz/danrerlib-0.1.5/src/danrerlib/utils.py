...
def load_data(data_file_name):
    file_dict = {
        ...
        'KEGG background': KEGG_DATA_DIR / Path(f'kegg_background_V{VERSION_NUM}.txt'),
        'Pathway IDs dre' : KEGG_DATA_DIR / Path(f'pathway_ids_dre_V{VERSION_NUM}.txt'),
        'Pathway IDs dreM' : KEGG_DATA_DIR / Path(f'pathway_ids_dreM_V{VERSION_NUM}.txt')
    }
