...
@app.command(help="Generate unit configuration file for systemd")
def generate_unit():
    import subprocess
    ...
    unit_config_path = Path(typer.get_app_dir("systemd")) / "user" / "systema.service"

    unit_config_path.mkdir(parents=True, exist_ok=True)
