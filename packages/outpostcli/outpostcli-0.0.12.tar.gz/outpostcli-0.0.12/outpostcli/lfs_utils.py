# ref: https://github.com/huggingface/huggingface_hub/blob/main/src/huggingface_hub/lfs.py
...
def _upload_parts_hf_transfer(
    ...
    with tqdm(
        unit="B", unit_scale=True, total=total, initial=0, desc=desc, disable=disable
    ) as progress:
        try:
