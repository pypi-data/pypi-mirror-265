...
sections of the documentation... or worse... ask ChatGPT!
...
options/arguments (type of values they accepts, hierarchical relationship among
them, etc...), feed that into this library and let it run, which will have this
effect:

    1. Start a TUI where the user can navigate with the arrow keys through all
       the available arguments/options.

    2. Let the user investigate ech of them (as documentation for the currently
