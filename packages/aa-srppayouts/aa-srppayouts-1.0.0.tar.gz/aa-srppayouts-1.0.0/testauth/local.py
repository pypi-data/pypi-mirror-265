...
# to https://srppayouts.com/sso/callback
# substituting your domain for srppayouts.com
...
# Set the default from email to something like 'noreply@srppayouts.com'
