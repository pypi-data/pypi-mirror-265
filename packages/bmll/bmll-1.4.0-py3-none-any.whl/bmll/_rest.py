...
from bmll.exceptions import (
    AuthenticationError, LoginError, QuotaReachedError, RequestTooLarge, QUOTA_EXCEEDED_ERROR,
)
...
class Session:
    ...
    def _new_auth_status_check(self):
        ...
        try:
            resp = self.http_session.request('get', self.SERVICE_URLS['lab-auth'] + '/status-check')
