...
class Plotter:
    ...
    def standard_plot_routine(self, keys: Sequence[str], ax: Optional[axes.Axes] = None, markers: Optional[Sequence[str]] = None):
        """
    ...
    @plot_logger()
    def plot_asm(self, keys: Optional[List[str]] = None, **kwargs) -> Tuple[figure.Figure, axes.Axes]:
        """
    ...
    @plot_logger()
    def plot_eda(self, keys: Optional[List[str]] = None, **kwargs) -> Tuple[figure.Figure, axes.Axes]:
        """
    ...
    @plot_logger()
    def plot_extra_strain(self, keys: Optional[List[str]] = None, **kwargs) -> Tuple[figure.Figure, axes.Axes]:
        """
    ...
    @plot_logger()
    def plot_arbitrary_keys(self, title: str, keys: List[str], **kwargs) -> Tuple[figure.Figure, axes.Axes]:
        """
