...
from afeng_tools.fastapi_tool.template.item import TemplateHtmlHeadData, TemplateBreadCrumbData, TemplatePaginationAreaData, TemplateLeftNavData, \
    ...
    TemplateTopRankingData, TemplateRedirectDownloadAreaData, TemplateRedirectAreaData, TemplateError404AreaData, TemplateError500AreaData, TemplateError501AreaData
