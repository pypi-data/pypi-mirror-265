...
# TODO: removed for UA, if this breaks DF, put it back
# fqdn: {fqdn}
user: {ssh_username}
...
def cloudinit_networkconfig(ip_address: str, network_bits: int, gateway: str, nameserver: str, searchdomain: str):
    return f"""version: 1
config:
  - type: physical
    name: eth0
