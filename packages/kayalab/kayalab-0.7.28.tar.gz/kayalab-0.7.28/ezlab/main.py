...
async def home(client: Client):
    ...
    with ui.footer() as footer:
        ...
        log = ui.log().classes("w-full h-48 text-accent").style("white-space: pre-wrap").bind_visibility(app.storage.user, "showlog")
...
if __name__ in {"__main__", "__mp_main__"}:
    ...
    # nicegui_log = logging.getLogger("nicegui.binding")
    # nicegui_log.setLevel(logging.FATAL)
