...
class Listener:
    ...
    def route_config(self):
        """
            Description: configura todas las rutas y endpoint para la comunicacion local entre los navegadores y la app.
        """
        ...
        def post_event():
            ...
            self.api._scanner.event_recorder_handler(data)
