  ...
  <dynamic-pagination :endpoint="endpoint"
    ...
    <template #default="paginationProps">
      ...
      <ul class="list-group" v-if="listView">
        <li class="list-group-item list-group-item-action py-1" v-for="item in paginationProps.items" :key="item.id">
          <a class="text-default stretched-link" :href="item._links.view">
            <div class="form-row align-items-center">
              <div class="col-md-4 order-1" v-trim-ws>
                <small>
                  <resource-visibility :visibility="item.visibility"></resource-visibility>
                </small>
                <strong class="wb-break-all ml-2">{{ item.title }}</strong>
              </div>
        ...
        <template #default="props">
          <div class="card-body py-2">
            <a class="text-default stretched-link" :href="props.item._links.view">
              ...
              <img class="img-max-75 img-thumbnail float-right ml-3"
