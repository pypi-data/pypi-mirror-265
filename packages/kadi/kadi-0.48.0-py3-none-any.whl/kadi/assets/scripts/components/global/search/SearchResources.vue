      ...
      <div class="list-group list-group-flush">
        <div class="list-group-item list-group-item-action text-body p-0"
          ...
          <a class="text-default" :href="resource._links.view">
            <div class="result">
              <img class="img-max-100 img-thumbnail float-sm-left mr-sm-3 mb-2"
                   :src="resource._links.image"
                   v-if="resource._links.image">
              <div class="d-flow-root">
                <div class="row mb-2 mb-sm-0">
                  <div class="col-sm-7" v-trim-ws>
                    ...
                    <strong class="wb-break-all ml-2" :class="{'mr-2': resource.type}">{{ resource.title }}</strong>
                    <resource-type class="badge-mt-minus" :type="resource.type" :is-template="Boolean(resource.data)">
                    </resource-type>
                    <p class="wb-break-all">@{{ resource.identifier }}</p>
                  </div>
