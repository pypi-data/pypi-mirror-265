...
<template>
  <div>
    <div class="row align-items-center" :class="{'mb-2': showToolbar}" v-if="!nestedType">
      ...
      <div class="col-sm-6 d-sm-flex justify-content-end" v-if="showToolbar">
        ...
        <div class="row align-items-center"
          ...
          <div class="col-md-5">
            <div v-if="!kadi.utils.isNestedType(extra.type)">
              ...
              <span v-else>
                <local-timestamp :timestamp="extra.value" v-if="extra.type === 'date'"></local-timestamp>
                <a class="text-primary"
                   target="_blank"
                   rel="noopener noreferrer"
                   :href="extra.value"
                   v-else-if="extra.validation && extra.validation.iri && kadi.utils.isHttpUrl(extra.value)"
                   v-trim-ws>
