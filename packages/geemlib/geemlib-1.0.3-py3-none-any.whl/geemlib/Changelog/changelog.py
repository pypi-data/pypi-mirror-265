...
class Changelog:
    ...
    def initLogs(self):
        ...
        self.logs.append(
            ...
            .addLine("Now Web is imported with geemlib, and added functions to")
            .addLine("get BeautifulSoup objects from text and file")
        )
        self.logs.append(
            ChangelogEntry(1, 0, 2)
            .addLine("Added geemlib.__version__ and geemlib.__changelog__")
        )
        self.logs.append(
            ChangelogEntry(1, 0, 1)
            .addLine("Should fix the parser issue on getBSFromUrl")
        )
        self.logs.append(
