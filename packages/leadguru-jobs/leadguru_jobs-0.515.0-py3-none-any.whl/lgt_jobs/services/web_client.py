...
from lgt_jobs.env import v2_server_host, service_account_email, service_account_password
...
class V3ServerClient(BaseHttpClient):
    ...
    def update_user_lead(self, message_id: str, email: str, slack_channel: str,
        ...
        return requests.post(f'{v2_server_host}/{self.api_version}/user_leads/update',
    ...
    def save_lead_from_contact(self, sender_id: str, source_id: str, email: str, message: str = None) -> Response:
        ...
        headers = self._create_default_headers()
        return requests.post(f'{v2_server_host}/{self.api_version}/user_leads/create',
...
class BillingServerClient:
    ...
    def login(email: str, password: str) -> str:
        ...
        response = requests.post(f'{v2_server_host}/{BillingServerClient.api_version}/login', json=payload).json()
