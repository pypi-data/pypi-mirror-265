...
class AutoNACBenchmarkMetrics(
    ...
    AutoNAC benchmark result metrics.
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["latency", "throughput", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["latency", "throughput", ], str]):
