...
A model stores data in constant fields, and let us manipulate the data in a more readable way.
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["metric"]) -> 'Metric': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["metric"]) -> 'Metric': ...
