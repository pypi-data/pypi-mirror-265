...
class APIResponseListDeciInfraDataTypesUserUserEvent(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['UserEvent']:
                        return UserEvent
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['UserEvent'], typing.List['UserEvent']],
                ...
                def __getitem__(self, i: int) -> 'UserEvent':
