...
class ConversionParametersResponse(
    schemas.DictSchema
):
...
A model stores data in constant fields, and let us manipulate the data in a more readable way.
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["workspaceId", "modelId", "parameters", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["workspaceId", "modelId", "parameters", ], str]):
