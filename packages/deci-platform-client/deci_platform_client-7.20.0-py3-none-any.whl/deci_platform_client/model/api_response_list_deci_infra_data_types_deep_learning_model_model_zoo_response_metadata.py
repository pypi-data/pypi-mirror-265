...
class APIResponseListDeciInfraDataTypesDeepLearningModelModelZooResponseMetadata(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ModelZooResponseMetadata']:
                        return ModelZooResponseMetadata
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['ModelZooResponseMetadata'], typing.List['ModelZooResponseMetadata']],
                ...
                def __getitem__(self, i: int) -> 'ModelZooResponseMetadata':
