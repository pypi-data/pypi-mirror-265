...
class BaselineModelResponseMetadata(
    schemas.DictSchema
):
...
A model stores data in constant fields, and let us manipulate the data in a more readable way.
        ...
        class properties:
            ...
            class optimizedModels(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['OptimizedModelResponseMetadata']:
                        return OptimizedModelResponseMetadata
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['OptimizedModelResponseMetadata'], typing.List['OptimizedModelResponseMetadata']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'optimizedModels':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'OptimizedModelResponseMetadata':
                    return super().__getitem__(i)
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["optimizedModels"]) -> typing.Union[MetaOapg.properties.optimizedModels, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["autoNacModels"]) -> typing.Union[MetaOapg.properties.autoNacModels, schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        optimizedModels: typing.Union[MetaOapg.properties.optimizedModels, list, tuple, schemas.Unset] = schemas.unset,
        autoNacModels: typing.Union[MetaOapg.properties.autoNacModels, list, tuple, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
