...
class APIResponseListDeciCommonDataTypesHardwareHardwareReturnSchema(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['HardwareReturnSchema']:
                        return HardwareReturnSchema
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['HardwareReturnSchema'], typing.List['HardwareReturnSchema']],
                ...
                def __getitem__(self, i: int) -> 'HardwareReturnSchema':
