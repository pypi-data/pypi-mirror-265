...
class APIResponseGruModelResponse(
    schemas.DictSchema
):
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['GruModelResponse']:
                return GruModelResponse
            __annotations__ = {
                "success": success,
                "message": message,
                "data": data,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'GruModelResponse': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> typing.Union['GruModelResponse', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        data: typing.Union['GruModelResponse', schemas.Unset] = schemas.unset,
