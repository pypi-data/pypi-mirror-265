...
class APIResponseListDeciInfraDataTypesInvitationsDataTypesInviteInDB(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['InviteInDB']:
                        return InviteInDB
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['InviteInDB'], typing.List['InviteInDB']],
                ...
                def __getitem__(self, i: int) -> 'InviteInDB':
