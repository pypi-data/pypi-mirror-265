...
A model stores data in constant fields, and let us manipulate the data in a more readable way.
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def level() -> typing.Type['FeatureFlagLevel']:
                return FeatureFlagLevel
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["level"]) -> 'FeatureFlagLevel': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["featureId", "description", "level", "updateTime", "creationTime", "id", "deleted", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["level"]) -> 'FeatureFlagLevel': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["featureId", "description", "level", "updateTime", "creationTime", "id", "deleted", ], str]):
