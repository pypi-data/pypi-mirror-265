...
class APIResponseListUnionDeciInfraDataTypesDeepLearningModelBaselineModelResponseMetadataDeciInfraDataTypesDeepLearningModelOptimizedModelResponseMetadata(
    schemas.DictSchema
):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'APIResponseListUnionDeciInfraDataTypesDeepLearningModelBaselineModelResponseMetadataDeciInfraDataTypesDeepLearningModelOptimizedModelResponseMetadata':
        return super().__new__(
            cls,
            *_args,
            success=success,
