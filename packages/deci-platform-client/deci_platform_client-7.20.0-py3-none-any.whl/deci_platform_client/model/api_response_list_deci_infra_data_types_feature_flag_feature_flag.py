...
class APIResponseListDeciInfraDataTypesFeatureFlagFeatureFlag(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class data(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['FeatureFlag']:
                        return FeatureFlag
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['FeatureFlag'], typing.List['FeatureFlag']],
                ...
                def __getitem__(self, i: int) -> 'FeatureFlag':
