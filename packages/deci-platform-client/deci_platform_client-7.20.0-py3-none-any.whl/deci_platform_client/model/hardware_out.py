...
class HardwareOut(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "family", "machineModel", "environment", "vendor", "jobLabel", "taint", "label", "group", "inferyVersion", "defaultBatchSizeList", "machine", "updateTime", "creationTime", "id", "deleted", "imageRepository", "imageDistribution", "deprecated", "future", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "family", "machineModel", "environment", "vendor", "jobLabel", "taint", "label", "group", "inferyVersion", "defaultBatchSizeList", "machine", "updateTime", "creationTime", "id", "deleted", "imageRepository", "imageDistribution", "deprecated", "future", ], str]):
