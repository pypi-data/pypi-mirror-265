...
class APIResponseInviteInDB(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['InviteInDB']:
                return InviteInDB
            __annotations__ = {
                "success": success,
                "message": message,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'InviteInDB': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> typing.Union['InviteInDB', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        data: typing.Union['InviteInDB', schemas.Unset] = schemas.unset,
