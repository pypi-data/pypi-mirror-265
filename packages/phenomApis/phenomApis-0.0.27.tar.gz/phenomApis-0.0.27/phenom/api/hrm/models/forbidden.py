...
class Forbidden(object):
    ...
    def __init__(self, status='failure', error='ACCESS_DENIED', message='Forbidden, You're not allowed to access this resource / Required flags are not enabled / Required permissions are missing'):  # noqa: E501
