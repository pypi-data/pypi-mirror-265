...
if __name__ == "__main__":
    ...
    sm.write_taylor_stats(filename, data, title=title, label=label, overwrite=True)

    # Check statistics for Taylor diagram
    diff = sm.check_taylor_stats(
        taylor_stats1["sdev"], taylor_stats1["crmsd"], taylor_stats1["ccoef"]
    )
