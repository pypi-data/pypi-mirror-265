...
class HubSpotClient:
    ...
    @deprecated("Please use get_business_v1 instead of get_business")
    ...
    def get_business_v1(self, business_id):
        resp = requests.post(
            f"{self.base_url}objects/{self.business_object_id}/search",
            headers=self.headers,
            data=json.dumps(
    ...
    @deprecated("Please use get_user_v1 instead of get_user")
