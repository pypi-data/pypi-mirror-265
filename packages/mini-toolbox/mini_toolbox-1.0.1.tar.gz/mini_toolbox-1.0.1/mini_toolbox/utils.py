...
__all__ = [
    'get_os', 'time_flag', 'time_delta', 'exec_cmd', 'dict2obj', 'split_str', 'is_none', 'format_bool', 'format_none',
    'set_or_not', 'get_obj_value', 'judge_errs', 'dict_sort', 'chunk_str', 'comp_ver', 'format_vars'
]
...
class _Dict2Obj():
    """ 仅内部调用, dict2obj返回对象类型 """

    def __init__(self, dict_):
        self.objupdate(dict_)

    def objupdate(self, dict_):
        """ 更新对象 """
