...
class Orbit(BaseModel):
    ...
    Orbit
    """ # noqa: E501
    sso: Optional[StrictBool] = Field(default=None, description="Indicates whether the orbit is sun-synchronous or not")
    ...
    __properties: ClassVar[List[str]] = ["sso", "inclination", "sma", "eccentricity", "parameters", "advancedParameters"]
