...
class NumericalOrbitalTransferRequest(BaseModel):
    ...
    perturbations: Optional[List[List[StrictStr]]] = Field(default=None, description="The perturbations to take into account for the propagation")
    ...
    __properties: ClassVar[List[str]] = ["missionDateTime", "maximumDuration", "propagationType", "spacecraft", "initialOrbit", "targetOrbit", "perturbations", "ephemerides", "meanEphemerides", "osculatingEphemerides", "customSolarFlux", "customEarthPotentialOrder", "customEarthPotentialDegree", "withEclipse"]
    ...
    def perturbations_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['DRAG', 'EARTH_POTENTIAL', 'SRP', 'THIRD_BODY']):
                raise ValueError("each list item must be one of ('DRAG', 'EARTH_POTENTIAL', 'SRP', 'THIRD_BODY')")
        return value
