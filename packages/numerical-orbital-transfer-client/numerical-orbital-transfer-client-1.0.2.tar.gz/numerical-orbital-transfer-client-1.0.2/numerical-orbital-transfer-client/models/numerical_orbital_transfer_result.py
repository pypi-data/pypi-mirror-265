...
class NumericalOrbitalTransferResult(BaseModel):
    ...
    number_of_burns: Optional[StrictInt] = Field(default=None, description="TODO", alias="numberOfBurns")
    ...
    __properties: ClassVar[List[str]] = ["ephemeridesFrame", "numberOfBurns", "thrustDuration", "usedPropellant", "deltaV", "thrusterMeanDutyCycle", "totalWarmupDutyCycle", "meanBurnDurationEstimation", "missionDuration", "numberOfPeriod", "totalImpulse", "finalDutyCycle", "finalOrbit", "ephemeris"]
