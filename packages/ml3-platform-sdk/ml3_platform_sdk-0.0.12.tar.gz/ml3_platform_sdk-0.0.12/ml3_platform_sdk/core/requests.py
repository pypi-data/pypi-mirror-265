...
class RemoteDataSourceInfo(BaseModel):
    ...
    remote_path: str
    is_folder: bool
    folder_type: Optional[FolderType]
...
class DataInfo(BaseModel):
    ...
    source: Union[LocalDataSourceInfo, RemoteDataSourceInfo]
...
class UnstructuredDataInfo(DataInfo):
    """
    Model that contains information for unstructured data to transfer
    to ML cube Platform.
    """

    mapping_source: Union[LocalDataSourceInfo, RemoteDataSourceInfo]


class ImageDataInfo(UnstructuredDataInfo):
    """
...
class AddProductionRequest(BaseModel):
    ...
    task_id: str
    inputs: Optional[DataInfo]
    target: Optional[DataInfo]
    predictions: Optional[List[Tuple[str, DataInfo]]]
