...
class ML3PlatformClientImpl:
    ...
    def _process_data(
        ...
        storing_data_type: StoringDataType,
        data_category: Optional[DataCategory],
        mapping_data_category: Optional[DataCategory],
        ...
        def build_source_info(
            source,
            source_data_category: Optional[DataCategory],
            data_structure: DataStructure,
        ) -> Union[LocalDataSourceInfo, RemoteDataSourceInfo]:
    ...
    def get_detection_events(self, task_id: str) -> List[DetectionEvent]:
        ...
        return parse_raw_as(List[DetectionEvent], response.content)
