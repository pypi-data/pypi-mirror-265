...
class _Image(modal.object._Object):
    ...
    @staticmethod
    def _registry_setup_commands(tag: str, builder_version: typing.Literal['2023.12', '2024.04'], setup_commands: typing.List[str], add_python: typing.Union[str, None]) -> typing.List[str]:
        ...
