...
def main():
    ...
    parser_blender.add_argument('--resolution', type=int, nargs=2, default=[1920, 1080], help='')
    parser_blender.add_argument('--samples', type=int, default=2, help='')
    ...
    parser_blender.add_argument('--sigma', type=float, default=1.2, help='')
