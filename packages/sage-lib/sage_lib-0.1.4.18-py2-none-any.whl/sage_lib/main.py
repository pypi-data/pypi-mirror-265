...
def main():
    ...
    parser_blender.add_argument('--plot', type=str, choices=['xyz'], default='xyz', required=False, help='')
    parser_blender.add_argument('--resolution', type=int, nargs=2, default=[1920, 1920], help='')
    parser_blender.add_argument('--samples', type=int, default=15, help='')
    parser_blender.add_argument('--fog', action='store_true', default=False, help='')
    parser_blender.add_argument('--render', action='store_true', default=False, help='')
    parser_blender.add_argument('--sigma', type=float, default=1.1, help='')
