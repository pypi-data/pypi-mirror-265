...
class AbstractModelPKType(six.with_metaclass(ABCMeta, object)):
    """
...
class ModelSinglePKType(AbstractModelPKType):
    ...
    def __str__(self):
        if self.app_label and self.model_name:
            str_ = 'id for {}.{}'.format(self.app_label, self.model_name)
        else:
...
class ModelMultiplePKType(AbstractModelPKType):
    ...
    def __str__(self):
        if self.app_label and self.model_name:
            str_ = 'ids for {}.{}'.format(self.app_label, self.model_name)
        else:
