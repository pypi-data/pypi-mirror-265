...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASEMODLIBS': '',
 'BINDIR': '/Users/datnh/local/code/krabby/env/bin',
 'BINLIBDEST': '/Users/datnh/local/code/krabby/env/lib/python3.11',
 ...
 'BLDSHARED': 'arm64-apple-darwin20.0.0-clang -bundle -undefined '
              ...
              '-Wl,-rpath,/Users/datnh/local/code/krabby/env/lib '
              '-L/Users/datnh/local/code/krabby/env/lib '
              ''
              ''
              '-Wl,-headerpad_max_install_names -Wl,-dead_strip_dylibs '
              '-Wl,-rpath,/Users/datnh/local/code/krabby/env/lib '
 ...
 'CFLAGS': '-DNDEBUG -fwrapv -O2 -Wall '
           ...
           '/Users/datnh/local/code/krabby/env/include '
           ' '
           ' '
           '-arch arm64  '
           ''
 ...
 'CONFIGURE_CPPFLAGS': ''
                       ...
                       '-I/Users/datnh/local/code/krabby/env/include',
 'CONFIGURE_LDFLAGS': ''
                      ''
                      '-Wl,-headerpad_max_install_names -Wl,-dead_strip_dylibs '
                      '-Wl,-rpath,/Users/datnh/local/code/krabby/env/lib '
 ...
 'CONFIG_ARGS': "'--with-build-python=/Users/runner/miniforge3/conda-bld/python-split_1708115673525/work/build-python-install/bin/python' "
                "'--prefix=/Users/datnh/local/code/krabby/env' "
                "'--build=x86_64-apple-darwin13.4.0' "
                "'--host=arm64-apple-darwin20.0.0' '--enable-ipv6' "
                "'--with-ensurepip=no' "
                "'--with-tzpath=/Users/datnh/local/code/krabby/env/share/zoneinfo:/Users/datnh/local/code/krabby/env/share/tzinfo' "
                "'--with-computed-gotos' '--with-system-ffi' "
                "'--with-system-expat' '--enable-loadable-sqlite-extensions' "
                "'--with-tcltk-includes=-I/Users/datnh/local/code/krabby/env/include' "
                "'--with-tcltk-libs=-L/Users/datnh/local/code/krabby/env/lib "
                ...
                "'PKG_CONFIG_PATH=/Users/datnh/local/code/krabby/env/lib/pkgconfig' "
                ...
                '-mmacosx-version-min=11.0 '
                "-I/Users/datnh/local/code/krabby/env/include'",
 'CONFINCLUDEDIR': '/Users/datnh/local/code/krabby/env/include',
 'CONFINCLUDEPY': '/Users/datnh/local/code/krabby/env/include/python3.11',
 'COREPYTHONPATH': '',
 ...
 'DESTDIRS': '/Users/datnh/local/code/krabby/env '
             '/Users/datnh/local/code/krabby/env/lib '
             '/Users/datnh/local/code/krabby/env/lib/python3.11 '
             '/Users/datnh/local/code/krabby/env/lib/python3.11/lib-dynload',
 'DESTLIB': '/Users/datnh/local/code/krabby/env/lib/python3.11',
 'DESTPATH': '',
 'DESTSHARED': '/Users/datnh/local/code/krabby/env/lib/python3.11/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'INCLDIRSTOMAKE': '/Users/datnh/local/code/krabby/env/include '
                   '/Users/datnh/local/code/krabby/env/include '
                   '/Users/datnh/local/code/krabby/env/include/python3.11 '
                   '/Users/datnh/local/code/krabby/env/include/python3.11',
 'INCLUDEDIR': '/Users/datnh/local/code/krabby/env/include',
 'INCLUDEPY': '/Users/datnh/local/code/krabby/env/include/python3.11',
 ...
 'LDVERSION': '3.11',
 'LIBC': '',
 'LIBDEST': '/Users/datnh/local/code/krabby/env/lib/python3.11',
 'LIBDIR': '/Users/datnh/local/code/krabby/env/lib',
 ...
 'LIBEXPAT_HEADERS': '\\',
 'LIBEXPAT_OBJS': '\\',
 'LIBFFI_INCLUDEDIR': '/Users/datnh/local/code/krabby/env/include',
 'LIBM': '',
 ...
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/Users/datnh/local/code/krabby/env/lib/pkgconfig',
 'LIBPL': '/Users/datnh/local/code/krabby/env/lib/python3.11/config-3.11-darwin',
 'LIBPYTHON': '',
 ...
 'MACHDEP': 'darwin',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/Users/datnh/local/code/krabby/env/lib/python3.11',
 ...
 'MANDIR': '/Users/datnh/local/code/krabby/env/share/man',
 ...
 'MODULE_BINASCII_CFLAGS': '-DUSE_ZLIB_CRC32 '
                           '-I/Users/datnh/local/code/krabby/env/include',
 'MODULE_BINASCII_LDFLAGS': '-L/Users/datnh/local/code/krabby/env/lib '
                            '-lz',
 ...
 'MODULE_ZLIB_CFLAGS': '-I/Users/datnh/local/code/krabby/env/include',
 'MODULE_ZLIB_LDFLAGS': '-L/Users/datnh/local/code/krabby/env/lib '
                        '-lz',
 ...
 'MODULE__HASHLIB_CFLAGS': '-I/Users/datnh/local/code/krabby/env/include',
 'MODULE__HASHLIB_DEPS': '/Users/runner/miniforge3/conda-bld/python-split_1708115673525/work/Modules/hashlib.h',
 'MODULE__HASHLIB_LDFLAGS': '-L/Users/datnh/local/code/krabby/env/lib   '
                            '-lcrypto',
 ...
 'MODULE__LZMA_CFLAGS': '-I/Users/datnh/local/code/krabby/env/include',
 'MODULE__LZMA_LDFLAGS': '-L/Users/datnh/local/code/krabby/env/lib '
                         '-llzma',
 ...
 'MODULE__SQLITE3_CFLAGS': '-I/Users/datnh/local/code/krabby/env/include '
 ...
 'MODULE__SQLITE3_LDFLAGS': '-L/Users/datnh/local/code/krabby/env/lib '
                            '-lsqlite3',
 'MODULE__SQLITE3_STATE': 'yes',
 'MODULE__SRE_LDFLAGS': '',
 'MODULE__SSL_CFLAGS': '-I/Users/datnh/local/code/krabby/env/include',
 ...
 'MODULE__SSL_LDFLAGS': '-L/Users/datnh/local/code/krabby/env/lib  '
                        '-lssl -lcrypto',
 ...
 'MODULE__TKINTER_CFLAGS': '-I/Users/datnh/local/code/krabby/env/include '
                           '-Wno-strict-prototypes -DWITH_APPINIT=1',
 'MODULE__TKINTER_LDFLAGS': '-L/Users/datnh/local/code/krabby/env/lib '
 ...
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/Users/datnh/local/code/krabby/env/include',
 'OPENSSL_LDFLAGS': '-L/Users/datnh/local/code/krabby/env/lib',
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': '',
 'SCRIPTDIR': '/Users/datnh/local/code/krabby/env/lib',
 'SETPGRP_HAVE_ARG': 0,
 'SHELL': '/bin/sh',
 ...
 'TM_IN_SYS_TIME': 0,
 'TZPATH': '/Users/datnh/local/code/krabby/env/share/zoneinfo:/Users/datnh/local/code/krabby/env/share/tzinfo',
 'UNICODE_DEPS': '\\',
 'UNIVERSALSDK': '',
 ...
 'WASM_ASSETS_DIR': './Users/datnh/local/code/krabby/env',
 'WASM_STDLIB': './Users/datnh/local/code/krabby/env/lib/python3.11/os.py',
 'WHEEL_PKG_DIR': '',
 'WINDOW_HAS_FLAGS': 1,
 ...
 'datarootdir': '/Users/datnh/local/code/krabby/env/share',
 'exec_prefix': '/Users/datnh/local/code/krabby/env',
 'prefix': '/Users/datnh/local/code/krabby/env',
