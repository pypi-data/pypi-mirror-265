...
class Config:
    ...
    def __init__(self): 
        ...
        self.ARDUINO_FOLDER = config.get("arduino", "folder") # folder to store ino file
        ...
        self.CAMERA_FOLDER = config.get("camera", "folder") # folder                  
        ...
        self.OS = config.get("main", "os") # OS : macos or raspberry
        ...
        self.PYTHON_FOLDER = config.get("python", "folder") # folder to store the py file                 

        # read the speech2Text section of the config
        self.LANGUAGE = config.get("speech2Text", "language") # language
        self.RECORD = config.get("speech2Text", "record") # recording
        self.RECORDING = config.get("speech2Text", "recording") # recording
        ...
        self.DATABASE = config.get("sqlite", "database") # database file 
