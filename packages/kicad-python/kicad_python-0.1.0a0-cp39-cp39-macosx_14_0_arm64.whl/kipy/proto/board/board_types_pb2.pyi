...
class PadStackLayer(google.protobuf.message.Message):
    ...
    def __init__(self, *, layers: collections.abc.Iterable[global___BoardLayer.ValueType] | None=..., shape: global___PadStackShape.ValueType=..., size: common.types.base_types_pb2.Vector2 | None=..., corner_rounding_ratio: builtins.float=..., chamfer_ratio: builtins.float=..., chamfered_corners: global___ChamferedRectCorners | None=..., custom_shapes: collections.abc.Iterable[global___GraphicShape] | None=...) -> None:
        ...
...
class PadStack(google.protobuf.message.Message):
    ...
    def __init__(self, *, type: global___PadStackType.ValueType=..., start_layer: global___BoardLayer.ValueType=..., end_layer: global___BoardLayer.ValueType=..., unconnected_layer_removal: global___UnconnectedLayerRemoval.ValueType=..., drill_diameter: common.types.base_types_pb2.Vector2 | None=..., layers: collections.abc.Iterable[global___PadStackLayer] | None=..., angle: common.types.base_types_pb2.Angle | None=...) -> None:
        ...

    def HasField(self, field_name: typing_extensions.Literal['angle', b'angle', 'drill_diameter', b'drill_diameter']) -> builtins.bool:
        ...
...
class GraphicCircleAttributes(google.protobuf.message.Message):
    ...
    def __init__(self, *, center: common.types.base_types_pb2.Vector2 | None=..., radius_point: common.types.base_types_pb2.Vector2 | None=...) -> None:
        ...
...
class GraphicShape(google.protobuf.message.Message):
    ...
    def __init__(self, *, id: common.types.base_types_pb2.KIID | None=..., locked: common.types.base_types_pb2.LockedState.ValueType=..., layer: global___BoardLayer.ValueType=..., net: global___Net | None=..., attributes: common.types.base_types_pb2.GraphicAttributes | None=..., segment: global___GraphicSegmentAttributes | None=..., rectangle: global___GraphicRectangleAttributes | None=..., arc: global___GraphicArcAttributes | None=..., circle: global___GraphicCircleAttributes | None=..., polygon: common.types.base_types_pb2.PolySet | None=..., bezier: global___GraphicBezierAttributes | None=...) -> None:
        ...

    def HasField(self, field_name: typing_extensions.Literal['arc', b'arc', 'attributes', b'attributes', 'bezier', b'bezier', 'circle', b'circle', 'geometry', b'geometry', 'id', b'id', 'net', b'net', 'polygon', b'polygon', 'rectangle', b'rectangle', 'segment', b'segment']) -> builtins.bool:
        ...
...
class Text(google.protobuf.message.Message):
    ...
    def __init__(self, *, text: common.types.base_types_pb2.Text | None=..., layer: global___BoardLayer.ValueType=...) -> None:
        ...

    def HasField(self, field_name: typing_extensions.Literal['text', b'text']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal['layer', b'layer', 'text', b'text']) -> None:
        ...
global___Text = Text
...
class TextBox(google.protobuf.message.Message):
    ...
    def __init__(self, *, textbox: common.types.base_types_pb2.TextBox | None=..., layer: global___BoardLayer.ValueType=...) -> None:
        ...

    def HasField(self, field_name: typing_extensions.Literal['textbox', b'textbox']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal['layer', b'layer', 'textbox', b'textbox']) -> None:
        ...
...
class Pad(google.protobuf.message.Message):
    ...
    def __init__(self, *, id: common.types.base_types_pb2.KIID | None=..., locked: common.types.base_types_pb2.LockedState.ValueType=..., number: builtins.str=..., net: global___Net | None=..., type: global___PadType.ValueType=..., pad_stack: global___PadStack | None=..., position: common.types.base_types_pb2.Vector2 | None=..., overrides: global___DesignRuleOverrides | None=..., thermal_spokes: global___ThermalSpokeSettings | None=...) -> None:
        ...

    def HasField(self, field_name: typing_extensions.Literal['id', b'id', 'net', b'net', 'overrides', b'overrides', 'pad_stack', b'pad_stack', 'position', b'position', 'thermal_spokes', b'thermal_spokes']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal['id', b'id', 'locked', b'locked', 'net', b'net', 'number', b'number', 'overrides', b'overrides', 'pad_stack', b'pad_stack', 'position', b'position', 'thermal_spokes', b'thermal_spokes', 'type', b'type']) -> None:
        ...
global___Pad = Pad
...
class DesignRuleOverrides(google.protobuf.message.Message):
    ...
    def __init__(self, *, clearance: common.types.base_types_pb2.Distance | None=..., solder_mask_margin: common.types.base_types_pb2.Distance | None=..., solder_paste_margin: common.types.base_types_pb2.Distance | None=..., solder_paste_margin_ratio: common.types.base_types_pb2.Ratio | None=..., zone_connection: global___ZoneConnectionStyle.ValueType=...) -> None:
        ...

    def HasField(self, field_name: typing_extensions.Literal['clearance', b'clearance', 'solder_mask_margin', b'solder_mask_margin', 'solder_paste_margin', b'solder_paste_margin', 'solder_paste_margin_ratio', b'solder_paste_margin_ratio']) -> builtins.bool:
        ...
