...
class GetItems(google.protobuf.message.Message):
    ...
    @property
    def types(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[common.types.base_types_pb2.ItemType]:
        """List of one or more types of items to retreive"""

    def __init__(self, *, header: common.types.base_types_pb2.ItemHeader | None=..., types: collections.abc.Iterable[common.types.base_types_pb2.ItemType] | None=...) -> None:
        ...
...
@typing_extensions.final
class GetItemBoundingBox(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    HEADER_FIELD_NUMBER: builtins.int
    ID_FIELD_NUMBER: builtins.int
    ...
    def __init__(self, *, header: common.types.base_types_pb2.ItemHeader | None=..., id: common.types.base_types_pb2.KIID | None=...) -> None:
        ...

    def HasField(self, field_name: typing_extensions.Literal['header', b'header', 'id', b'id']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal['header', b'header', 'id', b'id']) -> None:
        ...
global___GetItemBoundingBox = GetItemBoundingBox

@typing_extensions.final
class BoundingBoxResponse(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ...
    def __init__(self, *, position: common.types.base_types_pb2.Vector2 | None=..., size: common.types.base_types_pb2.Vector2 | None=...) -> None:
        ...
    ...
    def ClearField(self, field_name: typing_extensions.Literal['position', b'position', 'size', b'size']) -> None:
        ...
global___BoundingBoxResponse = BoundingBoxResponse