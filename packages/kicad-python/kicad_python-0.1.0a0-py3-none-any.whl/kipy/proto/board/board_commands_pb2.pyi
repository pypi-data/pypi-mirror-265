...
class GetItemsByNet(google.protobuf.message.Message):
    ...
    def __init__(self, *, header: common.types.base_types_pb2.ItemHeader | None=..., types: collections.abc.Iterable[common.types.base_types_pb2.ItemType] | None=..., net_codes: collections.abc.Iterable[board.board_types_pb2.NetCode] | None=...) -> None:
        ...
...
class GetItemsByNetClass(google.protobuf.message.Message):
    ...
    def __init__(self, *, header: common.types.base_types_pb2.ItemHeader | None=..., types: collections.abc.Iterable[common.types.base_types_pb2.ItemType] | None=..., net_classes: collections.abc.Iterable[builtins.str] | None=...) -> None:
        ...
...
class GetTextExtents(google.protobuf.message.Message):
    ...
    @property
    def text(self) -> board.board_types_pb2.Text:
        """A temporary text item to calculate the bounding box for"""

    def __init__(self, *, text: board.board_types_pb2.Text | None=...) -> None:
        ...
