...
class BoardStackupLayer(google.protobuf.message.Message):
    ...
    def __init__(self, *, thickness: common.types.base_types_pb2.Distance | None=..., layer: common.types.base_types_pb2.Layer | None=..., enabled: builtins.bool=..., copper: global___BoardStackupCopperLayer | None=...) -> None:
        ...

    def HasField(self, field_name: typing_extensions.Literal['copper', b'copper', 'item', b'item', 'layer', b'layer', 'thickness', b'thickness']) -> builtins.bool:
        ...
