...
class Text(google.protobuf.message.Message):
    ...
    def __init__(self, *, id: global___KIID | None=..., position: global___Vector2 | None=..., attributes: global___TextAttributes | None=..., locked: global___LockedState.ValueType=..., text: builtins.str=..., hyperlink: builtins.str=..., knockout: builtins.bool=...) -> None:
        ...

    def HasField(self, field_name: typing_extensions.Literal['attributes', b'attributes', 'id', b'id', 'position', b'position']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal['attributes', b'attributes', 'hyperlink', b'hyperlink', 'id', b'id', 'knockout', b'knockout', 'locked', b'locked', 'position', b'position', 'text', b'text']) -> None:
        ...
global___Text = Text
...
class TextBox(google.protobuf.message.Message):
    ...
    def __init__(self, *, id: global___KIID | None=..., top_left: global___Vector2 | None=..., bottom_right: global___Vector2 | None=..., attributes: global___TextAttributes | None=..., locked: global___LockedState.ValueType=..., text: builtins.str=...) -> None:
        ...

    def HasField(self, field_name: typing_extensions.Literal['attributes', b'attributes', 'bottom_right', b'bottom_right', 'id', b'id', 'top_left', b'top_left']) -> builtins.bool:
        ...

    def ClearField(self, field_name: typing_extensions.Literal['attributes', b'attributes', 'bottom_right', b'bottom_right', 'id', b'id', 'locked', b'locked', 'text', b'text', 'top_left', b'top_left']) -> None:
        ...
