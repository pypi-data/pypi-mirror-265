...
class Config:
    ...
    VERIFICAR_MODO = os.environ.get('VERIFICAR_MODO') or False
    FAILSAFE_OFF = os.environ.get('FAILSAFE_OFF') or False
    ARQUIVO_TEMPORARIO_ATIVO = os.environ.get('ARQUIVO_TEMPORARIO_ATIVO') or False
    NOME_ARQUIVO_TEMPORARIO = os.environ.get('NOME_ARQUIVO_TEMPORARIO') or 'temp.txt'


    @classmethod
    def get_config(cls):
        return (f"""***VARIÁVEIS DE AMBIENTE***
            ...
            MAX_WAIT_MANUTENCAO={cls.MAX_WAIT_MANUTENCAO}
            VERIFICAR_MODO={cls.VERIFICAR_MODO}
            FAILSAFE_OFF={cls.FAILSAFE_OFF}
            ARQUIVO_TEMPORARIO_ATIVO={cls.ARQUIVO_TEMPORARIO_ATIVO}
            NOME_ARQUIVO_TEMPORARIO={cls.NOME_ARQUIVO_TEMPORARIO}
        """)
