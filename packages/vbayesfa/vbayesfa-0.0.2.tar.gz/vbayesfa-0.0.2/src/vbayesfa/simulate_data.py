...
def latent_profile(n_profiles = 4, m = 10, n = 500, separation = 2.0, mu = None, pi = None, seed = 1234):
    '''
...
def latent_factor(n_factors = 2, m = 10, n = 500, loading_var = 3.0, loadings = None, seed = 1234):
    '''
