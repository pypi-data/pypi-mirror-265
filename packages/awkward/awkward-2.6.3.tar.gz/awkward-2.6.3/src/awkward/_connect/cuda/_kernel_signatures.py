...
def by_signature(cuda_kernel_templates):
    ...
    out["awkward_ListOffsetArray_reduce_nonlocal_nextstarts_64_a", int64, int64] = None
    out["awkward_ListOffsetArray_reduce_nonlocal_nextstarts_64_b", int64, int64] = None
    f.dir = ['out', 'in', 'in']
    f.is_ptr = [True, True, False]
    ...
    out["awkward_RegularArray_reduce_local_nextparents_a", int64] = None
    out["awkward_RegularArray_reduce_local_nextparents_b", int64] = None
    f.dir = ['out', 'in', 'in']
    f.is_ptr = [True, False, False]
    ...
    out["awkward_RegularArray_reduce_nonlocal_preparenext_a", int64, int64, int64] = None
    out["awkward_RegularArray_reduce_nonlocal_preparenext_b", int64, int64, int64] = None
    f.dir = ['out', 'out', 'in', 'in', 'in']
    f.is_ptr = [True, True, True, False, False]
