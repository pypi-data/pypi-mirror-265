...
from my_tgcf import proxy_parse_tuple
...
async def deleted_message_handler(event):
    ...
    # logging.info(f'event.deleted_ids:{event.deleted_ids}')
    # print(f'event.deleted_ids:{event.deleted_ids}')
...
async def start_sync() -> None:
    ...
    client = TelegramClient(
        ...
        proxy=proxy_parse_tuple(os.getenv('TG_PROXY'))
    )
