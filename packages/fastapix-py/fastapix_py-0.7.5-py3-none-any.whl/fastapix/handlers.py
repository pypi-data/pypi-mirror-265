...
async def http_exception_default_handler(
    ...
    return DataResponse(message=exc.detail, status_code=exc.status_code, exclude_none=True)
...
async def request_validation_exception_handler(
    ...
    return DataResponse(message=message, status_code=422, exclude_none=True)
...
async def fastapix_exception_default_handler(
    ...
    return DataResponse(message=exc.message, status_code=exc.code, exclude_none=True)
