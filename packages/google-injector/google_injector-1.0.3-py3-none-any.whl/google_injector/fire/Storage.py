...
from ..exc import raise_detailed_error

class Storage:
    """ Storage Service """
    def __init__(self, credentials: Union[ServiceAccountCredentials, None], storage_bucket: str, requests: Union[Session, httpx.Client]):
