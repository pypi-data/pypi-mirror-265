...
try:
    ...
    if openai.__version__ < "1.0.0":
        ...
        from openai import RateLimitError, APIConnectionError, AuthenticationError, NotFoundError
    ...
    def decorator(func):
        ...
        def _openai_error_handling(e, retries):
            ...
            if isinstance(e, AuthenticationError) or isinstance(e, APIConnectionError)\
                    or isinstance(e, NotFoundError) or isinstance(e, TypeError):
            ...
            if isinstance(e, RateLimitError):
                ...
                if getattr(e.error, "type", None) == "insufficient_quota":
                    logger.warning(
