...
from copul.families.other.frechet import IndependenceCopula, UpperFrechet
...
class CuadrasAuge(ExtremeValueCopula):
    ...
    @property
    def cdf(self):
        cdf = sympy.Min(self.u, self.v) ** self.delta * (self.u * self.v) ** (1 - self.delta)
    ...
    def cond_distr_1(self) -> SymPyFunctionWrapper:
        ...
        cond_distr_1 = (
            v ** (1 - delta)
            * (delta * u * sympy.Heaviside(-u + v) - delta * sympy.Min(u, v) + sympy.Min(u, v))
