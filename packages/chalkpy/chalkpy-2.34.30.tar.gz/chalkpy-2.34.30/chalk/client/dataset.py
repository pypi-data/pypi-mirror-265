...
class DatasetRevisionImpl(DatasetRevision):
    ...
    def wait(
        ...
        return status.errors if status.errors is not None and len(status.errors) > 0 else None
...
class DatasetImpl(Dataset):
    ...
    def wait(
        ...
        return self.revisions[-1].wait(timeout=timeout, show_progress=show_progress, caller_name=caller_name)
