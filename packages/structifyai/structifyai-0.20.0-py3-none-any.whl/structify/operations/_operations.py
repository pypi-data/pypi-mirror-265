...
def build_dataset_processsource_request(*, dataset_name: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
...
class DatasetOperations:
    ...
    def processsource(self, body: Union[JSON, IO[bytes]], *, dataset_name: str, **kwargs: Any) -> Any:
        """Adds a data source to a given dataset.
        ...
        _request = build_dataset_processsource_request(
            dataset_name=dataset_name,
            content_type=content_type,
            json=_json,
            content=_content,
...
class DocumentsOperations:
    ...
    def list(self, **kwargs: Any) -> List[Any]:
        ...
        if cls:
            return cls(pipeline_response, cast(List[Any], deserialized), {})  # type: ignore

        return cast(List[Any], deserialized)  # type: ignore
