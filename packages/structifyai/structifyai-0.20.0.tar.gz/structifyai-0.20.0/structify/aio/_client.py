...
from .operations import DatasetOperations, DocumentsOperations, ServerOperations, WorkflowsOperations
...
class Structify:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype workflows: structify.aio.operations.WorkflowsOperations
