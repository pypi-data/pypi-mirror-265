...
HandlerFunction = TypeVar("HandlerFunction", bound="Callable[[rio.Component], object]")
...
def on_populate(handler: HandlerFunction) -> HandlerFunction:
    """
...
def on_page_change(handler: HandlerFunction) -> HandlerFunction:
    """
...
def on_mount(handler: HandlerFunction) -> HandlerFunction:
    """
...
def on_unmount(handler: HandlerFunction) -> HandlerFunction:
    """
...
def periodic(
    ...
    def decorator(handler: HandlerFunction) -> HandlerFunction:
