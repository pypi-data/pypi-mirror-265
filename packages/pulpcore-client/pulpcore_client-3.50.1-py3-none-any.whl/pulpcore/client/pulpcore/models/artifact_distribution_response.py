...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, pulp_href=None, hidden=False, pulp_created=None, base_path=None, pulp_labels=None, pulp_last_updated=None, content_guard=None, name=None, base_url=None, local_vars_configuration=None):  # noqa: E501
