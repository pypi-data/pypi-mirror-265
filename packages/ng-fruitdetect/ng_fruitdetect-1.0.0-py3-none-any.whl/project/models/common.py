...
from project.utils.datasets import exif_transpose, letterbox
from project.utils.general import (LOGGER, check_requirements, check_suffix, check_version, colorstr, increment_path,
                                   make_divisible, non_max_suppression, scale_coords, xywh2xyxy, xyxy2xywh)
from project.utils.plots import Annotator, colors, save_one_box
from project.utils.torch_utils import copy_attr, time_sync
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights='yolov5s.pt', device=None, dnn=False, data=None):
        ...
        #   TensorRT:               *.engine
        from project.models.experimental import attempt_download, attempt_load  # scoped to avoid circular import
