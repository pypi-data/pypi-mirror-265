...
class Delete(DeleteInterface, RESTInterface):
    ...
    def _digestion(self, digestion_id: UUID, lock_token: str | None = None):
    ...
    def _group(self, group_id: UUID, lock_token: str | None = None):
        self._delete_resource(
            f"groups/{group_id}",
            additiona_params={"lock_token": lock_token},
        )
    ...
    def _ingestion(self, ingestion_id: UUID, lock_token: str | None = None):
        self._delete_resource(
    ...
    def _log(self, log_id: UUID, lock_token: str | None = None):
        self._delete_resource(
    ...
    def _log_object(
        self, log_id: UUID, object_key: str, lock_token: str | None = None
    ):
        self._delete_resource(
    ...
    def _query(
        self, log_id: UUID, query_id: UUID, lock_token: str | None = None
    ):
        self._delete_resource(
    ...
    def _record(
        self, timestamp: float, topic_id: UUID, lock_token: str | None = None
    ):
        self._delete_resource(
    ...
    def _tag(self, log_id: UUID, tag_id: UUID, lock_token: str | None = None):
        self._delete_resource(
    ...
    def _topic(self, topic_id: UUID, lock_token: str | None = None):
        self._delete_resource(
            f"topics/{topic_id}",
            additiona_params={"lock_token": lock_token},
        )
