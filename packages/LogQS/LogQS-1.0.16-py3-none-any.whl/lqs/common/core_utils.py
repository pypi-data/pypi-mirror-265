...
from typing import Iterator, Iterable, List, Optional, Callable, Any
...
class CoreUtils:
    ...
    def get_record_set(
        ...
        leftover_record: Record | None = None
    ...
    def get_presigned_url(
        self,
        object_key: str,
        object_store_id: UUID | str | None = None,
        log_id: UUID | str | None = None,
    ...
    def digestion_part_index_entry_to_record(
        self,
        entry: tuple,
        log_id: UUID | str = "00000000-0000-0000-0000-000000000000",
    ...
    def iter_ingestion_part_data(
        self,
        ingestion_part: IngestionPart | UUID | str,
        ingestion: Ingestion | None = None,
        deserialize_results: bool = False,
        transcoder: Transcode | None = None,
        density_threshold: float = 0.9,
