...
class CustomerDocumentClass(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, code, template_slug, entity_type, policy_code, account_code, content_type, entity_id, filename, description, created_at, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, code, template_slug, entity_type, policy_code, account_code, content_type, entity_id, filename, description, created_at, *args, **kwargs):  # noqa: E501
        """CustomerDocumentClass - a model defined in OpenAPI
