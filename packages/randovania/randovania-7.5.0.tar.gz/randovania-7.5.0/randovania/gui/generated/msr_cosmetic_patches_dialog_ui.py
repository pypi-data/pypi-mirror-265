...
class Ui_MSRCosmeticPatchesDialog(object):
    ...
    def retranslateUi(self, MSRCosmeticPatchesDialog):
        ...
        self.custom_laser_locked_color_button.setText(QCoreApplication.translate("MSRCosmeticPatchesDialog", u"Set Locked Color...", None))
        self.custom_laser_unlocked_color_button.setText(QCoreApplication.translate("MSRCosmeticPatchesDialog", u"Set Unlocked Color...", None))
        ...
        self.custom_grapple_laser_unlocked_color_button.setText(QCoreApplication.translate("MSRCosmeticPatchesDialog", u"Set Unlocked Color...", None))
        self.custom_grapple_laser_locked_color_button.setText(QCoreApplication.translate("MSRCosmeticPatchesDialog", u"Set Locked Color...", None))
