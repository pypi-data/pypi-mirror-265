...
def test_vector_to_series_1():
    assert ds.vector_to_series([1,2,3]).equals(pd.Series([1,2,3]))

#%%
def test_vector_to_series_2():
    assert ds.vector_to_series([]).equals(pd.Series([]))

#%%
def test_vector_to_series_3():
    assert ds.vector_to_series(np.array([1,2,3])).equals(pd.Series(np.array([1,2,3])))

#%%
def test_vector_to_series_4():
    assert ds.vector_to_series(pd.Series([1,2,3])).equals(pd.Series([1,2,3]))

#%%
def test_vector_to_series_5():
    assert ds.vector_to_series(pd.Series([1,2,3]).index).equals(pd.Series([0,1,2]))
