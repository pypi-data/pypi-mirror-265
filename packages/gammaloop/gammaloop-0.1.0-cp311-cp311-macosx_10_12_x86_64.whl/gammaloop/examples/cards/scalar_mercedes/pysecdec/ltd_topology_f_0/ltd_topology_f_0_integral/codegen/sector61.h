...
#procedure defineExpansion
  Global expansion = SecDecInternalsDUMMYIntegrand;
    Id SecDecInternalsDUMMYIntegrand = (( + (( + (1)) * (( + (1))^(-1)))) * ( + (((( + (1)*x1*x3^5*x4^4)^( + (1))) * (( + ( + (1))*x3^2*x4)^( + (0) + (-1))) * (( + ( + (1))*x1*x3^3*x4^2)^( + (0) + (-1))) * (( + (1))^( + (1)))) * (SecDecInternalCalI( + (1)*x1, + (1)*x2, + (1)*x3, + (1)*x4, + (1)*x5, + (1)*x6, + (0))))));
...
#procedure insertDecomposed
    Id F(x1?,x2?,x3?,x4?,x5?,x6?,eps?) =  + ( + (-p11))*x4*x5*x6 + ( + (-p11))*x5*x6 + ( + (-p11))*x6 + ( + (-p11))*x2*x3*x4^2*x5*x6 + ( + (-p11))*x2*x3*x4*x5*x6 + ( + (-p11))*x2*x3*x4*x6 + ( + (-p11))*x2*x4*x5*x6 + ( + (-p11))*x2*x6 + ( + (-p11))*x1*x3*x4^2*x5*x6 + ( + (-p11))*x1*x3*x4*x5*x6 + ( + (-p11))*x1*x3*x4*x6 + ( + (-p11))*x4*x5 + ( + (-p11))*x5 + ( + (-p11)) + ( + (-p11))*x1*x2*x3*x4^2*x5*x6 + ( + (-p11))*x2*x3*x4^2*x5 + ( + (-p11))*x1*x2*x3*x4*x6 + ( + (-p11))*x2*x3*x4*x5 + ( + (-p11))*x2*x3*x4 + ( + (-p11))*x2*x4*x5 + ( + (-p11))*x2;
  Id U(x1?,x2?,x3?,x4?,x5?,x6?,eps?) =  + ( + (1))*x1*x4*x6 + ( + (1))*x4*x5 + ( + (1))*x1*x6 + ( + (1))*x5 + ( + (1)) + ( + (1))*x1*x2*x3*x4^2*x6 + ( + (1))*x2*x3*x4^2*x5 + ( + (1))*x1*x2*x3*x4*x6 + ( + (1))*x2*x3*x4*x5 + ( + (1))*x2*x3*x4 + ( + (1))*x1*x2*x4*x6 + ( + (1))*x2*x4*x5 + ( + (1))*x2 + ( + (1))*x1^2*x3*x4^2*x6 + ( + (1))*x1*x3*x4^2*x5 + ( + (1))*x1^2*x3*x4*x6 + ( + (1))*x1*x3*x4*x5 + ( + (1))*x1*x3*x4 + ( + (1))*x1*x4 + ( + (1))*x1 + ( + (1))*x1^2*x2*x3*x4^2*x6 + ( + (1))*x1*x2*x3*x4^2*x5 + ( + (1))*x1*x2*x3*x4^2 + ( + (1))*x1*x2*x4;
