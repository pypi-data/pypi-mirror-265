#ifndef ltd_topology_f_0_integral_src_SecDecInternalFunctions_hpp_included
#define ltd_topology_f_0_integral_src_SecDecInternalFunctions_hpp_included
...
namespace ltd_topology_f_0_integral
{
    ...
    #define ltd_topology_f_0_integral_contour_deformation 0
    #define ltd_topology_f_0_integral_has_complex_parameters 0
    #define ltd_topology_f_0_integral_enforce_complex_return_type 0
    #if ltd_topology_f_0_integral_has_complex_parameters || ltd_topology_f_0_integral_contour_deformation || ltd_topology_f_0_integral_enforce_complex_return_type
      #ifdef SECDEC_WITH_CUDA
        __host__ __device__
      #endif
        ...
        inline real_t log(real_t arg)
        {
            if (arg < 0)
            {
                    ...
                    error_message += "Encountered \"log(<negative real>)\" in a real-valued integrand function of \"ltd_topology_f_0_integral\". ";
    ...
    complex_t inline pow(complex_t x, int y)
    {
        ...
        inline real_t pow(real_t base, real_t exponent)
        {
            if (base < 0)
            {
                    ...
                    error_message += "\"ltd_topology_f_0_integral\". Try to enforce complex return values for the generated integrands; i.e. set ";
                    error_message += "\"enforce_complex=True\" in the corresponding call to \"loop_package\" or \"make_package\".";
                    throw std::domain_error(error_message);
                #endif
            }
    ...
    #undef ltd_topology_f_0_integral_contour_deformation
    #undef ltd_topology_f_0_integral_has_complex_parameters
    #undef ltd_topology_f_0_integral_enforce_complex_return_type
    #undef SecDecFn
