...
#procedure defineExpansion
  Global expansion = SecDecInternalsDUMMYIntegrand;
    Id SecDecInternalsDUMMYIntegrand = (( + (( + (1)) * (( + (1))^(-1)))) * ( + (((( + (1)*x3^2*x5^5*x6)^( + (1))) * (( + ( + (1))*x3*x5^2)^( + (0) + (-1))) * (( + ( + (1))*x3*x5^3*x6)^( + (0) + (-1))) * (( + (1))^( + (1)))) * (SecDecInternalCalI( + (1)*x1, + (1)*x2, + (1)*x3, + (1)*x4, + (1)*x5, + (1)*x6, + (0))))));
...
#procedure insertDecomposed
    Id U(x1?,x2?,x3?,x4?,x5?,x6?,eps?) =  + ( + (1))*x4*x6 + ( + (1))*x4 + ( + (1))*x6 + ( + (1)) + ( + (1))*x3*x4 + ( + (1))*x2*x3*x4*x5*x6 + ( + (1))*x2*x3*x4*x5 + ( + (1))*x2*x3*x5*x6 + ( + (1))*x2*x3*x5 + ( + (1))*x2*x3^2*x4*x5 + ( + (1))*x2*x6 + ( + (1))*x2 + ( + (1))*x2*x3 + ( + (1))*x1*x4*x5*x6^2 + ( + (1))*x1*x4*x5*x6 + ( + (1))*x1*x5*x6^2 + ( + (1))*x1*x5*x6 + ( + (1))*x1*x3*x4*x5*x6 + ( + (1))*x1*x4*x6 + ( + (1))*x1*x6 + ( + (1))*x1*x2*x5*x6^2 + ( + (1))*x1*x2*x5*x6 + ( + (1))*x1*x2*x3*x4*x5*x6 + ( + (1))*x1*x2*x6;
  Id F(x1?,x2?,x3?,x4?,x5?,x6?,eps?) =  + ( + (-p11))*x4 + ( + (-p11)) + ( + (-p11))*x3*x4 + ( + (-p11))*x2*x3*x4*x5 + ( + (-p11))*x2*x3*x5 + ( + (-p11))*x2*x3^2*x4*x5 + ( + (-p11))*x2 + ( + (-p11))*x2*x3 + ( + (-p11))*x1*x4*x5*x6 + ( + (-p11))*x1*x5*x6 + ( + (-p11))*x1*x3*x4*x5*x6 + ( + (-p11))*x1*x4 + ( + (-p11))*x1 + ( + (-p11))*x1*x3*x4 + ( + (-p11))*x1*x2*x5*x6 + ( + (-p11))*x1*x2*x3*x4*x5 + ( + (-p11))*x1*x2*x3*x5*x6 + ( + (-p11))*x1*x2*x3*x5 + ( + (-p11))*x1*x2*x3^2*x4*x5 + ( + (-p11))*x1*x2 + ( + (-p11))*x1*x2*x3;
