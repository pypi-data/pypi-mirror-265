...
from aiask.openai import fetch_data
from aiask.utils import print_waiting, save_to_file, check_for_config
from aiask.consts import app_directory, api_key_key
...
async def main_impl():
    ...
    if args.command == "init":
        print(
            Fore.YELLOW + "Welcome to aiask! To get started you will need to generate an OpenAI API key and paste it here to save it to your aiask config.\n\nVisit " + Fore.WHITE + "https://platform.openai.com/api-keys." + Fore.YELLOW + "\n\nThe key should be like sk-{20chars}\n" + Style.RESET_ALL
        )
