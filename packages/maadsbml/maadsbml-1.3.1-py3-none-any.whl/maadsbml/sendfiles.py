...
def hyperpredictions(pkey,theinputdata,host,port,username,usereverseproxy=0,microserviceid='',password='123',company='otics',email='support@otics.ca',maadstoken='123'):
    ...
    value="%s,[%s],%s,%s,%s,%s" % (pkey,theinputdata,maadstoken,username,company,email)
