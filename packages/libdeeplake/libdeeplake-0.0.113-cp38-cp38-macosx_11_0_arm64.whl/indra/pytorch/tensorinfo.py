...
class TensorsInfo:
    def __init__(
        ...
        Args:
            ...
            medical_tensors (List[str], optional) Subset of raw tensors, these will be decompressed by python workers into lists.
        """
        ...
        self.medical_tensors = medical_tensors or []
    ...
    def __getstate__(self):
        return {
            ...
            "medical_tensors": self.medical_tensors,
        }
    ...
    def __setstate__(self, state):
        ...
        self.medical_tensors = state["medical_tensors"]
...
class LoaderMetaInfo:
    ...
    def __setstate__(self, state):
        ...
        self.pin_memory = state["pin_memory"]
