...
from .typing import Numeric, ModuleId
...
def class_ids(cls) -> Tuple[ModuleId, ModuleId]:
    ...
    return canon_id, cls.id if hasattr(cls, "id") else canon_id
...
def instance_ids(instance) -> Tuple[ModuleId, ModuleId]:
    ...
    return canon_id, instance.id if hasattr(instance, "id") else canon_id
