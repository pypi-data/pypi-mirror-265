...
import signlanguage.core.v3.trainmodel_class           as tm
import signlanguage.core.v3.executionmodel_class       as em
...
class SignTrace(ITrace):
    ...
    async def exec_model_async(self, executionModelpool: em.ExecutionModelPool, data=None):
        try:
            ...
            result, confidence = utils.utils().evaluation(data=res)
            return self.return_result(result=result, confidence=confidence, msg="Resultado obtenido exitosamente", review=True)   # type: ignore
