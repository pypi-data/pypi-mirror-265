...
class Provider(object):
    ...
    def __init__(self, id=None, label=None, provider_class=None, provider_type=None, creds=None, origin=None, config=None, created=None, modified=None, access_type=None):  # noqa: E501
