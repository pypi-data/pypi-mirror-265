...
class RTSDB:
    ...
    # self.find("query", ["fieldname"=string], [case_sensitive=<True|False>], [allow_typo=<True|False>])
    # Does: lookup all records that match the query
    # Input: <query = string>, [fieldname = string], [case_sensitive = boolean], [allow_typo = boolean]
