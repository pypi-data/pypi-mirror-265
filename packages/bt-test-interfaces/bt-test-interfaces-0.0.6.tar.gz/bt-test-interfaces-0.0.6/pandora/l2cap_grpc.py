...
class L2CAP:
    ...
    def Connect(self, connection: host_pb2.Connection = host_pb2.Connection(), basic: Optional[l2cap_pb2.ConnectionOrientedChannelRequest] = None, le_credit_based: Optional[l2cap_pb2.CreditBasedChannelRequest] = None, enhanced_credit_based: Optional[l2cap_pb2.CreditBasedChannelRequest] = None, wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> l2cap_pb2.ConnectResponse:
    ...
    def WaitConnection(self, connection: host_pb2.Connection = host_pb2.Connection(), basic: Optional[l2cap_pb2.ConnectionOrientedChannelRequest] = None, le_credit_based: Optional[l2cap_pb2.CreditBasedChannelRequest] = None, enhanced_credit_based: Optional[l2cap_pb2.CreditBasedChannelRequest] = None, wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> l2cap_pb2.WaitConnectionResponse:
        return self.channel.unary_unary(  # type: ignore
    ...
    def Send(self, data: bytes = b'', channel: Optional[l2cap_pb2.Channel] = None, fixed_channel: Optional[l2cap_pb2.FixedChannel] = None, wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> l2cap_pb2.SendResponse:
        return self.channel.unary_unary(  # type: ignore
...
class L2CAPServicer:
    ...
    def WaitConnection(self, request: l2cap_pb2.WaitConnectionRequest, context: grpc.ServicerContext) -> l2cap_pb2.WaitConnectionResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")
