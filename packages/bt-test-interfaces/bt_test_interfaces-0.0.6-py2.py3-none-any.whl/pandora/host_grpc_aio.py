...
class Host:
    ...
    def WaitConnectionUpdate(self, connection: host_pb2.Connection = host_pb2.Connection(), wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[host_pb2.WaitConnectionUpdateResponse]:
        return self.channel.unary_unary(  # type: ignore
    ...
    def GetConnectionParameters(self, connection: host_pb2.Connection = host_pb2.Connection(), wait_for_ready: Optional[bool] = None, timeout: Optional[float] = None) -> Awaitable[host_pb2.GetConnectionParametersResponse]:
        return self.channel.unary_unary(  # type: ignore
...
class HostServicer:
    ...
    async def WaitConnectionUpdate(self, request: host_pb2.WaitConnectionUpdateRequest, context: grpc.ServicerContext) -> host_pb2.WaitConnectionUpdateResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")

    async def GetConnectionParameters(self, request: host_pb2.GetConnectionParametersRequest, context: grpc.ServicerContext) -> host_pb2.GetConnectionParametersResponse:
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)  # type: ignore
        context.set_details("Method not implemented!")  # type: ignore
        raise NotImplementedError("Method not implemented!")
