...
setup(
    ...
    python_requires='>=3.7',
    install_requires=['networkx>=2.6.3','matplotlib>=3.5.1','numpy>=1.21.5','pandas>=1.2.4','seaborn>=0.11.1','scipy>=1.7.3','scanpy>=1.9.3', 'scikit-learn>=1.0.2', 'community>=1.0.0b1'],
)