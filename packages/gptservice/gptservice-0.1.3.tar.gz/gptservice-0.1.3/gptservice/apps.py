    ...
    try:
        ...
        for key, value in assistant_message.items():
            if key in service_mapping:
                ...
                params = [assistant_message.get(param).lower() if param == 'service_name' else 'gpt-test' if param == 'name' and assistant_message.get('name') is None else 'dummy' if param == 'movie_name' and assistant_message.get('movie_name') is None else 'Bengaluru' if param == 'city' and assistant_message.get('city') is None else assistant_message.get(param)  for param in payload]
                break      
