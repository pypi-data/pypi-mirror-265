...
class GetElementError(AppiumExtendedError):
    ...
    def __init__(self,
        ...
        message = f"{message}. Args: {locator=}, {by=}, {value=}, {contains=}"
        super().__init__(message)
...
class GetTextCoordinatesError(AppiumExtendedError):
    ...
    def __init__(self,
        ...
        message = f"{message}. Args: {text=}, {language=}, {ocr=}, {contains=}"
        super().__init__(message)
        self.text = text
...
class FindAndGetElementError(AppiumExtendedError):
    ...
    def __init__(self,
        ...
        message = f"{message}. Args: {locator=}, {contains=}"
        super().__init__(message)
        self.locator = locator
        self.timeout_elem = timeout_elem
        self.timeout_method = timeout_method
...
class TapError(AppiumExtendedError):
    ...
    def __init__(self,
        ...
        message = f"{message}. Args: {locator=}, {x=}, {y=}"
        super().__init__(message)
        self.locator = locator
        self.x = x
        self.y = y
...
class SwipeError(AppiumExtendedError):
    ...
    def __init__(self,
                 ...
                 duration=None,
                 original_exception: Optional[Exception] = None):
        message = f"{message}. Args: {start_position=}, {end_position=}, {direction=}, {distance=}, {duration=}"
        super().__init__(message)
...
class WaitReturnTrueError(AppiumExtendedError):
    ...
    def __init__(self,
                 ...
                 timeout: int = None,
                 original_exception: Optional[Exception] = None):
        message = f"{message}. Args: {str(method)=}, {timeout=}"
        super().__init__(message)
        self.method = method
        self.timeout = timeout
        self.original_exception = original_exception
...
class DrawByCoordinatesError(AppiumExtendedError):
    ...
    def __init__(self,
                 ...
                 path: str = None,
                 original_exception: Optional[Exception] = None):
        message = f"{message}. Args: {coordinates=}, {top_left=}, {bottom_right=}, {path=}"
        super().__init__(message)
...
class ExtractPointCoordinatesByTypingError(AppiumExtendedError):
    ...
    def __init__(self,
                 ...
                 original_exception: Optional[Exception] = None):
        message = f"{message}. Args: {position=}"
        super().__init__(message)
...
class ExtractPointCoordinatesError(AppiumExtendedError):
    ...
    def __init__(self,
                 ...
                 original_exception: Optional[Exception] = None):
        message = f"{message}. Args: {direction=}, {distance=}, {start_x=}, {start_y=}, {screen_resolution=} "
        super().__init__(message)
        self.direction = direction
        self.distance = distance
...
class SaveScreenshotError(AppiumExtendedError):
    ...
    def __init__(self,
                 ...
                 filename: str = None,
                 original_exception: Optional[Exception] = None):
        message = f"{message}. Args: {path=}, {filename=}"
        super().__init__(message)
        self.path = path
