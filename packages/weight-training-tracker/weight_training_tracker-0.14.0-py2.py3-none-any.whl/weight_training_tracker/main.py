...
class Set(pydantic.BaseModel):
    ...
    reps: Optional[int]
    weight: Optional[int]
    left_reps: Optional[int]
    left_weight: Optional[int]
    right_reps: Optional[int]
    right_weight: Optional[int]
    seconds: float
        ...
        for exercise_name in exercises:
            ...
            for set_number in exercises[exercise_name]["sets"]:
                ...
                if "reps" in recorded_set:
                    ...
                    set.left_reps = recorded_set["left_reps"]
                    set.left_weight = recorded_set["left_weight"]
                    set.right_reps = recorded_set["right_reps"]
                    set.right_weight = recorded_set["right_weight"]
