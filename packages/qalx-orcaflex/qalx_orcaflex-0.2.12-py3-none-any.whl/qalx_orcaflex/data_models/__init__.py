...
class OrcaFlexJobOptions:
    ...
    :param delete_message_on_load [bool]: will delete the queue message when the
        simulation bot loads (default=False)
    """
    ...
    delete_message_on_load: bool = False
...
class RangeGraph:
    ...
    def from_dict(cls, a_dict):
        ...
        return cls(
            ...
            as_file=a_dict.get("as_file", False),
        )
