...
def getMixedTypeDict():
    index = Index(np.arange(8))
    data = {
        "a": ["foo1", "foo2", "foo3", "foo4", "foo5", "foo3", "foo4", "foo5"],
        "b": bdate_range("1/1/2009", periods=8),
        "c": [0.0, 1.0, 3.0, 7.0, 9.0,10.0,18,55],
        "d": [1.0, 3.0, 4.0, 9.0, 10.0,15,50,60],
    }
