    ...
    def compute_status(self):
        if 'fairness' in self.values_all and self.values_subset_all != None:
            ...
            for metric_name,metric_values in fairness_keys.items():
                ...
                if 'fairness' in description_file and metric_name in description_file['fairness']:
                    try:
                        description = description_file['fairness'][metric_name]['description']
                        matters = description_file['fairness'][metric_name]['why it matters']
                    except Exception as e:
                        description = " "
                        matters = " "
                else:
                ...
                self.values_all['fairness'][metric_name]['threshold'] = threshold_precent
...
def compute_performance_analysis(values_all,values_subset_all,path_to_config):
        if 'performance' in values_all and values_subset_all != None:
            ...
            for metric_name,metric_values in performance_keys.items():
                ...
                if 'performance' in description_file and metric_name in description_file['performance']:
                    try:
                        description = description_file['performance'][metric_name]['description']
                        matters = description_file['performance'][metric_name]['why it matters']
                    except Exception as e:
                        description = " "
                        matters = " "
                else:
