...
from pureml_evaluate.metrics.nlp_metrics_model.meteor_score.meteor_score import MeteorScore
from pureml_evaluate.metrics.nlp_metrics_model.flesch_kincaid_grade_level.flesch_kincaid_grade_level import FleschKincaidGradeLevel
...
class NLP:
    def __init__(self):
        ...
        self.kwargs = None
        self.evaluator = None
        self.metrics = [BertScore(),MeteorScore(),
                        RougeScore(),
