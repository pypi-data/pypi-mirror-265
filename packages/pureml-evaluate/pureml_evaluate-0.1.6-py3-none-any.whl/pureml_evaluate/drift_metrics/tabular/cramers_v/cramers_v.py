...
class CramersV(DriftMetricBase):
    ...
    def parse_data(self, data: Any) -> pd.DataFrame:  # Cramer's V is only defined for DataFrames
    ...
    def compute(self, reference: Any, production: Optional[Any] = None,columns = None, split_ratio: float = 0.5, **kwargs) -> dict:
        ...
        if data1.shape != data2.shape:
            raise ValueError("Reference and Production datasets must have the same shape")
