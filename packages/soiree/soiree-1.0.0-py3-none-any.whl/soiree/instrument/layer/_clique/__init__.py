...
import soiree.instrument.layer.start_dev as flask_start_dev
import soiree.instrument.moves as instrument_moves
...
def add ():
	...
	def start (name, layer_port, mongo_port):
		...
		import soiree.instrument.moon as instrument_mongo
		mongo = Process (
