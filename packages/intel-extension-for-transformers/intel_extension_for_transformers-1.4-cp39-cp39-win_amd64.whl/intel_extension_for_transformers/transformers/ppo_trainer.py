...
class PPOTrainer(PyTorchModelHubMixin):
    ...
    def __init__(
        ...
        self.is_distributed = self.accelerator.distributed_type in [
            "MULTI_GPU",
            "MULTI_HPU",
        ]
    ...
    def _set_signature_columns_if_needed(self):  # pragma: no cover
    ...
    def _early_stop(self, policykl):
        ...
        if not self.is_distributed and policykl > 1.5 * self.config.target_kl:
            ...
            early_stop = True
        elif self.is_distributed:  # pragma: no cover
    ...
    def log_stats(
        ...
        if self.accelerator.is_main_process:
            ...
            elif self.config.log_with == "wandb":  # pragma: no cover
