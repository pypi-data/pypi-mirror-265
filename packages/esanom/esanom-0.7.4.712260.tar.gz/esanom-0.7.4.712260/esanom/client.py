...
def model_pipeline_failed( pipeline , exit_code=123 ) :
...
def user_pipeline( pipeline_name ) :
...
def user_pipeline_submit( pipeline ) :
    ...
    pipeline_io_uid = _roleuser.pipeline_submit_io( pipeline , task_uids )

    _roleuser.pipeline_submit_io_blocks( pipeline , pipeline_io_uid )
