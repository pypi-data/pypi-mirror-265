...
class Pipeline :
    ...
    def io( self , cmd_key , cmd_val = None , as_file = False ) :
        ...
        if cmd_val != None :
            self.io_set( dinfo , cmd_val , model_name_alt = model_name_alt , as_file = as_file )
        else : 
            return( self.io_get( dinfo , model_name_alt = model_name_alt , as_file = as_file ) )


    def io_set( self , dinfo , cmd_val , model_name_alt , as_file ) :
    ...
    def io_get( self , dinfo , model_name_alt , as_file ) :
    ...
    def xxxget_io_dinfo( self , dinfo ) :
